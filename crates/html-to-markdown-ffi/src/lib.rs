...
// alef:hash:e233924ed1ee9f3f299882377cdf235d71acef20de8d9d9e30cb6d69ec55aae8
...
pub unsafe extern "C" fn htm_convert_with_visitor(
    ...
    let visitor_handle: Option<std::rc::Rc<std::cell::RefCell<dyn html_to_markdown_rs::visitor::HtmlVisitor>>> =
        if visitor.is_null() {
            None
        } else {
...
// DEBUG: gen_ffi_trait_impl called
