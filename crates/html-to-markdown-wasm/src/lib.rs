...
// alef:hash:82cc1ef08300c9971b1774ab0eecb44e97aa9ffb5a496e6de00f1ea38ff1ed97
...
impl WasmConversionOptions {
    ...
    pub fn apply_update(&self, update: WasmConversionOptionsUpdate) -> () {
        ...
        html_to_markdown_rs::ConversionOptions::from(self.clone()).apply_update(update_core)
    }
...
pub struct WasmConversionOptionsBuilder {
    pub(crate) inner: Arc<html_to_markdown_rs::options::ConversionOptionsBuilder>,
}
...
impl WasmPreprocessingOptions {
    ...
    pub fn apply_update(&self, update: WasmPreprocessingOptionsUpdate) -> () {
        ...
        html_to_markdown_rs::PreprocessingOptions::from(self.clone()).apply_update(update_core)
    }
