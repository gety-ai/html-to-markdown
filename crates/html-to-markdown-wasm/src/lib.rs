...
// alef:hash:4b9cf80f11827678388b5a43a175a3fcb2a99470c03fe8b35ee59c0afa9bfbc7
...
impl WasmConversionOptionsBuilder {
    ...
    #[wasm_bindgen]
    pub fn visitor(&self, visitor: Option<WasmVisitorHandle>) -> WasmConversionOptionsBuilder {
        Self {
...
impl WasmVisitorHandle {
    /// Create a new visitor handle from a JavaScript object.
    /// The object should implement visitor methods like `visitHeading`, `visitLink`, etc.
    #[wasm_bindgen(constructor)]
    pub fn new(visitor_obj: JsValue) -> WasmVisitorHandle {
        use std::cell::RefCell;
        use std::rc::Rc;
        let bridge = WasmHtmlVisitorBridge::new(visitor_obj);
        let handle: html_to_markdown_rs::visitor::VisitorHandle = Rc::new(RefCell::new(bridge));
        WasmVisitorHandle {
...
impl From<WasmConversionOptions> for html_to_markdown_rs::options::ConversionOptions {
    fn from(val: WasmConversionOptions) -> Self {
        Self {
            ...
            visitor: val.visitor.as_ref().map(|v| v.inner.as_ref().clone()),
            ..Default::default()
        }
    }
}
