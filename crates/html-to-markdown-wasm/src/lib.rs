...
impl Default for WasmDocumentMetadata {
    fn default() -> Self {
...
impl Default for WasmHtmlMetadata {
    fn default() -> Self {
...
impl Default for WasmConversionOptionsUpdate {
    fn default() -> Self {
...
impl Default for WasmPreprocessingOptions {
    fn default() -> Self {
...
impl Default for WasmPreprocessingOptionsUpdate {
    fn default() -> Self {
...
impl WasmMetadataEntry {
    ...
    pub fn new(key: String, value: String) -> WasmMetadataEntry {
        WasmMetadataEntry { key: key, value: value }
    }
...
impl Default for WasmConversionResult {
    fn default() -> Self {
...
impl Default for WasmTableGrid {
    fn default() -> Self {
    ...
    let options_core: Option<html_to_markdown_rs::ConversionOptions> = options
        ...
        .or_else(|| {
            if visitor_handle.is_some() {
                ...
                opts.visitor = visitor_handle.clone();
                Some(opts)
            } else {
                None
            }
