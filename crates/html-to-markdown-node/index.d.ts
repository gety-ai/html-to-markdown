 ...
 * @param options - — optional conversion options. Defaults to [`ConversionOptions::default`]. When the `visitor` feature is enabled, a custom `HtmlVisitor` can be attached via the `visitor` field on `ConversionOptions`.
