 ...
 *
 * @param convert(html, - ConversionOptions::default())` — bare options.
 *
 * @param convert(html, - opts)` — bare options.
 *
 * @param convert(html, - Some(opts))` — explicit `Option`.
 *
 * @param convert(html, - None)` — fall back to [`ConversionOptions::default`].
 *
 * @throws Returns an error if HTML parsing fails or if the input contains invalid UTF-8.
 */
export declare function convert(html: string, options?: ConversionOptions | undefined | null): ConversionResult;
...
export interface HtmlVisitor {
	 ...
	 */
	visitText?(ctx: NodeContext, text: string): string;
	/**
	 ...
	 */
	visitElementStart?(ctx: NodeContext): string;
	/**
	 ...
	 */
	visitElementEnd?(ctx: NodeContext, output: string): string;
	/**
	 ...
	 */
	visitLink?(ctx: NodeContext, href: string, text: string, title?: string | undefined | null): string;
	/**
	 ...
	 * @param title - Optional title attribute
	 */
	visitImage?(ctx: NodeContext, src: string, alt: string, title?: string | undefined | null): string;
	/**
	 ...
	 */
	visitHeading?(ctx: NodeContext, level: number, text: string, id?: string | undefined | null): string;
	/**
	 ...
	 */
	visitCodeBlock?(ctx: NodeContext, code: string, lang?: string | undefined | null): string;
	/**
	 ...
	 * @param code - The code content
	 */
	visitCodeInline?(ctx: NodeContext, code: string): string;
	/**
	 * Visit list items `<li>`.
	 * @param ctx - Node context
	 *
	 ...
	 */
	visitListItem?(ctx: NodeContext, ordered: boolean, marker: string, text: string): string;
	/** Called before processing a list `<ul>` or `<ol>`. */
	visitListStart?(ctx: NodeContext, ordered: boolean): string;
	/** Called after processing a list `</ul>` or `</ol>`. */
	visitListEnd?(ctx: NodeContext, ordered: boolean, output: string): string;
	/** Called before processing a table `<table>`. */
	visitTableStart?(ctx: NodeContext): string;
	/**
	 * Visit table rows `<tr>`.
	 * @param ctx - Node context
	 *
	 ...
	 */
	visitTableRow?(ctx: NodeContext, cells: Array<string>, isHeader: boolean): string;
	/** Called after processing a table `</table>`. */
	visitTableEnd?(ctx: NodeContext, output: string): string;
	/**
	 ...
	 */
	visitBlockquote?(ctx: NodeContext, content: string, depth: number): string;
	/** Visit strong/bold elements `<strong>`, `<b>`. */
	visitStrong?(ctx: NodeContext, text: string): string;
	/** Visit emphasis/italic elements `<em>`, `<i>`. */
	visitEmphasis?(ctx: NodeContext, text: string): string;
	/** Visit strikethrough elements `<s>`, `<del>`, `<strike>`. */
	visitStrikethrough?(ctx: NodeContext, text: string): string;
	/** Visit underline elements `<u>`, `<ins>`. */
	visitUnderline?(ctx: NodeContext, text: string): string;
	/** Visit subscript elements `<sub>`. */
	visitSubscript?(ctx: NodeContext, text: string): string;
	/** Visit superscript elements `<sup>`. */
	visitSuperscript?(ctx: NodeContext, text: string): string;
	/** Visit mark/highlight elements `<mark>`. */
	visitMark?(ctx: NodeContext, text: string): string;
	/** Visit line break elements `<br>`. */
	visitLineBreak?(ctx: NodeContext): string;
	/** Visit horizontal rule elements `<hr>`. */
	visitHorizontalRule?(ctx: NodeContext): string;
	/**
	 ...
	 */
	visitCustomElement?(ctx: NodeContext, tagName: string, html: string): string;
	/** Visit definition list `<dl>`. */
	visitDefinitionListStart?(ctx: NodeContext): string;
	/** Visit definition term `<dt>`. */
	visitDefinitionTerm?(ctx: NodeContext, text: string): string;
	/** Visit definition description `<dd>`. */
	visitDefinitionDescription?(ctx: NodeContext, text: string): string;
	/** Called after processing a definition list `</dl>`. */
	visitDefinitionListEnd?(ctx: NodeContext, output: string): string;
	/** Visit form elements `<form>`. */
	visitForm?(ctx: NodeContext, action?: string | undefined | null, method?: string | undefined | null): string;
	...
	visitButton?(ctx: NodeContext, text: string): string;
	/** Visit audio elements `<audio>`. */
	visitAudio?(ctx: NodeContext, src?: string | undefined | null): string;
	/** Visit video elements `<video>`. */
	visitVideo?(ctx: NodeContext, src?: string | undefined | null): string;
	/** Visit iframe elements `<iframe>`. */
	visitIframe?(ctx: NodeContext, src?: string | undefined | null): string;
	/** Visit details elements `<details>`. */
	visitDetails?(ctx: NodeContext, open: boolean): string;
	/** Visit summary elements `<summary>`. */
	visitSummary?(ctx: NodeContext, text: string): string;
	/** Visit figure elements `<figure>`. */
	visitFigureStart?(ctx: NodeContext): string;
	/** Visit figcaption elements `<figcaption>`. */
	visitFigcaption?(ctx: NodeContext, text: string): string;
	/** Called after processing a figure `</figure>`. */
	visitFigureEnd?(ctx: NodeContext, output: string): string;
}
...
export type NodeContent =
	...
	| { node_type: "metadata_block"; entries: Array<MetadataEntry> }
