...
// alef:hash:147024b4f81393b371ce3036822adaa02fc44376f3be7a80b8be47e116e40f18
...
pub fn convert(html: String, options: Option<JsConversionOptions>) -> Result<JsConversionResult> {
    ...
    let options_core: Option<html_to_markdown_rs::ConversionOptions> = options.map(|mut o| {
        o.visitor = None;
