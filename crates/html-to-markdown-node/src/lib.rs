...
// alef:hash:69b23cc67af6dfd4cdb77358601dff75700fdfb0f332ae6908acb4f24bf8ab38
...
pub fn convert(html: String, options: Option<JsConversionOptions>) -> Result<JsConversionResult> {
    let visitor_handle = options.as_ref().and_then(|o| o.visitor.clone()).map(|v| {
    ...
    let mut options_core: Option<html_to_markdown_rs::ConversionOptions> = options.map(|mut o| {
        o.visitor = None;
