...
// alef:hash:a621bfb6bd43a89a977868d79793c291c6132e422b1554f0edb8e5278c1c97c6
...
impl ImageMetadata {
    ...
    pub fn get_dimensions(&self) -> Option<Vec<u32>> {
...
impl HtmlToMarkdownApi {
     ...
     *
     * @param mixed $options — optional conversion options. Defaults to `ConversionOptions.default`.
     *
    ...
    fn from(val: NodeContext) -> Self {
        Self {
            node_type: match val.node_type.as_str() {
                "Text" => html_to_markdown_rs::NodeType::Text,
                "Element" => html_to_markdown_rs::NodeType::Element,
                "Heading" => html_to_markdown_rs::NodeType::Heading,
                "Paragraph" => html_to_markdown_rs::NodeType::Paragraph,
                "Div" => html_to_markdown_rs::NodeType::Div,
                "Blockquote" => html_to_markdown_rs::NodeType::Blockquote,
                "Pre" => html_to_markdown_rs::NodeType::Pre,
                "Hr" => html_to_markdown_rs::NodeType::Hr,
                "List" => html_to_markdown_rs::NodeType::List,
                "ListItem" => html_to_markdown_rs::NodeType::ListItem,
                "DefinitionList" => html_to_markdown_rs::NodeType::DefinitionList,
                "DefinitionTerm" => html_to_markdown_rs::NodeType::DefinitionTerm,
                "DefinitionDescription" => html_to_markdown_rs::NodeType::DefinitionDescription,
                "Table" => html_to_markdown_rs::NodeType::Table,
                "TableRow" => html_to_markdown_rs::NodeType::TableRow,
                "TableCell" => html_to_markdown_rs::NodeType::TableCell,
                "TableHeader" => html_to_markdown_rs::NodeType::TableHeader,
                "TableBody" => html_to_markdown_rs::NodeType::TableBody,
                "TableHead" => html_to_markdown_rs::NodeType::TableHead,
                "TableFoot" => html_to_markdown_rs::NodeType::TableFoot,
                "Link" => html_to_markdown_rs::NodeType::Link,
                "Image" => html_to_markdown_rs::NodeType::Image,
                "Strong" => html_to_markdown_rs::NodeType::Strong,
                "Em" => html_to_markdown_rs::NodeType::Em,
                "Code" => html_to_markdown_rs::NodeType::Code,
                "Strikethrough" => html_to_markdown_rs::NodeType::Strikethrough,
                "Underline" => html_to_markdown_rs::NodeType::Underline,
                "Subscript" => html_to_markdown_rs::NodeType::Subscript,
                "Superscript" => html_to_markdown_rs::NodeType::Superscript,
                "Mark" => html_to_markdown_rs::NodeType::Mark,
                "Small" => html_to_markdown_rs::NodeType::Small,
                "Br" => html_to_markdown_rs::NodeType::Br,
                "Span" => html_to_markdown_rs::NodeType::Span,
                "Article" => html_to_markdown_rs::NodeType::Article,
                "Section" => html_to_markdown_rs::NodeType::Section,
                "Nav" => html_to_markdown_rs::NodeType::Nav,
                "Aside" => html_to_markdown_rs::NodeType::Aside,
                "Header" => html_to_markdown_rs::NodeType::Header,
                "Footer" => html_to_markdown_rs::NodeType::Footer,
                "Main" => html_to_markdown_rs::NodeType::Main,
                "Figure" => html_to_markdown_rs::NodeType::Figure,
                "Figcaption" => html_to_markdown_rs::NodeType::Figcaption,
                "Time" => html_to_markdown_rs::NodeType::Time,
                "Details" => html_to_markdown_rs::NodeType::Details,
                "Summary" => html_to_markdown_rs::NodeType::Summary,
                "Form" => html_to_markdown_rs::NodeType::Form,
                "Input" => html_to_markdown_rs::NodeType::Input,
                "Select" => html_to_markdown_rs::NodeType::Select,
                "Option" => html_to_markdown_rs::NodeType::Option,
                "Button" => html_to_markdown_rs::NodeType::Button,
                "Textarea" => html_to_markdown_rs::NodeType::Textarea,
                "Label" => html_to_markdown_rs::NodeType::Label,
                "Fieldset" => html_to_markdown_rs::NodeType::Fieldset,
                "Legend" => html_to_markdown_rs::NodeType::Legend,
                "Audio" => html_to_markdown_rs::NodeType::Audio,
                "Video" => html_to_markdown_rs::NodeType::Video,
                "Picture" => html_to_markdown_rs::NodeType::Picture,
                "Source" => html_to_markdown_rs::NodeType::Source,
                "Iframe" => html_to_markdown_rs::NodeType::Iframe,
                "Svg" => html_to_markdown_rs::NodeType::Svg,
                "Canvas" => html_to_markdown_rs::NodeType::Canvas,
                "Ruby" => html_to_markdown_rs::NodeType::Ruby,
                "Rt" => html_to_markdown_rs::NodeType::Rt,
                "Rp" => html_to_markdown_rs::NodeType::Rp,
                "Abbr" => html_to_markdown_rs::NodeType::Abbr,
                "Kbd" => html_to_markdown_rs::NodeType::Kbd,
                "Samp" => html_to_markdown_rs::NodeType::Samp,
                "Var" => html_to_markdown_rs::NodeType::Var,
                "Cite" => html_to_markdown_rs::NodeType::Cite,
                "Q" => html_to_markdown_rs::NodeType::Q,
                "Del" => html_to_markdown_rs::NodeType::Del,
                "Ins" => html_to_markdown_rs::NodeType::Ins,
                "Data" => html_to_markdown_rs::NodeType::Data,
                "Meter" => html_to_markdown_rs::NodeType::Meter,
                "Progress" => html_to_markdown_rs::NodeType::Progress,
                "Output" => html_to_markdown_rs::NodeType::Output,
                "Template" => html_to_markdown_rs::NodeType::Template,
                "Slot" => html_to_markdown_rs::NodeType::Slot,
                "Html" => html_to_markdown_rs::NodeType::Html,
                "Head" => html_to_markdown_rs::NodeType::Head,
                "Body" => html_to_markdown_rs::NodeType::Body,
                "Title" => html_to_markdown_rs::NodeType::Title,
                "Meta" => html_to_markdown_rs::NodeType::Meta,
                "LinkTag" => html_to_markdown_rs::NodeType::LinkTag,
                "Style" => html_to_markdown_rs::NodeType::Style,
                "Script" => html_to_markdown_rs::NodeType::Script,
                "Base" => html_to_markdown_rs::NodeType::Base,
                "Custom" => html_to_markdown_rs::NodeType::Custom,
