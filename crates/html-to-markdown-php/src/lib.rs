...
impl HtmlToMarkdownApi {
     ...
     *
     * @param mixed $options — conversion options. Rust accepts either bare `ConversionOptions`, `Some(options)`, or `None`; bindings expose the same option fields through language-native constructors or optional parameters.
     *
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("html_to_markdown", "3.6.8")
