...
// alef:hash:1ffa17709b511ef6177635666d1a4ad6a3c13db581a2cc2d70d6f6a6b75ccbf9
...
impl DocumentMetadata {
    ...
    #[php(getter)]
    pub fn get_openGraph(&self) -> HashMap<String, String> {
        self.open_graph.clone()
    }

    #[php(getter)]
    pub fn get_twitterCard(&self) -> HashMap<String, String> {
        self.twitter_card.clone()
    }

    #[php(getter)]
    pub fn get_metaTags(&self) -> HashMap<String, String> {
...
impl HtmlMetadata {
    ...
    #[php(getter)]
    pub fn get_structuredData(&self) -> Vec<StructuredData> {
...
impl ConversionOptionsBuilder {
     ...
     */
    pub fn visitor(&self, visitor: &mut ext_php_rs::types::ZendObject) -> ConversionOptionsBuilder {
        let bridge = PhpHtmlVisitorBridge::new(visitor);
        let handle: html_to_markdown_rs::visitor::VisitorHandle = std::rc::Rc::new(std::cell::RefCell::new(bridge));
        Self {
            inner: Arc::new((*self.inner).clone().visitor(Some(handle))),
        }
    }
...
impl ConversionResult {
    ...
    #[php(constructor)]
    pub fn new(content: Option<String>, images: Vec<String>) -> Self {
        Self {
            content,
