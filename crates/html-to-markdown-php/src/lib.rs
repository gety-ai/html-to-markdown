...
impl NodeContent {
    ...
    pub fn _factory_heading(level: u8, text: String) -> Self {
        html_to_markdown_rs::NodeContent::Heading {
            level: level,
            text: text,
        }
        .into()
    ...
    pub fn _factory_paragraph(text: String) -> Self {
        html_to_markdown_rs::NodeContent::Paragraph { text: text }.into()
    }

    #[php(name = "list")]
    pub fn _factory_list(ordered: bool) -> Self {
        html_to_markdown_rs::NodeContent::List { ordered: ordered }.into()
    }

    #[php(name = "listItem")]
    pub fn _factory_list_item(text: String) -> Self {
        html_to_markdown_rs::NodeContent::ListItem { text: text }.into()
    }
    ...
    pub fn _factory_code(text: String, language: Option<String>) -> Self {
        html_to_markdown_rs::NodeContent::Code {
            text: text,
            language: language,
        }
        .into()
    ...
    pub fn _factory_definition_item(term: String, definition: String) -> Self {
        html_to_markdown_rs::NodeContent::DefinitionItem {
            term: term,
    ...
    pub fn _factory_raw_block(format: String, content: String) -> Self {
        html_to_markdown_rs::NodeContent::RawBlock {
            format: format,
            content: content,
        }
        .into()
...
impl AnnotationKind {
    ...
    pub fn _factory_link(url: String, title: Option<String>) -> Self {
        html_to_markdown_rs::AnnotationKind::Link { url: url, title: title }.into()
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("html_to_markdown", "3.8.1")
