...
pub struct DocumentMetadata {
    ...
    #[serde(alias = "textDirection")]
    pub text_direction: Option<String>,
    /// Open Graph metadata (og:* properties) for social media
    /// Keys like "title", "description", "image", "url", etc.
    #[serde(alias = "openGraph")]
...
pub struct ConversionOptions {
    ...
    #[serde(alias = "keepInlineImagesIn")]
...
impl NodeContent {
    ...
    pub fn _factory_heading(level: u8, text: String) -> Self {
        html_to_markdown_rs::NodeContent::Heading { level, text }.into()
    }

    #[php(name = "paragraph")]
    pub fn _factory_paragraph(text: String) -> Self {
        html_to_markdown_rs::NodeContent::Paragraph { text }.into()
    }

    #[php(name = "list")]
    pub fn _factory_list(ordered: bool) -> Self {
        html_to_markdown_rs::NodeContent::List { ordered }.into()
    }

    #[php(name = "listItem")]
    pub fn _factory_list_item(text: String) -> Self {
        html_to_markdown_rs::NodeContent::ListItem { text }.into()
    }

    #[php(name = "table")]
    pub fn _factory_table(grid: &TableGrid) -> Self {
        html_to_markdown_rs::NodeContent::Table {
    ...
    #[php(name = "image")]
    pub fn _factory_image(description: Option<String>, src: Option<String>, imageIndex: Option<u32>) -> Self {
    ...
    pub fn _factory_code(text: String, language: Option<String>) -> Self {
        html_to_markdown_rs::NodeContent::Code { text, language }.into()
    }

    #[php(name = "definitionItem")]
    pub fn _factory_definition_item(term: String, definition: String) -> Self {
        html_to_markdown_rs::NodeContent::DefinitionItem { term, definition }.into()
    }

    #[php(name = "rawBlock")]
    pub fn _factory_raw_block(format: String, content: String) -> Self {
        html_to_markdown_rs::NodeContent::RawBlock { format, content }.into()
    }

    #[php(name = "metadataBlock")]
    pub fn _factory_metadata_block(entries: &ext_php_rs::types::ZendHashTable) -> PhpResult<Self> {
        let mut entries_core_result: Vec<html_to_markdown_rs::MetadataEntry> = Vec::new();
        for (_, item) in entries.iter() {
            if let Some(parsed) = <&MetadataEntry as ext_php_rs::convert::FromZval>::from_zval(item) {
                entries_core_result.push(parsed.clone().into());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to MetadataEntry".to_string(),
                ));
            }
        }
        let entries_core: Vec<html_to_markdown_rs::MetadataEntry> = entries_core_result;
        Ok(html_to_markdown_rs::NodeContent::MetadataBlock { entries: entries_core }.into())
    }
...
impl AnnotationKind {
    ...
    pub fn _factory_link(url: String, title: Option<String>) -> Self {
        html_to_markdown_rs::AnnotationKind::Link { url, title }.into()
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("html_to_markdown", "3.8.0")
