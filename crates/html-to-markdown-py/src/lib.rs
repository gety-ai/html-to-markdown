...
// alef:hash:776c6e1c06cdf19d1e4d3dc9416458e9cb3721de3050ebacd19ab8d296127833
...
impl HtmlMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (document=Self::default().document, headers=Self::default().headers, links=Self::default().links, images=Self::default().images, structured_data=Self::default().structured_data))]
    #[new]
    pub fn new(
...
impl ConversionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (tables=Self::default().tables, warnings=Self::default().warnings, content=None, document=None))]
    #[new]
    pub fn new(
