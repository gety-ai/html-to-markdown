...
impl ConversionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (metadata=None, tables=Self::default().tables, warnings=Self::default().warnings, content=None, document=None))]
    #[new]
    pub fn new(
...
impl NodeContext {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (node_type, tag_name, depth, index_in_parent, is_inline, parent_tag=None))]
    #[new]
    pub fn new(
        node_type: NodeType,
        tag_name: String,
    ...
    #[staticmethod]
    #[pyo3(signature = (node_type, tag_name, attributes, depth, index_in_parent, parent_tag=None, is_inline=false))]
    pub fn with_owned_attributes(
        ...
        let attributes_converted = attributes
            .iter()
            .map(|(k, v)| (k.clone(), v.clone()))
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            ...
            match s_lower.as_str() {
                "lefttoright" => return Ok(Self::LeftToRight),
                "ltr" => return Ok(Self::LeftToRight),
                "righttoleft" => return Ok(Self::RightToLeft),
                "rtl" => return Ok(Self::RightToLeft),
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::LeftToRight),
                1 => return Ok(Self::RightToLeft),
                2 => return Ok(Self::Auto),
                _ => {}
            }
        }
        let type_name = stringify!(TextDirection);
...
impl LinkType {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::Anchor),
                1 => return Ok(Self::Internal),
                2 => return Ok(Self::External),
                3 => return Ok(Self::Email),
                4 => return Ok(Self::Phone),
...
impl ImageType {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            match s_lower.as_str() {
                "datauri" => return Ok(Self::DataUri),
                "data_uri" => return Ok(Self::DataUri),
                "inlinesvg" => return Ok(Self::InlineSvg),
                "inline_svg" => return Ok(Self::InlineSvg),
                "external" => return Ok(Self::External),
                "relative" => return Ok(Self::Relative),
                _ => {}
            }
        }
        // Try to extract as integer (by discriminant value)
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::DataUri),
                1 => return Ok(Self::InlineSvg),
                2 => return Ok(Self::External),
                3 => return Ok(Self::Relative),
                _ => {}
            }
        }
        let type_name = stringify!(ImageType);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
...
impl StructuredDataType {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            match s_lower.as_str() {
                "jsonld" => return Ok(Self::JsonLd),
                "json_ld" => return Ok(Self::JsonLd),
                "microdata" => return Ok(Self::Microdata),
                "rdfa" => return Ok(Self::RDFa),
                _ => {}
            }
        }
        // Try to extract as integer (by discriminant value)
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::JsonLd),
                1 => return Ok(Self::Microdata),
                2 => return Ok(Self::RDFa),
                _ => {}
            }
        }
        let type_name = stringify!(StructuredDataType);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
...
impl TierStrategy {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            ...
            match s_lower.as_str() {
                "auto" => return Ok(Self::Auto),
                "tier2" => return Ok(Self::Tier2),
                "tier1" => return Ok(Self::Tier1),
                _ => {}
            }
        }
        // Try to extract as integer (by discriminant value)
        if let Ok(n) = value.extract::<i32>() {
            match n {
                ...
                1 => return Ok(Self::Tier2),
                2 => return Ok(Self::Tier1),
                _ => {}
            }
        }
        let type_name = stringify!(TierStrategy);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
    ...
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize TierStrategy: {e}")))
    }
...
impl OutputFormat {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            match s_lower.as_str() {
                "markdown" => return Ok(Self::Markdown),
                "djot" => return Ok(Self::Djot),
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::Markdown),
                1 => return Ok(Self::Djot),
                2 => return Ok(Self::Plain),
                _ => {}
            }
        }
        let type_name = stringify!(OutputFormat);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
...
impl NodeContent {
    ...
    fn new(
        ...
        //   NodeContent("variant_name")                     -> unit variant
        //   NodeContent({"type": "variant", ...})           -> dict positional
        //   NodeContent(type="variant", field=...)          -> kwargs (idiomatic)
        ...
        let json_str: String = if let Some(v) = value {
            if let Ok(s) = v.extract::<String>() {
                serde_json::to_string(&serde_json::json!({ "node_type": s }))
            ...
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "NodeContent() requires a positional value or keyword arguments".to_string(),
            ));
        };
    ...
    pub fn _factory_heading(level: u8, text: String) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::Heading { level, text },
        }
    }
    ...
    pub fn _factory_paragraph(text: String) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::Paragraph { text },
        }
    }
    ...
    pub fn _factory_list(ordered: bool) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::List { ordered },
        }
    }
    ...
    pub fn _factory_list_item(text: String) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::ListItem { text },
        }
    }

    #[pyo3(name = "table")]
    #[staticmethod]
    pub fn _factory_table(py: Python<'_>, grid: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: html_to_markdown_rs::NodeContent::Table {
                grid: __alef_coerce_dto(py, grid, __ALEF_WIRE_TABLE_GRID)?,
            },
        })
    }

    #[pyo3(name = "image")]
    #[pyo3(signature = (description=None, src=None, image_index=None))]
    #[staticmethod]
    pub fn _factory_image(description: Option<String>, src: Option<String>, image_index: Option<u32>) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::Image {
                description,
                src,
                image_index,
            },
    ...
    pub fn _factory_code(text: String, language: Option<String>) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::Code { text, language },
        }
    }

    #[pyo3(name = "definition_item")]
    #[staticmethod]
    pub fn _factory_definition_item(term: String, definition: String) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::DefinitionItem { term, definition },
        }
    }
    ...
    pub fn _factory_raw_block(format: String, content: String) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::RawBlock { format, content },
        }
    }

    #[pyo3(name = "metadata_block")]
    #[staticmethod]
    pub fn _factory_metadata_block(entries: Vec<MetadataEntry>) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::MetadataBlock {
    ...
    #[pyo3(name = "group")]
    #[pyo3(signature = (label=None, heading_level=None, heading_text=None))]
    #[staticmethod]
    pub fn _factory_group(label: Option<String>, heading_level: Option<u8>, heading_text: Option<String>) -> Self {
        Self {
            inner: html_to_markdown_rs::NodeContent::Group {
                label,
                heading_level,
                heading_text,
            },
...
impl AnnotationKind {
    ...
    fn new(
        ...
        // Accept three call shapes:
        //   AnnotationKind("variant_name")                     -> unit variant
        //   AnnotationKind({"type": "variant", ...})           -> dict positional
        //   AnnotationKind(type="variant", field=...)          -> kwargs (idiomatic)
        // Kwargs are assembled into a Python dict and re-serialized via json so
        // serde_json can deserialize into the tagged enum.
        let json_str: String = if let Some(v) = value {
            if let Ok(s) = v.extract::<String>() {
            ...
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "AnnotationKind() requires a positional value or keyword arguments".to_string(),
            ));
        };
    ...
    #[pyo3(name = "link")]
    #[pyo3(signature = (url, title=None))]
    #[staticmethod]
    pub fn _factory_link(url: String, title: Option<String>) -> Self {
        Self {
            inner: html_to_markdown_rs::AnnotationKind::Link { url, title },
        }
    }
}
...
impl WarningKind {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            let s_lower = s.to_lowercase();
            match s_lower.as_str() {
                "imageextractionfailed" => return Ok(Self::ImageExtractionFailed),
                "image_extraction_failed" => return Ok(Self::ImageExtractionFailed),
                "encodingfallback" => return Ok(Self::EncodingFallback),
                "encoding_fallback" => return Ok(Self::EncodingFallback),
                "truncatedinput" => return Ok(Self::TruncatedInput),
                "truncated_input" => return Ok(Self::TruncatedInput),
                "malformedhtml" => return Ok(Self::MalformedHtml),
                "malformed_html" => return Ok(Self::MalformedHtml),
                "sanitizationapplied" => return Ok(Self::SanitizationApplied),
                "sanitization_applied" => return Ok(Self::SanitizationApplied),
                "depthlimitexceeded" => return Ok(Self::DepthLimitExceeded),
                "depth_limit_exceeded" => return Ok(Self::DepthLimitExceeded),
                _ => {}
            }
        }
        // Try to extract as integer (by discriminant value)
        if let Ok(n) = value.extract::<i32>() {
            match n {
                0 => return Ok(Self::ImageExtractionFailed),
                1 => return Ok(Self::EncodingFallback),
                2 => return Ok(Self::TruncatedInput),
                3 => return Ok(Self::MalformedHtml),
                4 => return Ok(Self::SanitizationApplied),
                5 => return Ok(Self::DepthLimitExceeded),
                _ => {}
            }
        }
        let type_name = stringify!(WarningKind);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(s) = value.extract::<&str>() {
            ...
            match s_lower.as_str() {
                ...
                "heading" => return Ok(Self::Heading),
                "paragraph" => return Ok(Self::Paragraph),
                "div" => return Ok(Self::Div),
                "blockquote" => return Ok(Self::Blockquote),
                "pre" => return Ok(Self::Pre),
                "hr" => return Ok(Self::Hr),
                "list" => return Ok(Self::List),
                "listitem" => return Ok(Self::ListItem),
                "definitionlist" => return Ok(Self::DefinitionList),
                "definitionterm" => return Ok(Self::DefinitionTerm),
                "definitiondescription" => return Ok(Self::DefinitionDescription),
                "table" => return Ok(Self::Table),
                "tablerow" => return Ok(Self::TableRow),
                "tablecell" => return Ok(Self::TableCell),
                "tableheader" => return Ok(Self::TableHeader),
                "tablebody" => return Ok(Self::TableBody),
                "tablehead" => return Ok(Self::TableHead),
                "tablefoot" => return Ok(Self::TableFoot),
                "link" => return Ok(Self::Link),
                "image" => return Ok(Self::Image),
                "strong" => return Ok(Self::Strong),
                "em" => return Ok(Self::Em),
                "code" => return Ok(Self::Code),
                "strikethrough" => return Ok(Self::Strikethrough),
                "underline" => return Ok(Self::Underline),
                "subscript" => return Ok(Self::Subscript),
                "superscript" => return Ok(Self::Superscript),
                "mark" => return Ok(Self::Mark),
                "small" => return Ok(Self::Small),
                "br" => return Ok(Self::Br),
                "span" => return Ok(Self::Span),
                "article" => return Ok(Self::Article),
                "section" => return Ok(Self::Section),
                "nav" => return Ok(Self::Nav),
                "aside" => return Ok(Self::Aside),
                "header" => return Ok(Self::Header),
                "footer" => return Ok(Self::Footer),
                "main" => return Ok(Self::Main),
                "figure" => return Ok(Self::Figure),
                "figcaption" => return Ok(Self::Figcaption),
                "time" => return Ok(Self::Time),
                "details" => return Ok(Self::Details),
                "summary" => return Ok(Self::Summary),
                "form" => return Ok(Self::Form),
                "input" => return Ok(Self::Input),
                "select" => return Ok(Self::Select),
                "option" => return Ok(Self::Option),
                "button" => return Ok(Self::Button),
                "textarea" => return Ok(Self::Textarea),
                "label" => return Ok(Self::Label),
                "fieldset" => return Ok(Self::Fieldset),
                "legend" => return Ok(Self::Legend),
                "audio" => return Ok(Self::Audio),
                "video" => return Ok(Self::Video),
                "picture" => return Ok(Self::Picture),
                "source" => return Ok(Self::Source),
                "iframe" => return Ok(Self::Iframe),
                "svg" => return Ok(Self::Svg),
                "canvas" => return Ok(Self::Canvas),
                "ruby" => return Ok(Self::Ruby),
                "rt" => return Ok(Self::Rt),
                "rp" => return Ok(Self::Rp),
                "abbr" => return Ok(Self::Abbr),
                "kbd" => return Ok(Self::Kbd),
                "samp" => return Ok(Self::Samp),
                "var" => return Ok(Self::Var),
                "cite" => return Ok(Self::Cite),
                "q" => return Ok(Self::Q),
                "del" => return Ok(Self::Del),
                "ins" => return Ok(Self::Ins),
                "data" => return Ok(Self::Data),
                "meter" => return Ok(Self::Meter),
                "progress" => return Ok(Self::Progress),
                "output" => return Ok(Self::Output),
                "template" => return Ok(Self::Template),
                "slot" => return Ok(Self::Slot),
                "html" => return Ok(Self::Html),
                "head" => return Ok(Self::Head),
                "body" => return Ok(Self::Body),
                "title" => return Ok(Self::Title),
                "meta" => return Ok(Self::Meta),
                "linktag" => return Ok(Self::LinkTag),
                "style" => return Ok(Self::Style),
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                ...
                2 => return Ok(Self::Heading),
                3 => return Ok(Self::Paragraph),
                4 => return Ok(Self::Div),
                5 => return Ok(Self::Blockquote),
                6 => return Ok(Self::Pre),
                7 => return Ok(Self::Hr),
                8 => return Ok(Self::List),
                9 => return Ok(Self::ListItem),
                10 => return Ok(Self::DefinitionList),
                11 => return Ok(Self::DefinitionTerm),
                12 => return Ok(Self::DefinitionDescription),
                13 => return Ok(Self::Table),
                14 => return Ok(Self::TableRow),
                15 => return Ok(Self::TableCell),
                16 => return Ok(Self::TableHeader),
                17 => return Ok(Self::TableBody),
                18 => return Ok(Self::TableHead),
                19 => return Ok(Self::TableFoot),
                20 => return Ok(Self::Link),
                21 => return Ok(Self::Image),
                22 => return Ok(Self::Strong),
                23 => return Ok(Self::Em),
                24 => return Ok(Self::Code),
                25 => return Ok(Self::Strikethrough),
                26 => return Ok(Self::Underline),
                27 => return Ok(Self::Subscript),
                28 => return Ok(Self::Superscript),
                29 => return Ok(Self::Mark),
                30 => return Ok(Self::Small),
                31 => return Ok(Self::Br),
                32 => return Ok(Self::Span),
                33 => return Ok(Self::Article),
                34 => return Ok(Self::Section),
                35 => return Ok(Self::Nav),
                36 => return Ok(Self::Aside),
                37 => return Ok(Self::Header),
                38 => return Ok(Self::Footer),
                39 => return Ok(Self::Main),
                40 => return Ok(Self::Figure),
                41 => return Ok(Self::Figcaption),
                42 => return Ok(Self::Time),
                43 => return Ok(Self::Details),
                44 => return Ok(Self::Summary),
                45 => return Ok(Self::Form),
                46 => return Ok(Self::Input),
                47 => return Ok(Self::Select),
                48 => return Ok(Self::Option),
                49 => return Ok(Self::Button),
                50 => return Ok(Self::Textarea),
                51 => return Ok(Self::Label),
                52 => return Ok(Self::Fieldset),
                53 => return Ok(Self::Legend),
                54 => return Ok(Self::Audio),
                55 => return Ok(Self::Video),
                56 => return Ok(Self::Picture),
                57 => return Ok(Self::Source),
                58 => return Ok(Self::Iframe),
                59 => return Ok(Self::Svg),
                60 => return Ok(Self::Canvas),
                61 => return Ok(Self::Ruby),
                62 => return Ok(Self::Rt),
                63 => return Ok(Self::Rp),
                64 => return Ok(Self::Abbr),
                65 => return Ok(Self::Kbd),
                66 => return Ok(Self::Samp),
                67 => return Ok(Self::Var),
                68 => return Ok(Self::Cite),
                69 => return Ok(Self::Q),
                70 => return Ok(Self::Del),
                71 => return Ok(Self::Ins),
                72 => return Ok(Self::Data),
                73 => return Ok(Self::Meter),
                74 => return Ok(Self::Progress),
                75 => return Ok(Self::Output),
                76 => return Ok(Self::Template),
                77 => return Ok(Self::Slot),
                78 => return Ok(Self::Html),
                79 => return Ok(Self::Head),
                80 => return Ok(Self::Body),
                81 => return Ok(Self::Title),
                82 => return Ok(Self::Meta),
                83 => return Ok(Self::LinkTag),
                84 => return Ok(Self::Style),
                85 => return Ok(Self::Script),
                86 => return Ok(Self::Base),
                87 => return Ok(Self::Custom),
                _ => {}
            }
        }
        let type_name = stringify!(NodeType);
        Err(pyo3::exceptions::PyValueError::new_err(format!(
            "invalid value for {}: {:#?}. Expected variant name (str) or discriminant (int)",
            type_name, value
        )))
...
impl VisitResult {
    ...
    fn new(
        ...
        // Accept three call shapes:
        //   VisitResult("variant_name")                     -> unit variant
        //   VisitResult({"type": "variant", ...})           -> dict positional
        //   VisitResult(type="variant", field=...)          -> kwargs (idiomatic)
        // Kwargs are assembled into a Python dict and re-serialized via json so
        // serde_json can deserialize into the tagged enum.
        let json_str: String = if let Some(v) = value {
            if let Ok(s) = v.extract::<String>() {
            ...
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "VisitResult() requires a positional value or keyword arguments".to_string(),
            ));
        };
...
pub fn convert(
    ...
    let visitor_handle: Option<html_to_markdown_rs::VisitorHandle> = visitor.map(|v| {
        let bridge = PyHtmlVisitorBridge::new(v);
        std::sync::Arc::new(std::sync::Mutex::new(bridge)) as html_to_markdown_rs::VisitorHandle
    });
...
#[pyclass(name = "HtmlVisitor")]
pub struct PyHtmlVisitorMarker;
    ...
    T: pyo3::IntoPyObjectExt<'py>,
{
    ...
    py.import("_html_to_markdown.options")
    ...
    fn visit_text(&mut self, _ctx: &html_to_markdown_rs::NodeContext, _text: &str) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_text", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_text' raised; using default action: {e}");
                    ...
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_text' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_text' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_element_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_element_start", (nodecontext_to_py_dict(py, _ctx),)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_element_start' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_element_start' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_element_start' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_element_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_element_end", (nodecontext_to_py_dict(py, _ctx), _output)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_element_end' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_element_end' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_element_end' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_link(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_link", (nodecontext_to_py_dict(py, _ctx), _href, _text, _title)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_link' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_link' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_link' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_image(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_image", (nodecontext_to_py_dict(py, _ctx), _src, _alt, _title)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_image' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_image' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_image' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_heading(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_heading", (nodecontext_to_py_dict(py, _ctx), _level, _text, _id)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_heading' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_heading' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_heading' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_code_block(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_code_block", (nodecontext_to_py_dict(py, _ctx), _lang, _code)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_code_block' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_code_block' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_code_block' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_code_inline(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_code_inline", (nodecontext_to_py_dict(py, _ctx), _code)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_code_inline' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_code_inline' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_code_inline' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_list_item(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1(
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_list_item' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_list_item' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_list_item' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_list_start(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_list_start", (nodecontext_to_py_dict(py, _ctx), _ordered)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_list_start' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_list_start' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_list_start' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_list_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_list_end", (nodecontext_to_py_dict(py, _ctx), _ordered, _output)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_list_end' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_list_end' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_list_end' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_table_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_table_start", (nodecontext_to_py_dict(py, _ctx),)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_table_start' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_table_start' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_table_start' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_table_row(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1(
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_table_row' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_table_row' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_table_row' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_table_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_table_end", (nodecontext_to_py_dict(py, _ctx), _output)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_table_end' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_table_end' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_table_end' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_blockquote(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_blockquote", (nodecontext_to_py_dict(py, _ctx), _content, _depth)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_blockquote' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_blockquote' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_blockquote' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_strong(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_strong", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_strong' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_strong' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_strong' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_emphasis(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_emphasis", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_emphasis' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_emphasis' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_emphasis' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_strikethrough(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_strikethrough", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_strikethrough' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_strikethrough' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_strikethrough' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_underline(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_underline", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_underline' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_underline' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_underline' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_subscript(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_subscript", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_subscript' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_subscript' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_subscript' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_superscript(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_superscript", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_superscript' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_superscript' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_superscript' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_mark(&mut self, _ctx: &html_to_markdown_rs::NodeContext, _text: &str) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_mark", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_mark' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_mark' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_mark' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_line_break(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_line_break", (nodecontext_to_py_dict(py, _ctx),)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_line_break' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_line_break' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_line_break' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_horizontal_rule(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_horizontal_rule", (nodecontext_to_py_dict(py, _ctx),)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_horizontal_rule' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_horizontal_rule' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_horizontal_rule' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_custom_element(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1(
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_custom_element' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_custom_element' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_custom_element' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_definition_list_start(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_definition_list_start", (nodecontext_to_py_dict(py, _ctx),)) {
                ...
                Err(e) => {
                    eprintln!(
                        "[PyHtmlVisitorBridge] host 'visit_definition_list_start' raised; using default action: {e}"
                    );
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_list_start' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_list_start' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_definition_term(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_definition_term", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_term' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_term' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_term' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_definition_description(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1(
                ...
                Err(e) => {
                    eprintln!(
                        "[PyHtmlVisitorBridge] host 'visit_definition_description' raised; using default action: {e}"
                    );
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_description' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_description' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_definition_list_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_definition_list_end", (nodecontext_to_py_dict(py, _ctx), _output)) {
                ...
                Err(e) => {
                    eprintln!(
                        "[PyHtmlVisitorBridge] host 'visit_definition_list_end' raised; using default action: {e}"
                    );
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_list_end' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_definition_list_end' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_form(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_form", (nodecontext_to_py_dict(py, _ctx), _action, _method)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_form' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_form' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_form' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_input(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1(
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_input' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_input' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_input' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_button(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_button", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_button' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_button' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_button' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_audio(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_audio", (nodecontext_to_py_dict(py, _ctx), _src)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_audio' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_audio' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_audio' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_video(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_video", (nodecontext_to_py_dict(py, _ctx), _src)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_video' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_video' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_video' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_iframe(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_iframe", (nodecontext_to_py_dict(py, _ctx), _src)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_iframe' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_iframe' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_iframe' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_details(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_details", (nodecontext_to_py_dict(py, _ctx), _open)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_details' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_details' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_details' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_summary(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_summary", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_summary' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_summary' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_summary' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_figure_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_figure_start", (nodecontext_to_py_dict(py, _ctx),)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_figure_start' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_figure_start' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_figure_start' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_figcaption(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_figcaption", (nodecontext_to_py_dict(py, _ctx), _text)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_figcaption' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_figcaption' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_figcaption' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
    ...
    fn visit_figure_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_figure_end", (nodecontext_to_py_dict(py, _ctx), _output)) {
                ...
                // exception before substituting the default action.
                Err(e) => {
                    eprintln!("[PyHtmlVisitorBridge] host 'visit_figure_end' raised; using default action: {e}");
                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        ...
                        if let Ok(d) = py_dict {
                            if let Some(v) = d.get_item("Custom").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Custom(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_figure_end' returned a non-string 'Custom' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            if let Some(v) = d.get_item("Error").ok().flatten() {
                                return html_to_markdown_rs::VisitResult::Error(v.extract::<String>().unwrap_or_else(|e| {
                                eprintln!("[PyHtmlVisitorBridge] host 'visit_figure_end' returned a non-string 'Error' payload; using empty string: {e}");
                                String::new()
                            }));
                            }
                            html_to_markdown_rs::VisitResult::Continue
...
pyo3::create_exception!(_html_to_markdown, ParseError, ConversionError);
pyo3::create_exception!(_html_to_markdown, SanitizationError, ConversionError);
pyo3::create_exception!(_html_to_markdown, ConfigError, ConversionError);
pyo3::create_exception!(_html_to_markdown, IoError, ConversionError);
pyo3::create_exception!(_html_to_markdown, PanicError, ConversionError);
pyo3::create_exception!(_html_to_markdown, InvalidInputError, ConversionError);
pyo3::create_exception!(_html_to_markdown, OtherError, ConversionError);
...
pub fn _html_to_markdown(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<PyHtmlVisitorMarker>()?;
