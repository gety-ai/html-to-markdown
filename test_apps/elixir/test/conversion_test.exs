...
# alef:hash:947f387d8329002e5e14a71eed6e003d13ef9245f7f717527dd5a5d8c502e371
...
defmodule E2e.ConversionTest do
  ...
  describe "blockquote_multiple_paragraphs" do
    test "blockquote_multiple_paragraphs" do
      {:ok, result} = HtmlToMarkdown.convert("<blockquote><p>First paragraph.</p><p>Second paragraph.</p></blockquote>", nil)
  ...
  describe "blockquote_nested" do
    test "blockquote_nested" do
      {:ok, result} = HtmlToMarkdown.convert("<blockquote><p>Outer quote.</p><blockquote><p>Inner quote.</p></blockquote></blockquote>", nil)
  ...
  describe "blockquote_simple" do
    test "blockquote_simple" do
      {:ok, result} = HtmlToMarkdown.convert("<blockquote><p>Quote text</p></blockquote>", nil)
  ...
  describe "blockquote_with_list" do
    test "blockquote_with_list" do
      {:ok, result} = HtmlToMarkdown.convert("<blockquote><p>Quote intro:</p><ul><li>Point one</li><li>Point two</li></ul></blockquote>", nil)
      assert result.content != ""
  ...
  describe "bold_and_italic" do
    test "bold_and_italic" do
      {:ok, result} = HtmlToMarkdown.convert("<p><strong><em>both</em></strong></p>", nil)
  ...
  describe "bold_strong" do
    test "bold_strong" do
      {:ok, result} = HtmlToMarkdown.convert("<p><strong>bold</strong></p>", nil)
  ...
  describe "code_block" do
    test "code_block" do
      {:ok, result} = HtmlToMarkdown.convert("<pre><code class=\"language-python\">print('hello')</code></pre>", nil)
      assert result.content != ""
  ...
  describe "code_block_no_language" do
    test "code_block_no_language" do
      {:ok, result} = HtmlToMarkdown.convert("<pre><code>plain code here</code></pre>", nil)
      assert result.content != ""
  ...
  describe "code_inline_in_paragraph" do
    test "code_inline_in_paragraph" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Call the <code>initialize()</code> method first.</p>", nil)
  ...
  describe "code_with_backticks_in_content" do
    test "code_with_backticks_in_content" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Use <code>`backtick` here</code> carefully.</p>", nil)
      assert result.content != ""
  ...
  describe "emphasis_mark_highlight" do
    test "emphasis_mark_highlight" do
      {:ok, result} = HtmlToMarkdown.convert("<p><mark>highlighted</mark></p>", nil)
      assert result.content != ""
  ...
  describe "emphasis_strikethrough_del" do
    test "emphasis_strikethrough_del" do
      {:ok, result} = HtmlToMarkdown.convert("<p><del>deleted text</del></p>", nil)
  ...
  describe "emphasis_strikethrough_s" do
    test "emphasis_strikethrough_s" do
      {:ok, result} = HtmlToMarkdown.convert("<p><s>strikethrough</s></p>", nil)
  ...
  describe "emphasis_subscript" do
    test "emphasis_subscript" do
      {:ok, result} = HtmlToMarkdown.convert("<p>H<sub>2</sub>O</p>", nil)
  ...
  describe "emphasis_superscript" do
    test "emphasis_superscript" do
      {:ok, result} = HtmlToMarkdown.convert("<p>x<sup>2</sup></p>", nil)
  ...
  describe "emphasis_underline_u" do
    test "emphasis_underline_u" do
      {:ok, result} = HtmlToMarkdown.convert("<p><u>underlined</u></p>", nil)
  ...
  describe "form_input_elements" do
    test "form_input_elements" do
      ...
      options = %{options | preprocessing: %{"remove_forms" => false}}
  ...
  describe "heading_h1" do
    test "heading_h1" do
      {:ok, result} = HtmlToMarkdown.convert("<h1>Heading 1</h1>", nil)
  ...
  describe "heading_h2" do
    test "heading_h2" do
      {:ok, result} = HtmlToMarkdown.convert("<h2>Heading 2</h2>", nil)
  ...
  describe "heading_h3" do
    test "heading_h3" do
      {:ok, result} = HtmlToMarkdown.convert("<h3>Heading 3</h3>", nil)
  ...
  describe "heading_h4" do
    test "heading_h4" do
      {:ok, result} = HtmlToMarkdown.convert("<h4>Heading 4</h4>", nil)
  ...
  describe "heading_h5" do
    test "heading_h5" do
      {:ok, result} = HtmlToMarkdown.convert("<h5>Heading 5</h5>", nil)
  ...
  describe "heading_h6" do
    test "heading_h6" do
      {:ok, result} = HtmlToMarkdown.convert("<h6>Heading 6</h6>", nil)
  ...
  describe "image_figure_figcaption" do
    test "image_figure_figcaption" do
      {:ok, result} = HtmlToMarkdown.convert("<figure><img src=\"sunset.jpg\" alt=\"A sunset\"><figcaption>Beautiful sunset over the ocean</figcaption></figure>", nil)
  ...
  describe "image_linked" do
    test "image_linked" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"https://example.com\"><img src=\"icon.png\" alt=\"Icon\"></a>", nil)
  ...
  describe "image_no_alt" do
    test "image_no_alt" do
      {:ok, result} = HtmlToMarkdown.convert("<img src=\"banner.jpg\">", nil)
      assert result.content != ""
  ...
  describe "image_simple" do
    test "image_simple" do
      {:ok, result} = HtmlToMarkdown.convert("<img src=\"photo.jpg\" alt=\"A photo\">", nil)
  ...
  describe "image_with_title" do
    test "image_with_title" do
      {:ok, result} = HtmlToMarkdown.convert("<img src=\"chart.png\" alt=\"Sales chart\" title=\"Q3 Sales\">", nil)
  ...
  describe "inline_code" do
    test "inline_code" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Use <code>console.log()</code> to debug</p>", nil)
  ...
  describe "italic_em" do
    test "italic_em" do
      {:ok, result} = HtmlToMarkdown.convert("<p><em>italic</em></p>", nil)
  ...
  describe "line_break_br_tag" do
    test "line_break_br_tag" do
      {:ok, result} = HtmlToMarkdown.convert("<p>First line.<br>Second line.</p>", nil)
  ...
  describe "line_break_hr_tag" do
    test "line_break_hr_tag" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Before rule.</p><hr><p>After rule.</p>", nil)
      assert result.content != ""
  ...
  describe "line_break_multiple_br" do
    test "line_break_multiple_br" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Start.<br><br>End.</p>", nil)
  ...
  describe "link_anchor_fragment" do
    test "link_anchor_fragment" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"\#section\">Jump to section</a>", nil)
  ...
  describe "link_empty_href" do
    test "link_empty_href" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"\">No destination</a>", nil)
  ...
  describe "link_image_inside" do
    test "link_image_inside" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"https://example.com\"><img src=\"logo.png\" alt=\"Logo\"></a>", nil)
  ...
  describe "link_mailto" do
    test "link_mailto" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"mailto:user@example.com\">Email us</a>", nil)
  ...
  describe "link_simple" do
    test "link_simple" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"https://example.com\">Example</a>", nil)
  ...
  describe "link_with_bold_text" do
    test "link_with_bold_text" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"https://example.com\"><strong>Bold link</strong></a>", nil)
  ...
  describe "link_with_title" do
    test "link_with_title" do
      {:ok, result} = HtmlToMarkdown.convert("<a href=\"https://example.com\" title=\"Example Site\">Example</a>", nil)
      assert String.contains?(to_string(result.content), "[Example](https://example.com")
  ...
  describe "list_definition_dl" do
    test "list_definition_dl" do
      {:ok, result} = HtmlToMarkdown.convert("<dl><dt>Term One</dt><dd>Definition of term one.</dd><dt>Term Two</dt><dd>Definition of term two.</dd></dl>", nil)
  ...
  describe "list_item_multiple_paragraphs" do
    test "list_item_multiple_paragraphs" do
      {:ok, result} = HtmlToMarkdown.convert("<ul><li><p>First paragraph in item.</p><p>Second paragraph in item.</p></li><li>Simple item</li></ul>", nil)
  ...
  describe "list_mixed_nested" do
    test "list_mixed_nested" do
      {:ok, result} = HtmlToMarkdown.convert("<ul><li>Item A<ol><li>Sub 1</li><li>Sub 2</li></ol></li><li>Item B</li></ul>", nil)
  ...
  describe "list_nested_ordered" do
    test "list_nested_ordered" do
      {:ok, result} = HtmlToMarkdown.convert("<ol><li>Step 1<ol><li>Step 1a</li><li>Step 1b</li></ol></li><li>Step 2</li></ol>", nil)
  ...
  describe "list_nested_unordered" do
    test "list_nested_unordered" do
      {:ok, result} = HtmlToMarkdown.convert("<ul><li>Parent A<ul><li>Child A1</li><li>Child A2</li></ul></li><li>Parent B</li></ul>", nil)
  ...
  describe "list_task_checkboxes" do
    test "list_task_checkboxes" do
      {:ok, result} = HtmlToMarkdown.convert("<ul><li><input type=\"checkbox\" checked> Done task</li><li><input type=\"checkbox\"> Pending task</li></ul>", nil)
      assert result.content != ""
  ...
  describe "ordered_list" do
    test "ordered_list" do
      {:ok, result} = HtmlToMarkdown.convert("<ol><li>First</li><li>Second</li><li>Third</li></ol>", nil)
  ...
  describe "paragraph_multiple" do
    test "paragraph_multiple" do
      {:ok, result} = HtmlToMarkdown.convert("<p>First paragraph.</p><p>Second paragraph.</p>", nil)
      assert String.contains?(to_string(result.content), "First paragraph.")
      assert String.contains?(to_string(result.content), "Second paragraph.")
    end
  end
  ...
  describe "paragraph_nested_divs" do
    test "paragraph_nested_divs" do
      {:ok, result} = HtmlToMarkdown.convert("<div><div><p>Nested text</p></div></div>", nil)
  ...
  describe "paragraph_with_inline_formatting" do
    test "paragraph_with_inline_formatting" do
      {:ok, result} = HtmlToMarkdown.convert("<p>This has <strong>bold</strong>, <em>italic</em>, and a <a href=\"https://example.com\">link</a>.</p>", nil)
      assert String.contains?(to_string(result.content), "**bold**")
      assert String.contains?(to_string(result.content), "*italic*")
  ...
  describe "paragraph_with_line_breaks" do
    test "paragraph_with_line_breaks" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Line one.<br>Line two.<br>Line three.</p>", nil)
      assert result.content != ""
  ...
  describe "semantic_abbr" do
    test "semantic_abbr" do
      {:ok, result} = HtmlToMarkdown.convert("<p>The <abbr title=\"World Wide Web\">WWW</abbr> is global.</p>", nil)
  ...
  describe "semantic_article" do
    test "semantic_article" do
      {:ok, result} = HtmlToMarkdown.convert("<article><h2>Article Title</h2><p>Article body.</p></article>", nil)
  ...
  describe "semantic_definition_list" do
    test "semantic_definition_list" do
      {:ok, result} = HtmlToMarkdown.convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", nil)
  ...
  describe "semantic_details_summary" do
    test "semantic_details_summary" do
      {:ok, result} = HtmlToMarkdown.convert("<details><summary>Click to expand</summary><p>Hidden content here.</p></details>", nil)
      assert result.content != ""
  ...
  describe "semantic_hr" do
    test "semantic_hr" do
      {:ok, result} = HtmlToMarkdown.convert("<p>Above</p><hr><p>Below</p>", nil)
      assert result.content != ""
  ...
  describe "semantic_mark_highlight" do
    test "semantic_mark_highlight" do
      {:ok, result} = HtmlToMarkdown.convert("<p>This is <mark>highlighted text</mark> in a sentence.</p>", nil)
      assert result.content != ""
  ...
  describe "semantic_section_with_heading" do
    test "semantic_section_with_heading" do
      {:ok, result} = HtmlToMarkdown.convert("<section><h3>Section Heading</h3><p>Section content.</p></section>", nil)
  ...
  describe "semantic_sub_superscript" do
    test "semantic_sub_superscript" do
      {:ok, result} = HtmlToMarkdown.convert("<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>", nil)
      assert result.content != ""
      assert String.contains?(to_string(result.content), "H")
      assert String.contains?(to_string(result.content), "2")
      assert String.contains?(to_string(result.content), "O")
  ...
  describe "simple_table" do
    test "simple_table" do
      {:ok, result} = HtmlToMarkdown.convert("<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", nil)
      assert String.contains?(to_string(result.content), "Name")
  ...
  describe "table_empty" do
    test "table_empty" do
      {:ok, result} = HtmlToMarkdown.convert("<table></table>", nil)
  ...
  describe "table_no_thead" do
    test "table_no_thead" do
      {:ok, result} = HtmlToMarkdown.convert("<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</td><td>1.00</td></tr></table>", nil)
      assert result.content != ""
  ...
  describe "table_pipe_chars_in_content" do
    test "table_pipe_chars_in_content" do
      {:ok, result} = HtmlToMarkdown.convert("<table><thead><tr><th>Expression</th><th>Result</th></tr></thead><tbody><tr><td>a | b</td><td>true</td></tr></tbody></table>", nil)
      assert result.content != ""
  ...
  describe "table_with_alignment" do
    test "table_with_alignment" do
      {:ok, result} = HtmlToMarkdown.convert("<table><thead><tr><th align=\"left\">Left</th><th align=\"center\">Center</th><th align=\"right\">Right</th></tr></thead><tbody><tr><td>L</td><td>C</td><td>R</td></tr></tbody></table>", nil)
      assert result.content != ""
  ...
  describe "table_with_colspan" do
    test "table_with_colspan" do
      {:ok, result} = HtmlToMarkdown.convert("<table><thead><tr><th colspan=\"2\">Full Name</th></tr></thead><tbody><tr><td>John</td><td>Doe</td></tr></tbody></table>", nil)
      assert result.content != ""
  ...
  describe "unordered_list" do
    test "unordered_list" do
      {:ok, result} = HtmlToMarkdown.convert("<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>", nil)
