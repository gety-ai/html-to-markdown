...
# Installs the xberg-io/html-to-markdown extension via PIE before `composer install` runs.
...
"$PIE" install "xberg-io/html-to-markdown:$VERSION" --skip-enable-extension
