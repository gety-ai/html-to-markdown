...
// alef:hash:8cce7ec1443e1d561b73670551bc7ce7bf4f9b81cf66f7c5675a7285865f3ebf
...
func Test_BlockquoteNested(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Outer quote.`) {
			t.Errorf("expected to contain %s", `Outer quote.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Inner quote.`) {
...
func Test_BlockquoteSimple(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `> Quote text`) {
...
func Test_BlockquoteWithList(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Quote intro:`) {
			t.Errorf("expected to contain %s", `Quote intro:`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Point one`) {
			t.Errorf("expected to contain %s", `Point one`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Point two`) {
...
func Test_BoldAndItalic(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `***both***`) {
...
func Test_CodeBlock(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `print('hello')`) {
...
func Test_CodeBlockNoLanguage(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `plain code here`) {
...
func Test_CodeInlineInParagraph(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), "`initialize()`") {
...
func Test_CodeWithBackticksInContent(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `backtick`) {
...
func Test_EmphasisStrikethroughDel(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `~~deleted text~~`) {
...
func Test_EmphasisStrikethroughS(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `~~strikethrough~~`) {
...
func Test_EmphasisSubscript(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `H`) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `O`) {
...
func Test_EmphasisSuperscript(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `x`) {
...
func Test_EmphasisUnderlineU(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `underlined`) {
...
func Test_FormSelectOptions(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Color`) {
...
func Test_FormTextarea(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Message`) {
...
func Test_HeadingH1(t *testing.T) {
	...
	if strings.TrimSpace(string(content)) != `# Heading 1` {
...
func Test_HeadingH2(t *testing.T) {
	...
	if strings.TrimSpace(string(content)) != `## Heading 2` {
		t.Errorf("equals mismatch: got %v", content)
	}
}
...
func Test_HeadingH3(t *testing.T) {
	...
	if strings.TrimSpace(string(content)) != `### Heading 3` {
		t.Errorf("equals mismatch: got %v", content)
	}
}
...
func Test_HeadingH4(t *testing.T) {
	...
	if strings.TrimSpace(string(content)) != `#### Heading 4` {
		t.Errorf("equals mismatch: got %v", content)
	}
}
...
func Test_HeadingH5(t *testing.T) {
	...
	if strings.TrimSpace(string(content)) != `##### Heading 5` {
		t.Errorf("equals mismatch: got %v", content)
	}
}
...
func Test_HeadingH6(t *testing.T) {
	...
	if strings.TrimSpace(string(content)) != `###### Heading 6` {
		t.Errorf("equals mismatch: got %v", content)
	}
}
...
func Test_ImageFigureFigcaption(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `![A sunset](sunset.jpg)`) {
			t.Errorf("expected to contain %s", `![A sunset](sunset.jpg)`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Beautiful sunset over the ocean`) {
...
func Test_ImageLinked(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `![Icon](icon.png)`) {
...
func Test_ImageNoAlt(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `banner.jpg`) {
...
func Test_ImageSimple(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `![A photo](photo.jpg)`) {
...
func Test_ImageWithTitle(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `![Sales chart](chart.png`) {
			t.Errorf("expected to contain %s", `![Sales chart](chart.png`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Q3 Sales`) {
...
func Test_InlineCode(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), "`console.log()`") {
...
func Test_ItalicEm(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `*italic*`) {
...
func Test_LineBreakBrTag(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `First line.`) {
			t.Errorf("expected to contain %s", `First line.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Second line.`) {
...
func Test_LineBreakHrTag(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Before rule.`) {
			t.Errorf("expected to contain %s", `Before rule.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `After rule.`) {
...
func Test_LineBreakMultipleBr(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Start.`) {
			t.Errorf("expected to contain %s", `Start.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `End.`) {
...
func Test_LinkAnchorFragment(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `[Jump to section](#section)`) {
...
func Test_LinkEmptyHref(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `No destination`) {
...
func Test_LinkImageInside(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `![Logo](logo.png)`) {
...
func Test_LinkMailto(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `mailto:user@example.com`) {
...
func Test_LinkSimple(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `[Example](https://example.com)`) {
...
func Test_LinkWithBoldText(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `**Bold link**`) {
...
func Test_LinkWithTitle(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Example Site`) {
...
func Test_ListDefinitionDl(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Term One`) {
			t.Errorf("expected to contain %s", `Term One`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Definition of term one.`) {
			t.Errorf("expected to contain %s", `Definition of term one.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Term Two`) {
			t.Errorf("expected to contain %s", `Term Two`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Definition of term two.`) {
...
func Test_ListItemMultipleParagraphs(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `First paragraph in item.`) {
			t.Errorf("expected to contain %s", `First paragraph in item.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Second paragraph in item.`) {
			t.Errorf("expected to contain %s", `Second paragraph in item.`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Simple item`) {
...
func Test_ListMixedNested(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Sub 1`) {
			t.Errorf("expected to contain %s", `Sub 1`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Sub 2`) {
...
func Test_ListNestedOrdered(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Step 1`) {
			t.Errorf("expected to contain %s", `Step 1`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Step 1a`) {
			t.Errorf("expected to contain %s", `Step 1a`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Step 1b`) {
			t.Errorf("expected to contain %s", `Step 1b`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Step 2`) {
...
func Test_ListNestedUnordered(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Parent A`) {
			t.Errorf("expected to contain %s", `Parent A`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Child A1`) {
			t.Errorf("expected to contain %s", `Child A1`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Child A2`) {
			t.Errorf("expected to contain %s", `Child A2`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Parent B`) {
...
func Test_ListTaskCheckboxes(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Done task`) {
			t.Errorf("expected to contain %s", `Done task`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Pending task`) {
...
func Test_OrderedList(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `1. First`) {
			t.Errorf("expected to contain %s", `1. First`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `2. Second`) {
			t.Errorf("expected to contain %s", `2. Second`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `3. Third`) {
...
func Test_ParagraphNestedDivs(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Nested text`) {
...
func Test_ParagraphWithInlineFormatting(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `[link](https://example.com)`) {
...
func Test_ParagraphWithLineBreaks(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Line three.`) {
...
func Test_SemanticAbbr(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `WWW`) {
...
func Test_SemanticArticle(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Article Title`) {
			t.Errorf("expected to contain %s", `Article Title`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Article body.`) {
...
func Test_SemanticDefinitionList(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `HTML`) {
			t.Errorf("expected to contain %s", `HTML`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `HyperText Markup Language`) {
			t.Errorf("expected to contain %s", `HyperText Markup Language`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `CSS`) {
			t.Errorf("expected to contain %s", `CSS`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Cascading Style Sheets`) {
...
func Test_SemanticDetailsSummary(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Click to expand`) {
...
func Test_SemanticHr(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Above`) {
			t.Errorf("expected to contain %s", `Above`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Below`) {
...
func Test_SemanticMarkHighlight(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `highlighted text`) {
...
func Test_SemanticSectionWithHeading(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Section Heading`) {
			t.Errorf("expected to contain %s", `Section Heading`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Section content.`) {
...
func Test_SemanticSubSuperscript(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `E=mc`) {
...
func Test_SimpleTable(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Age`) {
			t.Errorf("expected to contain %s", `Age`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Alice`) {
			t.Errorf("expected to contain %s", `Alice`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `30`) {
...
func Test_TableNoThead(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Apple`) {
			t.Errorf("expected to contain %s", `Apple`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `1.00`) {
...
func Test_TablePipeCharsInContent(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Expression`) {
			t.Errorf("expected to contain %s", `Expression`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Result`) {
			t.Errorf("expected to contain %s", `Result`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `true`) {
...
func Test_TableWithAlignment(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Left`) {
			t.Errorf("expected to contain %s", `Left`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Center`) {
			t.Errorf("expected to contain %s", `Center`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Right`) {
			t.Errorf("expected to contain %s", `Right`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `L`) {
			t.Errorf("expected to contain %s", `L`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `C`) {
			t.Errorf("expected to contain %s", `C`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `R`) {
...
func Test_TableWithColspan(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Full Name`) {
			t.Errorf("expected to contain %s", `Full Name`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `John`) {
			t.Errorf("expected to contain %s", `John`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Doe`) {
...
func Test_UnorderedList(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `- Item 1`) {
			t.Errorf("expected to contain %s", `- Item 1`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `- Item 2`) {
			t.Errorf("expected to contain %s", `- Item 2`)
		}
	}
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `- Item 3`) {
