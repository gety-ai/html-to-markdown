...
group = "dev.kreuzberg.android"
version = "0.1.0"

android {
    namespace = "dev.kreuzberg.android.e2e"
    compileSdk = 35
...
dependencies {
    ...
    implementation("dev.kreuzberg:html-to-markdown-android:3.6.0-rc.10")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "dev.kreuzberg:html-to-markdown-android:3.6.0-rc.10"
