...
## Elixir API Reference <span class="version-badge">v3.6.0-rc.7</span>
...
| `metadata_block` | A block of key-value metadata pairs (from `<head>` meta tags). — Fields: `entries`: `list(list(String.t()))` |
