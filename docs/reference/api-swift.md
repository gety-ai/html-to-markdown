...
## Swift API Reference <span class="version-badge">v3.5.0-rc.3</span>
...
| `images`   | `[String]`            | `[]`    | Extracted inline images (data URIs and SVGs). Populated when `extract_images` is `true` in options.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
