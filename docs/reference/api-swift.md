...
## Swift API Reference <span class="version-badge">v3.6.0-rc.10</span>
...
| `attributes` | `[String: String]` | — | All HTML attributes as key-value pairs |
