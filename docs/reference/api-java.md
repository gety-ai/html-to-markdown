...
## Java API Reference <span class="version-badge">v3.6.0-rc.10</span>
...
| `dimensions` | `Optional<ImageDimensions>` | `null` | Image dimensions in pixels, if available. |
