...
## Java API Reference <span class="version-badge">v3.6.0-rc.3</span>
...
| `METADATA_BLOCK` | A block of key-value metadata pairs (from `<head>` meta tags). — Fields: `entries`: `List<List<String>>` |
