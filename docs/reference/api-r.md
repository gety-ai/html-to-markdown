...
## R API Reference <span class="version-badge">v3.8.0-rc.1</span>
...
`list` when sanitized for cross-language binding generation.
...
`list`. When the context was built with
