...
## C# API Reference <span class="version-badge">v3.4.0-rc.20</span>
...
```csharp
public static ConversionResult Convert(string html, ConversionOptions? options = null, string? visitor = null)
```
