...
## Rust API Reference <span class="version-badge">v3.6.0-rc.5</span>
...
| `MetadataBlock` | A block of key-value metadata pairs (from `<head>` meta tags). — Fields: `entries`: `Vec<Vec<String>>` |
