...
## Rust API Reference <span class="version-badge">v3.8.0-rc.1</span>
...
| `row_span` | `u32` | `serde(default = "default_span")` | Number of rows this cell spans (default 1). |
| `col_span` | `u32` | `serde(default = "default_span")` | Number of columns this cell spans (default 1). |
...
| `MetadataBlock` | A block of key-value metadata pairs (from `<head>` meta tags). — Fields: `entries`: `Vec<MetadataEntry>` |
