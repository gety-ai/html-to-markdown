...
if (Symbol.dispose)
  WasmConversionOptionsHandle.prototype[Symbol.dispose] =
    WasmConversionOptionsHandle.prototype.free;
...
if (Symbol.dispose)
  WasmHtmlExtraction.prototype[Symbol.dispose] = WasmHtmlExtraction.prototype.free;
...
export class WasmInlineImageConfig {
  ...
  set filenamePrefix(prefix) {
    var ptr0 = isLikeNone(prefix)
      ? 0
      : passStringToWasm0(prefix, wasm.__wbindgen_export, wasm.__wbindgen_export2);
  ...
  constructor(max_decoded_size_bytes) {
    const ret = wasm.wasminlineimageconfig_new(
      !isLikeNone(max_decoded_size_bytes),
      isLikeNone(max_decoded_size_bytes) ? 0 : max_decoded_size_bytes,
    );
...
if (Symbol.dispose)
  WasmInlineImageConfig.prototype[Symbol.dispose] = WasmInlineImageConfig.prototype.free;
...
if (Symbol.dispose)
  WasmInlineImageWarning.prototype[Symbol.dispose] = WasmInlineImageWarning.prototype.free;
...
if (Symbol.dispose)
  WasmMetadataConfig.prototype[Symbol.dispose] = WasmMetadataConfig.prototype.free;
