...
// alef:hash:7dd79d6fb0c86623b951d39f0dcaef80e95a994c591758e0727cd01f7be9da5f
...
fn test_visitor_audio_custom() {
    ...
    impl HtmlVisitor for _TestVisitor {
        fn visit_audio(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom("[AUDIO: podcast.mp3]".to_string())
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
    let result = convert(html, Some(options.clone()), Some(visitor)).expect("should succeed");
...
fn test_visitor_button_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_button(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_continue_default() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_strong(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_custom_blockquote() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_blockquote(&mut self, _: &NodeContext, _: &str, _: u32) -> VisitResult {
...
fn test_visitor_custom_emphasis() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_emphasis(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_custom_heading() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_heading(&mut self, _: &NodeContext, _: u8, _: &str, _: Option<&str>) -> VisitResult {
            VisitResult::Custom(format!("--- {text} ---"))
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_custom_image() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_image(&mut self, _: &NodeContext, _: &str, _: &str, _: &str) -> VisitResult {
...
fn test_visitor_custom_link_format() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_link(&mut self, _: &NodeContext, _: &str, _: &str, _: &str) -> VisitResult {
...
fn test_visitor_definition_list_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_definition_term(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom(format!("**{text}**"))
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_definition_list_custom_format() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_definition_description(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom(format!("> {text}"))
        }
        fn visit_definition_term(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom(format!("### {text}"))
...
fn test_visitor_details_summary_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_summary(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_details_summary_skip() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_details(&mut self, _: &NodeContext, _: bool) -> VisitResult {
            VisitResult::Skip
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_figure_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_figcaption(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom(format!("*{text}*"))
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_figure_custom_wrap() {
    ...
    impl HtmlVisitor for _TestVisitor {
        ...
        fn visit_figure_end(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_form_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_form(&mut self, _: &NodeContext, _: &str, _: &str) -> VisitResult {
...
fn test_visitor_iframe_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_iframe(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_input_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_input(&mut self, _: &NodeContext, _: &str, _: &str, _: &str) -> VisitResult {
...
fn test_visitor_skip_code_blocks() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_code_block(&mut self, _: &NodeContext, _: Option<&str>, _: &str) -> VisitResult {
            VisitResult::Skip
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_subscript_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_subscript(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom(format!("~{text}~"))
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_superscript_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_superscript(&mut self, _: &NodeContext, _: &str) -> VisitResult {
            VisitResult::Custom(format!("^{text}^"))
        }
    }
    let visitor = std::rc::Rc::new(std::cell::RefCell::new(_TestVisitor));
...
fn test_visitor_underline_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_underline(&mut self, _: &NodeContext, _: &str) -> VisitResult {
...
fn test_visitor_video_custom() {
    ...
    struct _TestVisitor;
    impl HtmlVisitor for _TestVisitor {
        fn visit_video(&mut self, _: &NodeContext, _: &str) -> VisitResult {
