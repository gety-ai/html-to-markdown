...
fn test_visitor_audio_custom() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"[AUDIO: podcast.mp3]"#),
        "expected to contain: {}",
        r#"[AUDIO: podcast.mp3]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Listen to this:"#),
        "expected to contain: {}",
        r#"Listen to this:"#
    );
}
...
fn test_visitor_audio_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Background music:"#),
        "expected to contain: {}",
        r#"Background music:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Enjoy!"#),
        "expected to contain: {}",
        r#"Enjoy!"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"music.ogg"#),
...
fn test_visitor_button_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[BTN:Click me]"#),
        "expected to contain: {}",
        r#"[BTN:Click me]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"[BTN:Cancel]"#),
        "expected to contain: {}",
        r#"[BTN:Cancel]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Confirm action:"#),
        "expected to contain: {}",
        r#"Confirm action:"#
    );
}
...
fn test_visitor_button_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Actions available:"#),
        "expected to contain: {}",
        r#"Actions available:"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Save"#),
        "expected NOT to contain: {}",
        r#"Save"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Delete"#),
        "expected NOT to contain: {}",
        r#"Delete"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Export"#),
        "expected NOT to contain: {}",
        r#"Export"#
    );
}
...
fn test_visitor_continue_default() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"**World**"#),
        "expected to contain: {}",
        r#"**World**"#
    );
}
...
fn test_visitor_custom_blockquote() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"QUOTE:"#),
        "expected to contain: {}",
        r#"QUOTE:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"A wise quote."#),
        "expected to contain: {}",
        r#"A wise quote."#
    );
}
...
fn test_visitor_custom_emphasis() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#">>>important<<<"#),
        "expected to contain: {}",
        r#">>>important<<<"#
    );
    assert!(
...
fn test_visitor_custom_heading() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"--- Section Title ---"#),
        "expected to contain: {}",
        r#"--- Section Title ---"#
    );
    assert!(
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Content below heading."#),
        "expected to contain: {}",
...
fn test_visitor_custom_image() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[Image: Banner]"#),
        "expected to contain: {}",
        r#"[Image: Banner]"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"banner.png"#),
        "expected NOT to contain: {}",
        r#"banner.png"#
    );
}
...
fn test_visitor_custom_link_format() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Example (https://example.com)"#),
        "expected to contain: {}",
        r#"Example (https://example.com)"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"[Example]"#),
        "expected NOT to contain: {}",
        r#"[Example]"#
    );
}
...
fn test_visitor_custom_link_static() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[REDACTED LINK]"#),
        "expected to contain: {}",
        r#"[REDACTED LINK]"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"example.com"#),
        "expected NOT to contain: {}",
        r#"example.com"#
    );
}
...
fn test_visitor_custom_output() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"## REPLACED HEADING"#),
        "expected to contain: {}",
        r#"## REPLACED HEADING"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"# Original Heading"#),
        "expected NOT to contain: {}",
        r#"# Original Heading"#
    );
}
...
fn test_visitor_definition_list_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"**HTML**"#),
        "expected to contain: {}",
        r#"**HTML**"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"**CSS**"#),
        "expected to contain: {}",
        r#"**CSS**"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"HyperText Markup Language"#),
        "expected to contain: {}",
...
fn test_visitor_definition_list_custom_format() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"### Python"#),
        "expected to contain: {}",
        r#"### Python"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"### JavaScript"#),
        "expected to contain: {}",
        r#"### JavaScript"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"> A high-level programming language"#),
        "expected to contain: {}",
        r#"> A high-level programming language"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"> A scripting language for web browsers"#),
        "expected to contain: {}",
...
fn test_visitor_definition_list_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Glossary:"#),
        "expected to contain: {}",
        r#"Glossary:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"End of glossary"#),
        "expected to contain: {}",
        r#"End of glossary"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Term A"#),
        "expected NOT to contain: {}",
        r#"Term A"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Definition"#),
        "expected NOT to contain: {}",
        r#"Definition"#
    );
}
...
fn test_visitor_details_summary_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[EXPANDABLE] Click to expand"#),
        "expected to contain: {}",
        r#"[EXPANDABLE] Click to expand"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"This content is initially hidden."#),
        "expected to contain: {}",
...
fn test_visitor_details_summary_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Main content here."#),
        "expected to contain: {}",
        r#"Main content here."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"More main content."#),
        "expected to contain: {}",
        r#"More main content."#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Hidden section"#),
        "expected NOT to contain: {}",
        r#"Hidden section"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Secret details"#),
        "expected NOT to contain: {}",
        r#"Secret details"#
    );
}
...
fn test_visitor_figure_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Article Title"#),
        "expected to contain: {}",
        r#"Article Title"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"*Figure 1: System Architecture*"#),
        "expected to contain: {}",
        r#"*Figure 1: System Architecture*"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Explanation of the figure."#),
        "expected to contain: {}",
...
fn test_visitor_figure_custom_wrap() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[FIGURE]"#),
        "expected to contain: {}",
        r#"[FIGURE]"#
    );
    assert!(
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Gallery"#),
        "expected to contain: {}",
        r#"Gallery"#
    );
}
...
fn test_visitor_figure_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"See the chart below:"#),
        "expected to contain: {}",
        r#"See the chart below:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"As shown in the chart above."#),
        "expected to contain: {}",
        r#"As shown in the chart above."#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Revenue Trends"#),
        "expected NOT to contain: {}",
        r#"Revenue Trends"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"chart.svg"#),
        "expected NOT to contain: {}",
        r#"chart.svg"#
    );
}
...
fn test_visitor_form_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[FORM PLACEHOLDER]"#),
        "expected to contain: {}",
        r#"[FORM PLACEHOLDER]"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"submit"#),
        "expected NOT to contain: {}",
        r#"submit"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"input"#),
        "expected NOT to contain: {}",
        r#"input"#
    );
}
...
fn test_visitor_form_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Before form"#),
        "expected to contain: {}",
        r#"Before form"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"After form"#),
        "expected to contain: {}",
        r#"After form"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"email"#),
        "expected NOT to contain: {}",
        r#"email"#
    );
}
...
fn test_visitor_heading_bare_string_preserves_case() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"## Important Section Title ##"#),
        "expected to contain: {}",
...
fn test_visitor_horizontal_rule_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[DIVIDER]"#),
        "expected to contain: {}",
        r#"[DIVIDER]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Section A"#),
        "expected to contain: {}",
        r#"Section A"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Section B"#),
        "expected to contain: {}",
        r#"Section B"#
    );
    assert!(
...
fn test_visitor_horizontal_rule_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Part 1"#),
        "expected to contain: {}",
        r#"Part 1"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Part 2"#),
        "expected to contain: {}",
        r#"Part 2"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Part 3"#),
        "expected to contain: {}",
        r#"Part 3"#
    );
    assert!(
...
fn test_visitor_iframe_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[EMBEDDED: https://maps.example.com/embed]"#),
        "expected to contain: {}",
        r#"[EMBEDDED: https://maps.example.com/embed]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Embedded map:"#),
        "expected to contain: {}",
        r#"Embedded map:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"End of map"#),
        "expected to contain: {}",
        r#"End of map"#
    );
}
...
fn test_visitor_iframe_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Reviews"#),
        "expected to contain: {}",
        r#"Reviews"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"See reviews from our partners."#),
        "expected to contain: {}",
        r#"See reviews from our partners."#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"widget.example.com"#),
        "expected NOT to contain: {}",
...
fn test_visitor_image_bare_string_preserves_case() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[image: Sunset Over Bay -> PhotoOne.JPG]"#),
        "expected to contain: {}",
        r#"[image: Sunset Over Bay -> PhotoOne.JPG]"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"sunset over bay"#),
        "expected NOT to contain: {}",
        r#"sunset over bay"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"photoone.jpg"#),
        "expected NOT to contain: {}",
        r#"photoone.jpg"#
    );
}
...
fn test_visitor_input_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[INPUT:text]"#),
        "expected to contain: {}",
        r#"[INPUT:text]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"[INPUT:password]"#),
        "expected to contain: {}",
        r#"[INPUT:password]"#
    );
}
...
fn test_visitor_input_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Sign up:"#),
        "expected to contain: {}",
        r#"Sign up:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Continue"#),
        "expected to contain: {}",
        r#"Continue"#
    );
    assert!(
...
fn test_visitor_line_break_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"First line | Second line | Third line"#),
        "expected to contain: {}",
        r#"First line | Second line | Third line"#
    );
    assert!(
        !format!("{:?}", _content).contains(
            r#"
...
fn test_visitor_line_break_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Address Line 1Address Line 2Address Line 3"#),
        "expected to contain: {}",
...
fn test_visitor_link_bare_string_preserves_case() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[Download](https://new-cdn.com/file.pdf)"#),
        "expected to contain: {}",
        r#"[Download](https://new-cdn.com/file.pdf)"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"[download]"#),
        "expected NOT to contain: {}",
        r#"[download]"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"old-cdn.com"#),
        "expected NOT to contain: {}",
        r#"old-cdn.com"#
    );
}
...
fn test_visitor_mark_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"==highlighted passage=="#),
        "expected to contain: {}",
        r#"==highlighted passage=="#
    );
    assert!(
        format!("{:?}", _content).contains(r#"This is a"#),
        "expected to contain: {}",
        r#"This is a"#
    );
}
...
fn test_visitor_mark_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"always validate input"#),
        "expected NOT to contain: {}",
        r#"always validate input"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Key insight:"#),
        "expected to contain: {}",
        r#"Key insight:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"for security."#),
        "expected to contain: {}",
        r#"for security."#
    );
}
...
fn test_visitor_preserve_html() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"<custom-tag>"#),
        "expected to contain: {}",
        r#"<custom-tag>"#
    );
}
...
fn test_visitor_skip_code_blocks() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Intro text"#),
        "expected to contain: {}",
        r#"Intro text"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Outro text"#),
        "expected to contain: {}",
        r#"Outro text"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"let x = 42"#),
        "expected NOT to contain: {}",
        r#"let x = 42"#
    );
}
...
fn test_visitor_skip_heading() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Body text remains."#),
        "expected to contain: {}",
        r#"Body text remains."#
    );
}
...
fn test_visitor_skip_images() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Before image"#),
        "expected to contain: {}",
        r#"Before image"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"After image"#),
        "expected to contain: {}",
        r#"After image"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"photo.jpg"#),
        "expected NOT to contain: {}",
        r#"photo.jpg"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"A photo"#),
        "expected NOT to contain: {}",
        r#"A photo"#
    );
}
...
fn test_visitor_skip_links() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"link text"#),
        "expected NOT to contain: {}",
        r#"link text"#
    );
    assert!(
...
fn test_visitor_skip_strong() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        !format!("{:?}", _content).contains(r#"bold text"#),
        "expected NOT to contain: {}",
        r#"bold text"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Normal"#),
        "expected to contain: {}",
        r#"Normal"#
    );
}
...
fn test_visitor_subscript_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"H~2~O"#),
        "expected to contain: {}",
        r#"H~2~O"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"is water"#),
        "expected to contain: {}",
        r#"is water"#
    );
}
...
fn test_visitor_subscript_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"The formula CHO is sugar."#),
        "expected to contain: {}",
...
fn test_visitor_superscript_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"E=mc^2^"#),
        "expected to contain: {}",
        r#"E=mc^2^"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"revolutionized physics"#),
        "expected to contain: {}",
...
fn test_visitor_superscript_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"The equation x + y = z has no solutions."#),
        "expected to contain: {}",
...
fn test_visitor_underline_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"_very important_"#),
        "expected to contain: {}",
        r#"_very important_"#
    );
    assert!(
...
fn test_visitor_underline_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Normal text with"#),
        "expected to contain: {}",
        r#"Normal text with"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"and more text."#),
        "expected to contain: {}",
        r#"and more text."#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"underlined part"#),
        "expected NOT to contain: {}",
        r#"underlined part"#
    );
}
...
fn test_visitor_video_custom() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[VIDEO: tutorial.mp4]"#),
        "expected to contain: {}",
        r#"[VIDEO: tutorial.mp4]"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Watch our tutorial:"#),
        "expected to contain: {}",
        r#"Watch our tutorial:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Great content!"#),
        "expected to contain: {}",
        r#"Great content!"#
    );
}
...
fn test_visitor_video_skip() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Demo"#),
        "expected to contain: {}",
        r#"Demo"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"See the demo above."#),
        "expected to contain: {}",
        r#"See the demo above."#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"demo.webm"#),
        "expected NOT to contain: {}",
        r#"demo.webm"#
    );
}
