...
fn test_real_world_blog_post() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"# Getting Started with Rust"#),
        "expected to contain: {}",
        r#"# Getting Started with Rust"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"## Installation"#),
        "expected to contain: {}",
        r#"## Installation"#
    );
    assert!(
    ...
    assert!(
        format!("{:?}", _content).contains(r#"## Key Concepts"#),
        "expected to contain: {}",
        r#"## Key Concepts"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"cargo run"#),
        "expected to contain: {}",
        r#"cargo run"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"[Mozilla](https://www.mozilla.org)"#),
        "expected to contain: {}",
        r#"[Mozilla](https://www.mozilla.org)"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"- Ownership and borrowing"#),
        "expected to contain: {}",
...
assert_eq!(markdown, "# Hello");</code></pre><h2>ConversionOptions</h2><p>Configure conversion behavior using the builder pattern:</p><pre><code class="language-rust">let options = ConversionOptions::builder()
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"# API Reference"#),
        "expected to contain: {}",
        r#"# API Reference"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"## convert_html"#),
        "expected to contain: {}",
        r#"## convert_html"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"### Parameters"#),
        "expected to contain: {}",
        r#"### Parameters"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"### Returns"#),
        "expected to contain: {}",
        r#"### Returns"#
    );
    assert!(
    ...
    assert!(
        format!("{:?}", _content).contains(r#"## ConversionOptions"#),
        "expected to contain: {}",
        r#"## ConversionOptions"#
    );
    assert!(
    ...
    assert!(
        format!("{:?}", _content).contains(r#"thread-safe"#),
        "expected to contain: {}",
        r#"thread-safe"#
    );
    assert!(
...
fn test_real_world_product_page() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"# Wireless Keyboard Pro"#),
        "expected to contain: {}",
        r#"# Wireless Keyboard Pro"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"![Wireless Keyboard Pro](https://example.com/keyboard.jpg)"#),
        "expected to contain: {}",
        r#"![Wireless Keyboard Pro](https://example.com/keyboard.jpg)"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"## Specifications"#),
        "expected to contain: {}",
        r#"## Specifications"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Battery Life"#),
        "expected to contain: {}",
        r#"Battery Life"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"12 months"#),
        "expected to contain: {}",
        r#"12 months"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Bluetooth 5.0"#),
        "expected to contain: {}",
        r#"Bluetooth 5.0"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"## What's in the Box"#),
        "expected to contain: {}",
        r#"## What's in the Box"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"USB-C charging cable"#),
        "expected to contain: {}",
