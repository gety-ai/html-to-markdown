...
fn test_blockquote_nested() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Outer quote."#),
        "expected to contain: {}",
        r#"Outer quote."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Inner quote."#),
        "expected to contain: {}",
        r#"Inner quote."#
    );
}
...
fn test_blockquote_with_list() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Quote intro:"#),
        "expected to contain: {}",
        r#"Quote intro:"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Point one"#),
        "expected to contain: {}",
        r#"Point one"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Point two"#),
        "expected to contain: {}",
        r#"Point two"#
    );
}
...
fn test_bold_and_italic() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"***both***"#),
        "expected to contain: {}",
        r#"***both***"#
    );
}
...
fn test_code_block_no_language() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"plain code here"#),
        "expected to contain: {}",
        r#"plain code here"#
    );
}
...
fn test_code_inline_in_paragraph() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"`initialize()`"#),
        "expected to contain: {}",
        r#"`initialize()`"#
    );
}
...
fn test_code_with_backticks_in_content() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"backtick"#),
        "expected to contain: {}",
        r#"backtick"#
    );
}
...
fn test_emphasis_strikethrough_del() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"~~deleted text~~"#),
        "expected to contain: {}",
        r#"~~deleted text~~"#
    );
}
...
fn test_emphasis_strikethrough_s() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"~~strikethrough~~"#),
        "expected to contain: {}",
        r#"~~strikethrough~~"#
    );
}
...
fn test_emphasis_underline_u() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"underlined"#),
        "expected to contain: {}",
        r#"underlined"#
    );
}
...
fn test_form_select_options() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Color"#),
        "expected to contain: {}",
        r#"Color"#
    );
}
...
fn test_form_textarea() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Message"#),
        "expected to contain: {}",
        r#"Message"#
    );
}
...
fn test_image_figure_figcaption() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"![A sunset](sunset.jpg)"#),
        "expected to contain: {}",
        r#"![A sunset](sunset.jpg)"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Beautiful sunset over the ocean"#),
        "expected to contain: {}",
...
fn test_image_linked() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"![Icon](icon.png)"#),
        "expected to contain: {}",
        r#"![Icon](icon.png)"#
    );
    assert!(
...
fn test_image_no_alt() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"banner.jpg"#),
        "expected to contain: {}",
        r#"banner.jpg"#
    );
}
...
fn test_image_simple() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"![A photo](photo.jpg)"#),
        "expected to contain: {}",
        r#"![A photo](photo.jpg)"#
    );
}
...
fn test_image_with_title() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"![Sales chart](chart.png"#),
        "expected to contain: {}",
        r#"![Sales chart](chart.png"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Q3 Sales"#),
        "expected to contain: {}",
        r#"Q3 Sales"#
    );
}
...
fn test_inline_code() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"`console.log()`"#),
        "expected to contain: {}",
        r#"`console.log()`"#
    );
}
...
fn test_italic_em() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"*italic*"#),
        "expected to contain: {}",
        r#"*italic*"#
    );
}
...
fn test_line_break_br_tag() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"First line."#),
        "expected to contain: {}",
        r#"First line."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Second line."#),
        "expected to contain: {}",
        r#"Second line."#
    );
}
...
fn test_line_break_hr_tag() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Before rule."#),
        "expected to contain: {}",
        r#"Before rule."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"After rule."#),
        "expected to contain: {}",
        r#"After rule."#
    );
}
...
fn test_line_break_multiple_br() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Start."#),
        "expected to contain: {}",
        r#"Start."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"End."#),
        "expected to contain: {}",
        r#"End."#
    );
}
...
fn test_link_anchor_fragment() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"[Jump to section](#section)"#),
        "expected to contain: {}",
...
fn test_link_empty_href() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"No destination"#),
        "expected to contain: {}",
        r#"No destination"#
    );
}
...
fn test_link_image_inside() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"![Logo](logo.png)"#),
        "expected to contain: {}",
        r#"![Logo](logo.png)"#
    );
    assert!(
...
fn test_link_mailto() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"mailto:user@example.com"#),
        "expected to contain: {}",
...
fn test_link_with_bold_text() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"**Bold link**"#),
        "expected to contain: {}",
        r#"**Bold link**"#
    );
    assert!(
...
fn test_link_with_title() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Example Site"#),
        "expected to contain: {}",
        r#"Example Site"#
    );
}
...
fn test_list_definition_dl() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Term One"#),
        "expected to contain: {}",
        r#"Term One"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Definition of term one."#),
        "expected to contain: {}",
        r#"Definition of term one."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Term Two"#),
        "expected to contain: {}",
        r#"Term Two"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Definition of term two."#),
        "expected to contain: {}",
...
fn test_list_item_multiple_paragraphs() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"First paragraph in item."#),
        "expected to contain: {}",
        r#"First paragraph in item."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Second paragraph in item."#),
        "expected to contain: {}",
        r#"Second paragraph in item."#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Simple item"#),
        "expected to contain: {}",
        r#"Simple item"#
    );
}
...
fn test_list_mixed_nested() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Sub 1"#),
        "expected to contain: {}",
        r#"Sub 1"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Sub 2"#),
        "expected to contain: {}",
        r#"Sub 2"#
    );
    assert!(
...
fn test_list_nested_ordered() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Step 1"#),
        "expected to contain: {}",
        r#"Step 1"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Step 1a"#),
        "expected to contain: {}",
        r#"Step 1a"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Step 1b"#),
        "expected to contain: {}",
        r#"Step 1b"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Step 2"#),
        "expected to contain: {}",
        r#"Step 2"#
    );
}
...
fn test_list_nested_unordered() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Parent A"#),
        "expected to contain: {}",
        r#"Parent A"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Child A1"#),
        "expected to contain: {}",
        r#"Child A1"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Child A2"#),
        "expected to contain: {}",
        r#"Child A2"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Parent B"#),
        "expected to contain: {}",
        r#"Parent B"#
    );
}
...
fn test_list_task_checkboxes() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Done task"#),
        "expected to contain: {}",
        r#"Done task"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Pending task"#),
        "expected to contain: {}",
        r#"Pending task"#
    );
}
...
fn test_ordered_list() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"1. First"#),
        "expected to contain: {}",
        r#"1. First"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"2. Second"#),
        "expected to contain: {}",
        r#"2. Second"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"3. Third"#),
        "expected to contain: {}",
        r#"3. Third"#
    );
}
...
fn test_paragraph_nested_divs() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Nested text"#),
        "expected to contain: {}",
        r#"Nested text"#
    );
}
...
fn test_paragraph_with_inline_formatting() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"[link](https://example.com)"#),
        "expected to contain: {}",
...
fn test_paragraph_with_line_breaks() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Line three."#),
        "expected to contain: {}",
        r#"Line three."#
    );
}
...
fn test_semantic_abbr() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"WWW"#),
        "expected to contain: {}",
        r#"WWW"#
    );
}
...
fn test_semantic_definition_list() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Cascading Style Sheets"#),
        "expected to contain: {}",
...
fn test_semantic_details_summary() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Click to expand"#),
        "expected to contain: {}",
        r#"Click to expand"#
    );
}
...
fn test_semantic_hr() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Above"#),
        "expected to contain: {}",
        r#"Above"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Below"#),
        "expected to contain: {}",
        r#"Below"#
    );
}
...
fn test_semantic_mark_highlight() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"highlighted text"#),
        "expected to contain: {}",
        r#"highlighted text"#
    );
}
...
fn test_semantic_section_with_heading() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Section Heading"#),
        "expected to contain: {}",
        r#"Section Heading"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Section content."#),
        "expected to contain: {}",
        r#"Section content."#
    );
}
...
fn test_semantic_sub_superscript() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"E=mc"#),
        "expected to contain: {}",
        r#"E=mc"#
    );
}
...
fn test_simple_table() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Age"#),
        "expected to contain: {}",
        r#"Age"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Alice"#),
        "expected to contain: {}",
        r#"Alice"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"30"#),
        "expected to contain: {}",
        r#"30"#
    );
    assert!(
...
fn test_table_no_thead() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Product"#),
        "expected to contain: {}",
        r#"Product"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Price"#),
        "expected to contain: {}",
        r#"Price"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Apple"#),
        "expected to contain: {}",
        r#"Apple"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"1.00"#),
        "expected to contain: {}",
        r#"1.00"#
    );
    assert!(
...
fn test_table_pipe_chars_in_content() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Expression"#),
        "expected to contain: {}",
        r#"Expression"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Result"#),
        "expected to contain: {}",
        r#"Result"#
    );
    assert!(
...
fn test_table_with_alignment() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Left"#),
        "expected to contain: {}",
        r#"Left"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Center"#),
        "expected to contain: {}",
        r#"Center"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Right"#),
        "expected to contain: {}",
        r#"Right"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"L"#),
        "expected to contain: {}",
        r#"L"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"C"#),
        "expected to contain: {}",
        r#"C"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"R"#),
        "expected to contain: {}",
        r#"R"#
    );
    assert!(
...
fn test_table_with_colspan() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Full Name"#),
        "expected to contain: {}",
        r#"Full Name"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"John"#),
        "expected to contain: {}",
        r#"John"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Doe"#),
        "expected to contain: {}",
        r#"Doe"#
    );
}
...
fn test_unordered_list() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"- Item 1"#),
        "expected to contain: {}",
        r#"- Item 1"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"- Item 2"#),
        "expected to contain: {}",
        r#"- Item 2"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"- Item 3"#),
        "expected to contain: {}",
        r#"- Item 3"#
    );
}
