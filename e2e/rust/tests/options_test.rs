...
fn test_options_br_in_tables_false() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Col"#),
        "expected to contain: {}",
        r#"Col"#
    );
}
...
fn test_options_br_in_tables_true() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Header"#),
        "expected to contain: {}",
        r#"Header"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Line 1"#),
        "expected to contain: {}",
        r#"Line 1"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Line 2"#),
        "expected to contain: {}",
        r#"Line 2"#
    );
}
...
fn test_options_capture_svg_false() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"capture_svg":false,"extract_images":true}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Below SVG"#),
        "expected to contain: {}",
        r#"Below SVG"#
    );
}
...
fn test_options_capture_svg_true() {
    ...
    let html = r#"<p>Below SVG:</p><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"><rect width="10" height="10" fill="red"/></svg>"#;
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"capture_svg":true,"extract_images":true}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(!_content.is_empty(), "expected non-empty value");
...
fn test_options_code_block_backticks() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"console.log('hi');"#),
        "expected to contain: {}",
        r#"console.log('hi');"#
    );
}
...
fn test_options_code_block_indented() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"print('hello')"#),
        "expected to contain: {}",
        r#"print('hello')"#
    );
    assert!(
...
fn test_options_code_block_tildes() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"let x = 1;"#),
        "expected to contain: {}",
        r#"let x = 1;"#
    );
}
...
fn test_options_code_block_tildes_style() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"some code"#),
        "expected to contain: {}",
        r#"some code"#
    );
}
...
fn test_options_code_language_python() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"def hello"#),
        "expected to contain: {}",
        r#"def hello"#
    );
}
...
fn test_options_debug_true() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Debug test"#),
        "expected to contain: {}",
        r#"Debug test"#
    );
}
...
fn test_options_default_title_true() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Link"#),
        "expected to contain: {}",
        r#"Link"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"https://example.com"#),
        "expected to contain: {}",
        r#"https://example.com"#
    );
}
...
fn test_options_escape_ascii_enabled() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"hash"#),
        "expected to contain: {}",
        r#"hash"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"brackets"#),
        "expected to contain: {}",
        r#"brackets"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"star"#),
        "expected to contain: {}",
        r#"star"#
    );
}
...
fn test_options_escape_asterisks() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"2"#),
        "expected to contain: {}",
        r#"2"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"3"#),
        "expected to contain: {}",
        r#"3"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"6"#),
        "expected to contain: {}",
        r#"6"#
    );
}
...
fn test_options_escape_misc() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Use"#),
        "expected to contain: {}",
        r#"Use"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"and"#),
        "expected to contain: {}",
        r#"and"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"in text."#),
        "expected to contain: {}",
        r#"in text."#
    );
}
...
fn test_options_escape_underscores() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"variable"#),
        "expected to contain: {}",
        r#"variable"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"name"#),
        "expected to contain: {}",
        r#"name"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"defined."#),
        "expected to contain: {}",
        r#"defined."#
    );
}
...
fn test_options_exclude_selectors_attribute() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"exclude_selectors":["[role='complementary']"]}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Primary text"#),
        "expected to contain: {}",
        r#"Primary text"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Sidebar"#),
        "expected NOT to contain: {}",
        r#"Sidebar"#
    );
}
...
fn test_options_exclude_selectors_class() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Main content"#),
        "expected to contain: {}",
        r#"Main content"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"cookies"#),
        "expected NOT to contain: {}",
        r#"cookies"#
    );
}
...
fn test_options_exclude_selectors_empty_noop() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Hello world"#),
        "expected to contain: {}",
        r#"Hello world"#
    );
}
...
fn test_options_exclude_selectors_id() {
    ...
    assert!(
        !format!("{:?}", _content).contains(r#"Buy stuff"#),
        "expected NOT to contain: {}",
        r#"Buy stuff"#
    );
}
...
fn test_options_exclude_selectors_multiple() {
    ...
    assert!(
        !format!("{:?}", _content).contains(r#"Menu"#),
        "expected NOT to contain: {}",
        r#"Menu"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Footer"#),
        "expected NOT to contain: {}",
        r#"Footer"#
    );
}
...
fn test_options_exclude_selectors_nested_content_dropped() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Main text"#),
        "expected to contain: {}",
        r#"Main text"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Related"#),
        "expected NOT to contain: {}",
        r#"Related"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Sidebar text"#),
        "expected NOT to contain: {}",
        r#"Sidebar text"#
    );
}
...
fn test_options_exclude_selectors_plain_text_mode() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"exclude_selectors":[".nav"],"output_format":"Plain"}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Article body"#),
        "expected to contain: {}",
        r#"Article body"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Navigation"#),
        "expected NOT to contain: {}",
        r#"Navigation"#
    );
}
...
fn test_options_exclude_selectors_vs_strip_tags() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Outer text"#),
        "expected to contain: {}",
        r#"Outer text"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Inner paragraph"#),
        "expected NOT to contain: {}",
        r#"Inner paragraph"#
    );
}
...
fn test_options_extract_images_true_data_uri() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Before"#),
        "expected to contain: {}",
        r#"Before"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"After"#),
        "expected to contain: {}",
        r#"After"#
    );
}
...
fn test_options_heading_style_atx() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"## Subtitle"#),
        "expected to contain: {}",
        r#"## Subtitle"#
    );
}
...
fn test_options_heading_style_atx_closed() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"# Closed Heading #"#),
        "expected to contain: {}",
        r#"# Closed Heading #"#
    );
}
...
fn test_options_heading_style_underlined() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Main Title"#),
        "expected to contain: {}",
        r#"Main Title"#
    );
}
...
fn test_options_highlight_bold() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"**highlighted**"#),
        "expected to contain: {}",
        r#"**highlighted**"#
    );
}
...
fn test_options_highlight_none() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"plain"#),
        "expected to contain: {}",
        r#"plain"#
    );
    assert!(
...
fn test_options_include_document_structure_false() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Heading"#),
        "expected to contain: {}",
        r#"Heading"#
    );
}
...
fn test_options_infer_dimensions_false() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"extract_images":true,"infer_dimensions":false}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"No dims"#),
        "expected to contain: {}",
        r#"No dims"#
    );
}
...
fn test_options_infer_dimensions_true() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"extract_images":true,"infer_dimensions":true}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"With dims"#),
        "expected to contain: {}",
        r#"With dims"#
    );
}
...
fn test_options_keep_inline_images_in_paragraph() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"more text"#),
        "expected to contain: {}",
        r#"more text"#
    );
}
...
fn test_options_link_style_reference() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Other"#),
        "expected to contain: {}",
        r#"Other"#
    );
    assert!(
...
fn test_options_list_custom_bullets() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"* Item A"#),
        "expected to contain: {}",
        r#"* Item A"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"* Item B"#),
        "expected to contain: {}",
        r#"* Item B"#
    );
}
...
fn test_options_list_indent_tabs() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Parent"#),
        "expected to contain: {}",
        r#"Parent"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Child"#),
        "expected to contain: {}",
        r#"Child"#
    );
}
...
fn test_options_list_indent_width_four() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Inner"#),
        "expected to contain: {}",
        r#"Inner"#
    );
}
...
fn test_options_max_depth_default_unlimited() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Deep content"#),
        "expected to contain: {}",
        r#"Deep content"#
    );
}
...
fn test_options_max_depth_truncates() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Shallow"#),
        "expected to contain: {}",
        r#"Shallow"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"Too deep"#),
        "expected NOT to contain: {}",
        r#"Too deep"#
    );
}
...
fn test_options_max_image_size_generous_limit() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"extract_images":true,"max_image_size":10485760}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Image"#),
        "expected to contain: {}",
        r#"Image"#
    );
}
...
fn test_options_max_image_size_tiny_limit_safe() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"extract_images":true,"max_image_size":10}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Tiny limit"#),
        "expected to contain: {}",
        r#"Tiny limit"#
    );
}
...
fn test_options_newline_backslash() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Line one"#),
        "expected to contain: {}",
        r#"Line one"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Line two"#),
        "expected to contain: {}",
        r#"Line two"#
    );
}
...
fn test_options_newline_spaces() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"First"#),
        "expected to contain: {}",
        r#"First"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Second"#),
        "expected to contain: {}",
        r#"Second"#
    );
}
...
fn test_options_output_format_djot() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Simple paragraph."#),
        "expected to contain: {}",
        r#"Simple paragraph."#
    );
}
...
fn test_options_output_format_markdown() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"heading_style":"Atx","output_format":"Markdown"}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
    ...
    assert!(
        format!("{:?}", _content).contains(r#"Some text."#),
        "expected to contain: {}",
        r#"Some text."#
    );
}
...
fn test_options_output_format_plain() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"bold"#),
        "expected to contain: {}",
        r#"bold"#
    );
    assert!(
...
fn test_options_preprocessing_enabled_false_skips_cleanup() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"NavSection"#),
        "expected to contain: {}",
        r#"NavSection"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"Paragraph"#),
        "expected to contain: {}",
        r#"Paragraph"#
    );
}
...
fn test_options_preprocessing_remove_navigation_false_keeps_nav() {
    ...
    let options_json: serde_json::Value =
        serde_json::from_str(r#"{"preprocessing":{"remove_navigation":false}}"#).unwrap();
    let options: ConversionOptions = serde_json::from_value(options_json).unwrap();
    let result = convert(html, Some(options.clone())).expect("should succeed");
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"SiteMenu"#),
        "expected to contain: {}",
        r#"SiteMenu"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"MainContent"#),
        "expected to contain: {}",
        r#"MainContent"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"SidebarText"#),
        "expected to contain: {}",
        r#"SidebarText"#
    );
}
...
fn test_options_preserve_tags_iframe() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"<iframe"#),
        "expected to contain: {}",
        r#"<iframe"#
    );
}
...
fn test_options_skip_images_true() {
    ...
    assert!(
        !format!("{:?}", _content).contains(r#"photo"#),
        "expected NOT to contain: {}",
        r#"photo"#
    );
}
...
fn test_options_strip_tags_div_span() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"Inside div"#),
        "expected to contain: {}",
        r#"Inside div"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"span text"#),
        "expected to contain: {}",
        r#"span text"#
    );
}
...
fn test_options_strong_em_underscore() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"__bold__"#),
        "expected to contain: {}",
        r#"__bold__"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"_italic_"#),
        "expected to contain: {}",
        r#"_italic_"#
    );
}
...
#[test]
fn test_options_url_escape_style_angle_default() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"</file (1).pdf>"#),
        "expected to contain: {}",
        r#"</file (1).pdf>"#
    );
}
...
#[test]
fn test_options_url_escape_style_percent_angle_brackets_in_url() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"/file%20%281%29%20%3Cdraft%3E.pdf"#),
        "expected to contain: {}",
        r#"/file%20%281%29%20%3Cdraft%3E.pdf"#
    );
}

#[test]
fn test_options_url_escape_style_percent_image() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"/img%20%281%29%20%3Cdraft%3E.png"#),
        "expected to contain: {}",
        r#"/img%20%281%29%20%3Cdraft%3E.png"#
    );
}

#[test]
fn test_options_url_escape_style_percent_link() {
    ...
    let _content = result.content.as_ref().map(|v| v.to_string()).unwrap_or_default();
    assert!(
        format!("{:?}", _content).contains(r#"/file%20%281%29.pdf"#),
        "expected to contain: {}",
        r#"/file%20%281%29.pdf"#
    );
    assert!(
        !format!("{:?}", _content).contains(r#"</"#),
        "expected NOT to contain: {}",
...
fn test_options_whitespace_normalized() {
    ...
    assert!(
        format!("{:?}", _content).contains(r#"with"#),
        "expected to contain: {}",
        r#"with"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"extra"#),
        "expected to contain: {}",
        r#"extra"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"spaces."#),
        "expected to contain: {}",
        r#"spaces."#
    );
}
...
fn test_options_whitespace_strict() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"Preserved"#),
        "expected to contain: {}",
        r#"Preserved"#
    );
    assert!(
        format!("{:?}", _content).contains(r#"spacing."#),
        "expected to contain: {}",
        r#"spacing."#
    );
}
...
fn test_options_wrap_enabled() {
    ...
    assert!(!_content.is_empty(), "expected non-empty value");
    assert!(
        format!("{:?}", _content).contains(r#"This is a long paragraph"#),
        "expected to contain: {}",
