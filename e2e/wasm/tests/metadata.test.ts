...
// alef:hash:246a09b88a54bda62536d118d437bdb8d41391294bae77b566fe349d0df082a8
...
describe('metadata', () => {
  ...
  it('metadata_lang_attribute: Extract language from html lang attribute', () => {
    const result = convert("<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>");
    expect((result.content ?? "").length).toBeGreaterThan(0);
  ...
  it('metadata_microdata_schema_organization: Extract schema.org microdata for Organization', () => {
    const result = convert("<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>");
    expect((result.content ?? "").length).toBeGreaterThan(0);
  ...
  it('metadata_microdata_schema_person: Extract schema.org microdata for Person', () => {
    const result = convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>");
    expect((result.content ?? "").length).toBeGreaterThan(0);
  ...
  it('metadata_text_direction_ltr: Extract text direction from lang attribute on html element', () => {
    const result = convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>");
    expect((result.content ?? "").length).toBeGreaterThan(0);
    expect(result.content ?? "").toContain("left-to-right text");
  });

  it('metadata_text_direction_rtl: Extract right-to-left text direction', () => {
    const result = convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>");
    expect((result.content ?? "").length).toBeGreaterThan(0);
