...
// alef:hash:225ffaee36071e0fdaa82aadba6568f4b7dc6959ad8f8b8d94263c17c8f22e9f
...
describe('metadata', () => {
  it('metadata_author_meta: Extract author from <meta name=\'author\'> tag', () => {
    const result = convert("<html><head><title>Page</title><meta name=\"author\" content=\"Jane Doe\"></head><body><p>Content</p></body></html>", {} as unknown as JsConversionOptions);
  ...
  it('metadata_canonical_url: Extract canonical URL from <link rel=\'canonical\'> tag', () => {
    const result = convert("<html><head><title>Page</title><link rel=\"canonical\" href=\"https://example.com/canonical-page\"></head><body><p>Content</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_description_meta: Extract description from <meta name=\'description\'> tag', () => {
    const result = convert("<html><head><title>Page</title><meta name=\"description\" content=\"This is the page description.\"></head><body><p>Content</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_dublin_core: Extract Dublin Core metadata tags', () => {
    const result = convert("<html><head><title>Scholarly Work</title><meta name=\"DC.title\" content=\"Principles of Knowledge Management\"><meta name=\"DC.creator\" content=\"Dr. Alice Johnson\"><meta name=\"DC.date\" content=\"2023-06-15\"><meta name=\"DC.subject\" content=\"Knowledge Management\"><meta name=\"DC.publisher\" content=\"Academic Press\"></head><body><p>This is a scholarly article.</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_extract_all_images: Extract all images from a document into metadata', () => {
    const result = convert("<html><head><title>Gallery</title></head><body><img src=\"https://example.com/photo1.jpg\" alt=\"Photo 1\"><img src=\"https://example.com/photo2.png\" alt=\"Photo 2\"><img src=\"/local/image.webp\" alt=\"Local image\"></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_extract_all_links: Extract all links from a document into metadata', () => {
    const result = convert("<html><head><title>Links Page</title></head><body><p>Visit <a href=\"https://example.com\">Example</a> or <a href=\"https://docs.example.com\">Docs</a>.</p><p>Also see <a href=\"/relative/path\">relative link</a> and <a href=\"mailto:hello@example.com\">email us</a>.</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_headers_hierarchy: Extract heading hierarchy from document into metadata', () => {
    const result = convert("<html><head><title>Docs</title></head><body><h1>Introduction</h1><h2>Getting Started</h2><h3>Installation</h3><h3>Configuration</h3><h2>Advanced Usage</h2><h3>Custom Options</h3></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_keywords_meta: Extract keywords from <meta name=\'keywords\'> tag', () => {
    const result = convert("<html><head><title>Page</title><meta name=\"keywords\" content=\"rust, markdown, html, converter\"></head><body><p>Content</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_lang_attribute: Extract language from html lang attribute', () => {
    const result = convert("<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_microdata_schema_organization: Extract schema.org microdata for Organization', () => {
    const result = convert("<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_microdata_schema_person: Extract schema.org microdata for Person', () => {
    const result = convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('metadata_text_direction_ltr: Extract text direction from lang attribute on html element', () => {
    const result = convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
    expect(result.content ?? "").toContain("left-to-right text");
  });

  it('metadata_text_direction_rtl: Extract right-to-left text direction', () => {
    const result = convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
    expect(result.content ?? "").toContain("right-to-left text");
  });

  it('metadata_title_tag: Extract title from <title> tag', () => {
    const result = convert("<html><head><title>My Page</title></head><body><p>Content</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('og_basic_tags: Extract og:title, og:description, and og:image from Open Graph meta tags', () => {
    const result = convert("<html><head><title>Fallback Title</title><meta property=\"og:title\" content=\"OG Title\"><meta property=\"og:description\" content=\"OG description text.\"><meta property=\"og:image\" content=\"https://example.com/image.jpg\"></head><body><p>Content</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('structured_data_json_ld: JSON-LD script tag is stripped from output (security) but metadata may be extracted', () => {
    const result = convert("<html><head><title>Article</title><script type=\"application/ld+json\">{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"My Article\",\"author\":{\"@type\":\"Person\",\"name\":\"Jane Doe\"},\"datePublished\":\"2024-01-15\"}</script></head><body><h1>My Article</h1><p>Article body text.</p></body></html>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
