...
// alef:hash:766050679e6e7679f85fc0f96dc1ce0ad4e34ed51a7e144fce6bb11afd45475f
...
describe("visitor", () => {
  ...
  it("visitor_continue_default: Visitor continue action preserves default conversion", () => {
    ...
    const result = convert("<p>Hello <strong>World</strong></p>", {} as WasmConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_emphasis: Visitor replaces emphasis with custom output", () => {
    ...
    const result = convert("<p>This is <em>important</em> text.</p>", {} as WasmConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_image: Visitor replaces image with custom output using template", () => {
    ...
    const result = convert('<img src="banner.png" alt="Banner">', {} as WasmConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_output: Visitor custom action replaces element output", () => {
    ...
    const result = convert("<h1>Original Heading</h1>", {} as WasmConversionOptions, {
      visitor: _testVisitor,
    });
...
`,
  ...
  it("visitor_skip_all_headings: Visitor skips all headings from document", () => {
    ...
    const result = convert("<h1>Title</h1><p>Body text remains.</p>", {} as WasmConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_subscript_custom: Visitor replaces subscript with custom template", () => {
    ...
    const result = convert("<p>H<sub>2</sub>O is water.</p>", {} as WasmConversionOptions, {
      visitor: _testVisitor,
    });
