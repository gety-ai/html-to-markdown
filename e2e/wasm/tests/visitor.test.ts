...
// alef:hash:52105f694456137ecfbf9290c0a5a16c29ba99983f8b971a5ff5906641fa2fed
...
`,
  ...
  it("visitor_heading_bare_string_preserves_case: Visitor returns rendered heading template as bare string; mixed-case is preserved (regression guard for issue #350)", () => {
    ...
    const result = convert("<h2>Important Section Title</h2><p>Body.</p>", {
      visitor: _testVisitor,
    });
  ...
  it("visitor_image_bare_string_preserves_case: Visitor returns bare-string image replacement; mixed-case alt/src preserved (regression guard for issue #350)", () => {
    ...
    const result = convert('<img src="PhotoOne.JPG" alt="Sunset Over Bay">', {
      visitor: _testVisitor,
    });
  ...
  it("visitor_link_bare_string_preserves_case: Visitor returns rendered template as a bare string (not a dict) and original mixed-case content is preserved end-to-end (regression guard for issue #350)", () => {
    ...
    const result = convert('<a href="https://old-cdn.com/file.pdf">Download</a>', {
      visitor: _testVisitor,
    });
