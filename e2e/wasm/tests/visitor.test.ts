...
// alef:hash:78ecf52b4ccf1a5d0cddf8a2107819e99c2eca748cf390eccf8a29c83b911032
...
describe('visitor', () => {
  it('visitor_audio_custom: Visitor replaces audio element with custom output', () => {
    ...
    const result = convert("<p>Listen to this: <audio src=\"podcast.mp3\" controls></audio></p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_audio_skip: Visitor removes audio elements from output', () => {
    ...
    const result = convert("<p>Background music:</p><audio src=\"music.ogg\" autoplay></audio><p>Enjoy!</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_button_custom: Visitor replaces button with bracketed text', () => {
    ...
    const result = convert("<p>Confirm action: <button type=\"submit\">Click me</button> or <button type=\"reset\">Cancel</button></p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_button_skip: Visitor removes all buttons from output', () => {
    ...
    const result = convert("<p>Actions available: <button>Save</button> <button>Delete</button> <button>Export</button></p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_continue_default: Visitor continue action preserves default conversion', () => {
    ...
    const result = convert("<p>Hello <strong>World</strong></p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_blockquote: Visitor replaces blockquote with custom format', () => {
    ...
    const result = convert("<blockquote><p>A wise quote.</p></blockquote>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_emphasis: Visitor replaces emphasis with custom output', () => {
    ...
    const result = convert("<p>This is <em>important</em> text.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_heading: Visitor replaces heading with custom format', () => {
    ...
    const result = convert("<h2>Section Title</h2><p>Content below heading.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_image: Visitor replaces image with custom output using template', () => {
    ...
    const result = convert("<img src=\"banner.png\" alt=\"Banner\">", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_link_format: Visitor reformats links using template interpolation', () => {
    ...
    const result = convert("<p>Visit <a href=\"https://example.com\">Example</a> for more info.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_link_static: Visitor replaces link with static custom output', () => {
    ...
    const result = convert("<a href=\"https://example.com\">Click here</a>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_custom_output: Visitor custom action replaces element output', () => {
    ...
    const result = convert("<h1>Original Heading</h1>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_definition_list_custom: Visitor customizes definition list items', () => {
    ...
    const result = convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_definition_list_custom_format: Visitor formats definition lists with custom templates', () => {
    ...
    const result = convert("<dl><dt>Python</dt><dd>A high-level programming language</dd><dt>JavaScript</dt><dd>A scripting language for web browsers</dd></dl>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_definition_list_skip: Visitor skips definition list items from output', () => {
    ...
    const result = convert("<p>Glossary:</p><dl><dt>Term A</dt><dd>Definition of term A</dd><dt>Term B</dt><dd>Definition of term B</dd></dl><p>End of glossary</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_details_summary_custom: Visitor customizes details/summary disclosure elements', () => {
    ...
    const result = convert("<details><summary>Click to expand</summary><p>This content is initially hidden.</p><p>But can be revealed by the user.</p></details>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_details_summary_skip: Visitor removes details/summary elements entirely', () => {
    ...
    const result = convert("<p>Main content here.</p><details><summary>Hidden section</summary><p>Secret details</p></details><p>More main content.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_figure_custom: Visitor customizes figure and figcaption elements', () => {
    ...
    const result = convert("<article><h1>Article Title</h1><p>Introduction paragraph.</p><figure><img src=\"diagram.png\" alt=\"System architecture diagram\"><figcaption>Figure 1: System Architecture</figcaption></figure><p>Explanation of the figure.</p></article>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
...
` };
    ...
    const result = convert("<section><h2>Gallery</h2><figure><img src=\"photo1.jpg\" alt=\"Photo\"><figcaption>Beautiful sunset</figcaption></figure></section>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_figure_skip: Visitor removes figure elements with their captions', () => {
    ...
    const result = convert("<p>See the chart below:</p><figure><img src=\"chart.svg\"><figcaption>Revenue Trends 2020-2024</figcaption></figure><p>As shown in the chart above.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_form_custom: Visitor replaces form with custom output', () => {
    ...
    const result = convert("<div><form action=\"/submit\" method=\"POST\"><label>Name: <input type=\"text\" name=\"name\"></label><button type=\"submit\">Submit</button></form></div>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_form_skip: Visitor skips form elements entirely', () => {
    ...
    const result = convert("<p>Before form</p><form><input type=\"email\" name=\"email\"></form><p>After form</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_horizontal_rule_custom: Visitor replaces horizontal rule with custom output', () => {
    ...
    const result = convert("<h1>Section A</h1><p>Content A</p><hr><h1>Section B</h1><p>Content B</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_horizontal_rule_skip: Visitor removes all horizontal rules', () => {
    ...
    const result = convert("<p>Part 1</p><hr><p>Part 2</p><hr><p>Part 3</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_iframe_custom: Visitor replaces embedded iframe with custom text', () => {
    ...
    const result = convert("<p>Embedded map:</p><iframe src=\"https://maps.example.com/embed\" width=\"400\" height=\"300\"></iframe><p>End of map</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_iframe_skip: Visitor removes embedded iframes', () => {
    ...
    const result = convert("<h3>Reviews</h3><iframe src=\"https://widget.example.com/reviews\"></iframe><p>See reviews from our partners.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_input_custom: Visitor replaces input with labeled output', () => {
    ...
    const result = convert("<form><label>Username: <input type=\"text\" name=\"username\" value=\"\"></label><label>Password: <input type=\"password\" name=\"password\"></label></form>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_input_skip: Visitor skips all input elements', () => {
    ...
    const result = convert("<p>Sign up:</p><input type=\"text\" name=\"email\" placeholder=\"your@email.com\"><input type=\"checkbox\" name=\"agree\"><p>Continue</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_line_break_custom: Visitor replaces line break with custom output', () => {
    ...
    const result = convert("<p>First line<br>Second line<br>Third line</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_line_break_skip: Visitor removes all line breaks', () => {
    ...
    const result = convert("<p>Address Line 1<br>Address Line 2<br>Address Line 3</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_mark_custom: Visitor replaces highlight/mark with custom template', () => {
    ...
    const result = convert("<p>This is a <mark>highlighted passage</mark> in the text.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_mark_skip: Visitor skips mark elements entirely', () => {
    ...
    const result = convert("<p>Key insight: <mark>always validate input</mark> for security.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_preserve_html: Visitor preserve_html action includes raw HTML in output', () => {
    ...
    const result = convert("<div><custom-tag>Custom content</custom-tag></div>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_skip_all_headings: Visitor skips all headings from document', () => {
    ...
    const result = convert("<h1>Title</h1><p>Body text remains.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_skip_code_blocks: Visitor skips code blocks from output', () => {
    ...
    const result = convert("<p>Intro text</p><pre><code>let x = 42;</code></pre><p>Outro text</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_skip_images: Visitor skips all images from output', () => {
    ...
    const result = convert("<p>Before image</p><img src=\"photo.jpg\" alt=\"A photo\"><p>After image</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_skip_links: Visitor skips all links entirely', () => {
    ...
    const result = convert("<p>Before <a href=\"https://example.com\">link text</a> after</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_skip_strong: Visitor skips bold/strong elements', () => {
    ...
    const result = convert("<p>Normal <strong>bold text</strong> normal</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_subscript_custom: Visitor replaces subscript with custom template', () => {
    ...
    const result = convert("<p>H<sub>2</sub>O is water.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_subscript_skip: Visitor skips subscript elements entirely', () => {
    ...
    const result = convert("<p>The formula C<sub>12</sub>H<sub>22</sub>O<sub>11</sub> is sugar.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_superscript_custom: Visitor replaces superscript with custom template', () => {
    ...
    const result = convert("<p>Einstein's E=mc<sup>2</sup> revolutionized physics.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_superscript_skip: Visitor skips superscript from output', () => {
    ...
    const result = convert("<p>The equation x<sup>3</sup> + y<sup>3</sup> = z<sup>3</sup> has no solutions.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_underline_custom: Visitor replaces underline with custom markup', () => {
    ...
    const result = convert("<p>This is <u>very important</u> text.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_underline_skip: Visitor skips underline elements from output', () => {
    ...
    const result = convert("<p>Normal text with <u>underlined part</u> and more text.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_video_custom: Visitor replaces video with custom link', () => {
    ...
    const result = convert("<p>Watch our tutorial:</p><video src=\"tutorial.mp4\" width=\"320\" height=\"240\" controls></video><p>Great content!</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
  ...
  it('visitor_video_skip: Visitor removes video elements entirely', () => {
    ...
    const result = convert("<h2>Demo</h2><video src=\"demo.webm\"></video><p>See the demo above.</p>", {} as unknown as JsConversionOptions, { visitor: _testVisitor });
