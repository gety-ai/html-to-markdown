...
// alef:hash:504b528dae133520a00a31b43b805553caadf8de71bc278f3579d8e9c4c4e490
...
describe('conversion', () => {
  it('blockquote_multiple_paragraphs: Blockquote with multiple paragraphs has each paragraph prefixed', () => {
    const result = convert("<blockquote><p>First paragraph.</p><p>Second paragraph.</p></blockquote>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("> First paragraph.");
    expect(result.content).toContain("> Second paragraph.");
  });

  it('blockquote_nested: Nested blockquote produces double-prefixed lines', () => {
    const result = convert("<blockquote><p>Outer quote.</p><blockquote><p>Inner quote.</p></blockquote></blockquote>", {} as unknown as JsConversionOptions);
  ...
  it('blockquote_simple: Simple blockquote', () => {
    const result = convert("<blockquote><p>Quote text</p></blockquote>", {} as unknown as JsConversionOptions);
  ...
  it('blockquote_with_list: Blockquote containing a list preserves list items inside quote', () => {
    const result = convert("<blockquote><p>Quote intro:</p><ul><li>Point one</li><li>Point two</li></ul></blockquote>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('bold_and_italic: Nested bold and italic', () => {
    const result = convert("<p><strong><em>both</em></strong></p>", {} as unknown as JsConversionOptions);
  ...
  it('code_block: Code block with language preserves content', () => {
    const result = convert("<pre><code class=\"language-python\">print('hello')</code></pre>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('code_block_no_language: Code block without a language class preserves content', () => {
    const result = convert("<pre><code>plain code here</code></pre>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
    expect(result.content).toContain("plain code here");
  });

  it('code_inline_in_paragraph: Inline code element nested inside a paragraph', () => {
    const result = convert("<p>Call the <code>initialize()</code> method first.</p>", {} as unknown as JsConversionOptions);
  ...
  it('code_with_backticks_in_content: Inline code containing backtick characters is properly escaped', () => {
    const result = convert("<p>Use <code>`backtick` here</code> carefully.</p>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('form_input_elements: Form input elements produce readable output without form mechanics', () => {
    const result = convert("<form><label for=\"name\">Name:</label><input type=\"text\" id=\"name\" placeholder=\"Enter name\"></form>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
    expect(result.content).toContain("Name");
  });

  it('form_select_options: Select element with options produces readable output', () => {
    const result = convert("<form><label>Color:</label><select><option value=\"red\">Red</option><option value=\"blue\" selected>Blue</option><option value=\"green\">Green</option></select></form>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
    expect(result.content).toContain("Color");
  });

  it('form_textarea: Textarea element produces readable output', () => {
    const result = convert("<form><label>Message:</label><textarea>Default text content</textarea></form>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('image_figure_figcaption: Figure with figcaption preserves both image and caption', () => {
    const result = convert("<figure><img src=\"sunset.jpg\" alt=\"A sunset\"><figcaption>Beautiful sunset over the ocean</figcaption></figure>", {} as unknown as JsConversionOptions);
  ...
  it('image_linked: Image inside an anchor produces a linked image', () => {
    const result = convert("<a href=\"https://example.com\"><img src=\"icon.png\" alt=\"Icon\"></a>", {} as unknown as JsConversionOptions);
  ...
  it('image_simple: Image with alt text', () => {
    const result = convert("<img src=\"photo.jpg\" alt=\"A photo\">", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("![A photo](photo.jpg)");
  });

  it('image_with_title: Image with title attribute includes title in output', () => {
    const result = convert("<img src=\"chart.png\" alt=\"Sales chart\" title=\"Q3 Sales\">", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("![Sales chart](chart.png");
    expect(result.content).toContain("Q3 Sales");
  });

  it('inline_code: Inline code', () => {
    const result = convert("<p>Use <code>console.log()</code> to debug</p>", {} as unknown as JsConversionOptions);
  ...
  it('line_break_br_tag: Single br tag produces a line break in output', () => {
    const result = convert("<p>First line.<br>Second line.</p>", {} as unknown as JsConversionOptions);
  ...
  it('line_break_hr_tag: hr tag produces a horizontal separator between content', () => {
    const result = convert("<p>Before rule.</p><hr><p>After rule.</p>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('link_anchor_fragment: Fragment-only anchor link is preserved', () => {
    const result = convert("<a href=\"#section\">Jump to section</a>", {} as unknown as JsConversionOptions);
  ...
  it('link_image_inside: Image inside a link produces a linked image', () => {
    const result = convert("<a href=\"https://example.com\"><img src=\"logo.png\" alt=\"Logo\"></a>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("![Logo](logo.png)");
    expect(result.content).toContain("https://example.com");
  });

  it('link_mailto: Mailto link is preserved with mailto: scheme', () => {
    const result = convert("<a href=\"mailto:user@example.com\">Email us</a>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("mailto:user@example.com");
  });

  it('link_simple: Simple link', () => {
    const result = convert("<a href=\"https://example.com\">Example</a>", {} as unknown as JsConversionOptions);
  ...
  it('link_with_bold_text: Link containing bold text preserves formatting', () => {
    const result = convert("<a href=\"https://example.com\"><strong>Bold link</strong></a>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("**Bold link**");
    expect(result.content).toContain("https://example.com");
  });

  it('link_with_title: Link with title attribute', () => {
    const result = convert("<a href=\"https://example.com\" title=\"Example Site\">Example</a>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("[Example](https://example.com");
    expect(result.content).toContain("Example Site");
  });

  it('list_definition_dl: Definition list with dt and dd elements', () => {
    const result = convert("<dl><dt>Term One</dt><dd>Definition of term one.</dd><dt>Term Two</dt><dd>Definition of term two.</dd></dl>", {} as unknown as JsConversionOptions);
  ...
  it('list_item_multiple_paragraphs: List item containing multiple paragraphs', () => {
    const result = convert("<ul><li><p>First paragraph in item.</p><p>Second paragraph in item.</p></li><li>Simple item</li></ul>", {} as unknown as JsConversionOptions);
  ...
  it('list_mixed_nested: Mixed list: ordered list nested inside unordered list', () => {
    const result = convert("<ul><li>Item A<ol><li>Sub 1</li><li>Sub 2</li></ol></li><li>Item B</li></ul>", {} as unknown as JsConversionOptions);
  ...
  it('list_nested_ordered: Nested ordered list with two levels of depth', () => {
    const result = convert("<ol><li>Step 1<ol><li>Step 1a</li><li>Step 1b</li></ol></li><li>Step 2</li></ol>", {} as unknown as JsConversionOptions);
  ...
  it('list_nested_unordered: Nested unordered list with two levels of depth', () => {
    const result = convert("<ul><li>Parent A<ul><li>Child A1</li><li>Child A2</li></ul></li><li>Parent B</li></ul>", {} as unknown as JsConversionOptions);
  ...
  it('list_task_checkboxes: Task list with checked and unchecked checkboxes', () => {
    const result = convert("<ul><li><input type=\"checkbox\" checked> Done task</li><li><input type=\"checkbox\"> Pending task</li></ul>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('ordered_list: Ordered list', () => {
    const result = convert("<ol><li>First</li><li>Second</li><li>Third</li></ol>", {} as unknown as JsConversionOptions);
  ...
  it('paragraph_multiple: Multiple paragraphs are separated by a blank line', () => {
    const result = convert("<p>First paragraph.</p><p>Second paragraph.</p>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("First paragraph.");
    expect(result.content).toContain("Second paragraph.");
  });

  it('paragraph_nested_divs: Text nested inside divs is extracted correctly', () => {
    const result = convert("<div><div><p>Nested text</p></div></div>", {} as unknown as JsConversionOptions);
  ...
  it('paragraph_with_inline_formatting: Paragraph with bold, italic, and a link', () => {
    const result = convert("<p>This has <strong>bold</strong>, <em>italic</em>, and a <a href=\"https://example.com\">link</a>.</p>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("**bold**");
    expect(result.content).toContain("*italic*");
  ...
  it('paragraph_with_line_breaks: Paragraph with br tags produces line breaks in output', () => {
    const result = convert("<p>Line one.<br>Line two.<br>Line three.</p>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('semantic_abbr: Abbreviation element text is preserved', () => {
    const result = convert("<p>The <abbr title=\"World Wide Web\">WWW</abbr> is global.</p>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("WWW");
  });

  it('semantic_article: Article element wrapping content preserves inner content', () => {
    const result = convert("<article><h2>Article Title</h2><p>Article body.</p></article>", {} as unknown as JsConversionOptions);
  ...
  it('semantic_definition_list: Definition list with term and description', () => {
    const result = convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", {} as unknown as JsConversionOptions);
  ...
  it('semantic_details_summary: Details and summary elements produce readable output', () => {
    const result = convert("<details><summary>Click to expand</summary><p>Hidden content here.</p></details>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('semantic_mark_highlight: Mark tag produces highlighted output', () => {
    const result = convert("<p>This is <mark>highlighted text</mark> in a sentence.</p>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('semantic_section_with_heading: Section element with heading preserves structure', () => {
    const result = convert("<section><h3>Section Heading</h3><p>Section content.</p></section>", {} as unknown as JsConversionOptions);
  ...
  it('semantic_sub_superscript: Subscript and superscript elements are preserved in output', () => {
    const result = convert("<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
    expect(result.content).toContain("H");
    expect(result.content).toContain("2");
    expect(result.content).toContain("O");
  ...
  it('simple_table: Simple table with header', () => {
    const result = convert("<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", {} as unknown as JsConversionOptions);
    expect(result.content).toContain("Name");
  ...
  it('table_no_thead: Table without thead uses first row as implied header', () => {
    const result = convert("<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</td><td>1.00</td></tr></table>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('table_pipe_chars_in_content: Table cells containing pipe characters are escaped in output', () => {
    const result = convert("<table><thead><tr><th>Expression</th><th>Result</th></tr></thead><tbody><tr><td>a | b</td><td>true</td></tr></tbody></table>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('table_with_alignment: Table with column alignment attributes', () => {
    const result = convert("<table><thead><tr><th align=\"left\">Left</th><th align=\"center\">Center</th><th align=\"right\">Right</th></tr></thead><tbody><tr><td>L</td><td>C</td><td>R</td></tr></tbody></table>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('table_with_colspan: Table with colspan attribute in a header cell', () => {
    const result = convert("<table><thead><tr><th colspan=\"2\">Full Name</th></tr></thead><tbody><tr><td>John</td><td>Doe</td></tr></tbody></table>", {} as unknown as JsConversionOptions);
    expect((() => { const v = (result.content as unknown) ?? ''; return typeof v === 'string' || Array.isArray(v) ? (v as { length: number }).length : Object.keys(v as object).length; })()).toBeGreaterThan(0);
  ...
  it('unordered_list: Unordered list', () => {
    const result = convert("<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>", {} as unknown as JsConversionOptions);
