...
// alef:hash:88e6d6f180dab3bde12137b3c48a34058a635cc9190533e9e4e62f977844cdf1
...
describe("conversion", () => {
  ...
  it("bold_and_italic: Nested bold and italic", () => {
    const result = convert("<p><strong><em>both</em></strong></p>", {} as WasmConversionOptions);
    expect(result.content).toContain("***both***");
  });

  it("bold_strong: Strong tag converts to bold", () => {
    const result = convert("<p><strong>bold</strong></p>", {} as WasmConversionOptions);
  ...
  it("code_block_no_language: Code block without a language class preserves content", () => {
    const result = convert("<pre><code>plain code here</code></pre>", {} as WasmConversionOptions);
    expect((result.content ?? "").length).toBeGreaterThan(0);
  ...
  it("emphasis_superscript: sup tag content is preserved", () => {
    const result = convert("<p>x<sup>2</sup></p>", {} as WasmConversionOptions);
    expect(result.content).toContain("x");
    expect(result.content).toContain("2");
  });

  it("emphasis_underline_u: u tag content is preserved in output", () => {
    const result = convert("<p><u>underlined</u></p>", {} as WasmConversionOptions);
  ...
  it("form_input_elements: Form input elements produce readable output without form mechanics", () => {
    const result = convert(
      ...
      { preprocessing: { removeForms: false } } as WasmConversionOptions,
    );
    expect((result.content ?? "").length).toBeGreaterThan(0);
  ...
  it("heading_h1: H1 heading", () => {
    const result = convert("<h1>Heading 1</h1>", {} as WasmConversionOptions);
    expect((result.content ?? "").trim()).toBe("# Heading 1");
  });

  it("heading_h2: H2 heading", () => {
    const result = convert("<h2>Heading 2</h2>", {} as WasmConversionOptions);
    expect((result.content ?? "").trim()).toBe("## Heading 2");
  });

  it("heading_h3: H3 heading", () => {
    const result = convert("<h3>Heading 3</h3>", {} as WasmConversionOptions);
    expect((result.content ?? "").trim()).toBe("### Heading 3");
  });

  it("heading_h4: H4 heading", () => {
    const result = convert("<h4>Heading 4</h4>", {} as WasmConversionOptions);
    expect((result.content ?? "").trim()).toBe("#### Heading 4");
  });

  it("heading_h5: H5 heading", () => {
    const result = convert("<h5>Heading 5</h5>", {} as WasmConversionOptions);
    expect((result.content ?? "").trim()).toBe("##### Heading 5");
  });

  it("heading_h6: H6 heading", () => {
    const result = convert("<h6>Heading 6</h6>", {} as WasmConversionOptions);
  ...
  it("image_no_alt: Image without alt text produces image markdown", () => {
    const result = convert('<img src="banner.jpg">', {} as WasmConversionOptions);
    expect((result.content ?? "").length).toBeGreaterThan(0);
    expect(result.content).toContain("banner.jpg");
  });

  it("image_simple: Image with alt text", () => {
    const result = convert('<img src="photo.jpg" alt="A photo">', {} as WasmConversionOptions);
  ...
  it("italic_em: Em tag converts to italic", () => {
    const result = convert("<p><em>italic</em></p>", {} as WasmConversionOptions);
    expect(result.content).toContain("*italic*");
  });

  it("line_break_br_tag: Single br tag produces a line break in output", () => {
    const result = convert("<p>First line.<br>Second line.</p>", {} as WasmConversionOptions);
  ...
  it("line_break_multiple_br: Multiple consecutive br tags in sequence", () => {
    const result = convert("<p>Start.<br><br>End.</p>", {} as WasmConversionOptions);
    expect(result.content).toContain("Start.");
    expect(result.content).toContain("End.");
  });

  it("link_anchor_fragment: Fragment-only anchor link is preserved", () => {
    const result = convert('<a href="#section">Jump to section</a>', {} as WasmConversionOptions);
  ...
  it("link_empty_href: Link with empty href produces output with the link text", () => {
    const result = convert('<a href="">No destination</a>', {} as WasmConversionOptions);
  ...
  it("paragraph_nested_divs: Text nested inside divs is extracted correctly", () => {
    const result = convert("<div><div><p>Nested text</p></div></div>", {} as WasmConversionOptions);
  ...
  it("semantic_hr: Horizontal rule produces a separator in output", () => {
    const result = convert("<p>Above</p><hr><p>Below</p>", {} as WasmConversionOptions);
    expect((result.content ?? "").length).toBeGreaterThan(0);
  ...
  it("table_empty: Empty table produces no output or minimal output", () => {
    const result = convert("<table></table>", {} as WasmConversionOptions);
