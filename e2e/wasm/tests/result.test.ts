...
describe("result", () => {
	...
	it("result_tables_empty_when_no_tables: Result tables array is empty when input has no tables", () => {
		const result = convert("<p>No tables here</p>", (() => { const _u0 = WasmConversionOptions.default(); _u0.includeDocumentStructure = true; return _u0; })());
    {
	...
	it("result_tables_multiple: Multiple tables each appear in the tables array", () => {
		const result = convert("<table><tr><th>A</th></tr><tr><td>1</td></tr></table><p>Between</p><table><tr><th>B</th></tr><tr><td>2</td></tr></table>", (() => { const _u0 = WasmConversionOptions.default(); _u0.includeDocumentStructure = true; return _u0; })());
	...
	it("result_tables_simple: Simple table populates the tables array in result", () => {
		const result = convert("<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", (() => { const _u0 = WasmConversionOptions.default(); _u0.includeDocumentStructure = true; return _u0; })());
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("result_warning_kind_image_extraction_failed: A malformed data URI with extract_images enabled produces an ImageExtractionFailed warning", () => {
		const result = convert("<p>Text<img src=\"data:BADMIME\" alt=\"broken\">end</p>", (() => { const _u0 = WasmConversionOptions.default(); _u0.extractImages = true; return _u0; })());
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
