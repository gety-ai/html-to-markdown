...
// alef:hash:7d6802358de18fe327e14bd61b9f099a52e1b3d6043c4b178cfd370b01543531
...
final class OptionsTest extends TestCase
{
    ...
    {        $options = ConversionOptions::from_json(json_encode(["extractMetadata" => true]));
        $result = HtmlToMarkdown::convert("<html><head><title>Test Page</title><meta name='description' content='A test page'></head><body><p>Content</p></body></html>", $options);
            $this->assertNotEmpty($result->content);
            $this->assertEquals("Test Page", trim($result->metadata->document->title));
            $this->assertEquals("A test page", trim($result->metadata->document->description));
    ...
    {        $options = ConversionOptions::from_json(json_encode(["preprocessing" => ["remove_forms" => true]]));
