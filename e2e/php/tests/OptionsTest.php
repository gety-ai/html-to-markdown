...
// alef:hash:ff301976a6bc417ad5f5c2bf3a67dcf2b94bc07e5f47871a65395356b59003b4
...
final class OptionsTest extends TestCase
{
    ...
    {
        $builder = \HtmlToMarkdown\ConversionOptions::builder();
        $preprocessing = new \HtmlToMarkdown\PreprocessingOptions(true, "Aggressive", true, true);
    ...
    {
        $builder = \HtmlToMarkdown\ConversionOptions::builder();
        $preprocessing = new \HtmlToMarkdown\PreprocessingOptions(true, "Minimal", true, true);
        $builder = $builder->preprocessing($preprocessing);
        $options = $builder->build();
