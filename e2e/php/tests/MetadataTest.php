...
final class MetadataTest extends TestCase
{
    ...
    public function test_metadata_canonical_url(): void
    {
        ...
        $this->assertEquals(
            ...
            trim($result->getMetadata()->getDocument()->canonicalUrl),
        );
    }
    ...
    public function test_og_basic_tags(): void
    {
        ...
        $this->assertEquals(
            'OG description text.',
            trim($result->getMetadata()->getDocument()->getOpenGraph()['description']),
        );
        $this->assertEquals(
            'https://example.com/image.jpg',
            trim($result->getMetadata()->getDocument()->getOpenGraph()['image']),
        );
    }
    ...
    public function test_og_multiple_tags(): void
    {
        ...
        $this->assertEquals(
            ...
            trim($result->getMetadata()->getDocument()->getOpenGraph()['url']),
        );
    ...
    public function test_twitter_card_tags(): void
    {
        ...
        $this->assertEquals(
            'summary_large_image',
            trim($result->getMetadata()->getDocument()->getTwitterCard()['card']),
        );
        $this->assertEquals(
            'Twitter Card Title',
            trim($result->getMetadata()->getDocument()->getTwitterCard()['title']),
        );
        $this->assertEquals(
            'Twitter card description.',
            trim($result->getMetadata()->getDocument()->getTwitterCard()['description']),
        );
    }
}
