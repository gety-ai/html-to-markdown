...
void main() {
  ...
  test('Links without title get empty title attribute when defaultTitle is true', () async {
    ...
    final result = await H2mBridge.convert('<p><a href=\'https://example.com\'>Link</a></p>', options: _options);
  ...
  test('UTF-8 encoding hint for special characters', () async {
    ...
    final result = await H2mBridge.convert('<p>Café naïve résumé</p>', options: _options);
    expect(result.content, isNotNull);
  });
  ...
  test('Elements matching CSS id selector are excluded entirely', () async {
    ...
    final result = await H2mBridge.convert('<body><div id="ad-container">Buy stuff</div><p>Article text</p></body>', options: _options);
  ...
  test('When extract_images is false, conversion still succeeds and inline images are not extracted', () async {
    ...
    final result = await H2mBridge.convert('<p>Text with <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" alt="pixel"> image.</p>', options: _options);
    expect(result.content, isNotNull);
  });
  ...
  test('Enabling extract_images processes a data-URI image without crashing', () async {
    ...
    final result = await H2mBridge.convert('<p>Before<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" alt="pixel">After</p>', options: _options);
    expect(result.content, isNotNull);
  ...
  test('Mark tag rendered as bold', () async {
    ...
    final result = await H2mBridge.convert('<p>Text with <mark>highlighted</mark> text.</p>', options: _options);
  ...
  test('Disabling infer_dimensions skips the decode step and still produces content', () async {
    ...
    final result = await H2mBridge.convert('<p>No dims: <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" alt="pixel"></p>', options: _options);
    expect(result.content, isNotNull);
  ...
  test('Enabling infer_dimensions decodes image bytes to populate dimension metadata when extract_images is on', () async {
    ...
    final result = await H2mBridge.convert('<p>With dims: <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" alt="pixel"></p>', options: _options);
    expect(result.content, isNotNull);
  ...
  test('Default max_depth (null) converts deeply nested content fully', () async {
    ...
    final result = await H2mBridge.convert('<div><div><div><div><p>Deep content</p></div></div></div></div>', _options);
  ...
  test('A generous max_image_size accommodates a small data-URI image without warnings', () async {
    ...
    final result = await H2mBridge.convert('<p>Image: <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" alt="pixel"></p>', options: _options);
    expect(result.content, isNotNull);
  ...
  test('A tiny max_image_size does not crash conversion even when the image exceeds the limit', () async {
    ...
    final result = await H2mBridge.convert('<p>Tiny limit: <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==" alt="pixel"></p>', options: _options);
    expect(result.content, isNotNull);
