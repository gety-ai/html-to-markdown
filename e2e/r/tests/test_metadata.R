...
# alef:hash:741d7ae6cdce180fe7385e1e55a8c5f63a4adfd1ca3f4976953f6cd3cd2ccaa1
...
test_that("metadata_author_meta: Extract author from <meta name='author'> tag", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Page</title><meta name=\"author\" content=\"Jane Doe\"></head><body><p>Content</p></body></html>", options = NULL), simplifyVector = FALSE)
...
test_that("metadata_canonical_url: Extract canonical URL from <link rel='canonical'> tag", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Page</title><link rel=\"canonical\" href=\"https://example.com/canonical-page\"></head><body><p>Content</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_description_meta: Extract description from <meta name='description'> tag", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Page</title><meta name=\"description\" content=\"This is the page description.\"></head><body><p>Content</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_dublin_core: Extract Dublin Core metadata tags", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Scholarly Work</title><meta name=\"DC.title\" content=\"Principles of Knowledge Management\"><meta name=\"DC.creator\" content=\"Dr. Alice Johnson\"><meta name=\"DC.date\" content=\"2023-06-15\"><meta name=\"DC.subject\" content=\"Knowledge Management\"><meta name=\"DC.publisher\" content=\"Academic Press\"></head><body><p>This is a scholarly article.</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_extract_all_images: Extract all images from a document into metadata", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Gallery</title></head><body><img src=\"https://example.com/photo1.jpg\" alt=\"Photo 1\"><img src=\"https://example.com/photo2.png\" alt=\"Photo 2\"><img src=\"/local/image.webp\" alt=\"Local image\"></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_extract_all_links: Extract all links from a document into metadata", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Links Page</title></head><body><p>Visit <a href=\"https://example.com\">Example</a> or <a href=\"https://docs.example.com\">Docs</a>.</p><p>Also see <a href=\"/relative/path\">relative link</a> and <a href=\"mailto:hello@example.com\">email us</a>.</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_headers_hierarchy: Extract heading hierarchy from document into metadata", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Docs</title></head><body><h1>Introduction</h1><h2>Getting Started</h2><h3>Installation</h3><h3>Configuration</h3><h2>Advanced Usage</h2><h3>Custom Options</h3></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_keywords_meta: Extract keywords from <meta name='keywords'> tag", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Page</title><meta name=\"keywords\" content=\"rust, markdown, html, converter\"></head><body><p>Content</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_lang_attribute: Extract language from html lang attribute", {
  result <- jsonlite::fromJSON(convert(html = "<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_microdata_schema_article: Extract schema.org microdata for Article", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Article</title></head><body><article itemscope itemtype=\"https://schema.org/Article\"><h1 itemprop=\"headline\">Breaking News Today</h1><span itemprop=\"author\">Jane Reporter</span><span itemprop=\"datePublished\">2024-04-22</span><div itemprop=\"articleBody\"><p>The article content goes here with important information about the breaking news story.</p></div></article></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_microdata_schema_organization: Extract schema.org microdata for Organization", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_microdata_schema_person: Extract schema.org microdata for Person", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_microdata_schema_product: Extract schema.org microdata for Product", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Product</title></head><body><div itemscope itemtype=\"https://schema.org/Product\"><h1 itemprop=\"name\">Awesome Widget</h1><span itemprop=\"description\">The best widget on the market</span><span itemprop=\"price\">29.99</span><span itemprop=\"priceCurrency\">USD</span><img itemprop=\"image\" src=\"widget.jpg\" alt=\"Widget\"><span itemprop=\"ratingValue\">4.5</span></div></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_text_direction_ltr: Extract text direction from lang attribute on html element", {
  result <- jsonlite::fromJSON(convert(html = "<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("metadata_text_direction_rtl: Extract right-to-left text direction", {
  result <- jsonlite::fromJSON(convert(html = "<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
  expect_true(grepl("right-to-left text", result$content, fixed = TRUE))
})

test_that("metadata_title_tag: Extract title from <title> tag", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>My Page</title></head><body><p>Content</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("og_basic_tags: Extract og:title, og:description, and og:image from Open Graph meta tags", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Fallback Title</title><meta property=\"og:title\" content=\"OG Title\"><meta property=\"og:description\" content=\"OG description text.\"><meta property=\"og:image\" content=\"https://example.com/image.jpg\"></head><body><p>Content</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("structured_data_json_ld: JSON-LD script tag is stripped from output (security) but metadata may be extracted", {
  result <- jsonlite::fromJSON(convert(html = "<html><head><title>Article</title><script type=\"application/ld+json\">{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"My Article\",\"author\":{\"@type\":\"Person\",\"name\":\"Jane Doe\"},\"datePublished\":\"2024-01-15\"}</script></head><body><h1>My Article</h1><p>Article body text.</p></body></html>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
