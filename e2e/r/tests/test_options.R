...
# alef:hash:72e44f22d6dca7c3c50c0d080aa654dcb6a6d9a6a2d131dc885d42d4cf8b9695
...
test_that("options_exclude_selectors_attribute: Elements matching CSS attribute selector are excluded entirely", {
  result <- convert(html = "<body><div role=\"complementary\">Sidebar</div><p>Primary text</p></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c("[role='complementary']")), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_class: Elements matching CSS class selector are excluded entirely", {
  result <- convert(html = "<body><div class=\"cookie-banner\">Accept cookies</div><p>Main content</p></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c(".cookie-banner")), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_empty_noop: Empty exclude_selectors list does not affect output", {
  result <- convert(html = "<p>Hello world</p>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c()), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_id: Elements matching CSS id selector are excluded entirely", {
  result <- convert(html = "<body><div id=\"ad-container\">Buy stuff</div><p>Article text</p></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c("#ad-container")), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_multiple: Multiple CSS selectors each exclude their matched elements", {
  result <- convert(html = "<body><nav class=\"nav\">Menu</nav><p>Content</p><footer>Footer</footer></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c(".nav", "footer")), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_nested_content_dropped: All descendants of excluded elements are dropped", {
  result <- convert(html = "<body><aside class=\"sidebar\"><h2>Related</h2><p>Sidebar text</p></aside><main><p>Main text</p></main></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c(".sidebar")), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_plain_text_mode: Exclude selectors work in plain text output mode", {
  result <- convert(html = "<body><div class=\"nav\">Navigation</div><p>Article body</p></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c(".nav"), "output_format" = "plain"), auto_unbox = TRUE)))
...
test_that("options_exclude_selectors_vs_strip_tags: exclude_selectors drops entire subtree unlike strip_tags which keeps children", {
  result <- convert(html = "<body><div class=\"wrapper\"><p>Inner paragraph</p></div><p>Outer text</p></body>", options = ConversionOptions$from_json(jsonlite::toJSON(list("exclude_selectors" = c(".wrapper")), auto_unbox = TRUE)))
...
test_that("options_keep_inline_images_in_paragraph: Images inside specified tags stay inline", {
  result <- convert(html = "<p>Text <img src='icon.png' alt='icon'> more text</p>", options = ConversionOptions$from_json(jsonlite::toJSON(list("keep_inline_images_in" = c("p")), auto_unbox = TRUE)))
  expect_true(any(grepl("Text", result$content, fixed = TRUE)))
...
test_that("options_preserve_tags_iframe: Iframe tags preserved as raw HTML in output", {
  result <- convert(html = "<p>Before</p><iframe src='video.html' width='560'></iframe><p>After</p>", options = ConversionOptions$from_json(jsonlite::toJSON(list("preserve_tags" = c("iframe")), auto_unbox = TRUE)))
  expect_true(any(grepl("Before", result$content, fixed = TRUE)))
  expect_true(any(grepl("After", result$content, fixed = TRUE)))
...
test_that("options_strip_tags_div_span: Div and span tags stripped but content preserved", {
  result <- convert(html = "<div class='wrapper'><p>Inside div</p></div><p>Outside <span class='hl'>span text</span></p>", options = ConversionOptions$from_json(jsonlite::toJSON(list("strip_tags" = c("div", "span")), auto_unbox = TRUE)))
