...
# alef:hash:dce8847a1fdbb60d314dbe0b1697bcc75b04052701485b8ddcf21e91ce0c1fb6
...
test_that("blockquote_multiple_paragraphs: Blockquote with multiple paragraphs has each paragraph prefixed", {
  result <- jsonlite::fromJSON(convert(html = "<blockquote><p>First paragraph.</p><p>Second paragraph.</p></blockquote>", options = NULL), simplifyVector = FALSE)
...
test_that("blockquote_nested: Nested blockquote produces double-prefixed lines", {
  result <- jsonlite::fromJSON(convert(html = "<blockquote><p>Outer quote.</p><blockquote><p>Inner quote.</p></blockquote></blockquote>", options = NULL), simplifyVector = FALSE)
...
test_that("blockquote_simple: Simple blockquote", {
  result <- jsonlite::fromJSON(convert(html = "<blockquote><p>Quote text</p></blockquote>", options = NULL), simplifyVector = FALSE)
...
test_that("blockquote_with_list: Blockquote containing a list preserves list items inside quote", {
  result <- jsonlite::fromJSON(convert(html = "<blockquote><p>Quote intro:</p><ul><li>Point one</li><li>Point two</li></ul></blockquote>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("bold_and_italic: Nested bold and italic", {
  result <- jsonlite::fromJSON(convert(html = "<p><strong><em>both</em></strong></p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("***both***", result$content, fixed = TRUE))
})

test_that("bold_strong: Strong tag converts to bold", {
  result <- jsonlite::fromJSON(convert(html = "<p><strong>bold</strong></p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("**bold**", result$content, fixed = TRUE))
})

test_that("code_block: Code block with language preserves content", {
  result <- jsonlite::fromJSON(convert(html = "<pre><code class=\"language-python\">print('hello')</code></pre>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("code_block_no_language: Code block without a language class preserves content", {
  result <- jsonlite::fromJSON(convert(html = "<pre><code>plain code here</code></pre>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("code_inline_in_paragraph: Inline code element nested inside a paragraph", {
  result <- jsonlite::fromJSON(convert(html = "<p>Call the <code>initialize()</code> method first.</p>", options = NULL), simplifyVector = FALSE)
...
test_that("code_with_backticks_in_content: Inline code containing backtick characters is properly escaped", {
  result <- jsonlite::fromJSON(convert(html = "<p>Use <code>`backtick` here</code> carefully.</p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("emphasis_mark_highlight: mark tag produces highlighted output", {
  result <- jsonlite::fromJSON(convert(html = "<p><mark>highlighted</mark></p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("emphasis_strikethrough_del: del tag converts to GFM strikethrough", {
  result <- jsonlite::fromJSON(convert(html = "<p><del>deleted text</del></p>", options = NULL), simplifyVector = FALSE)
...
test_that("emphasis_strikethrough_s: s tag converts to GFM strikethrough", {
  result <- jsonlite::fromJSON(convert(html = "<p><s>strikethrough</s></p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("~~strikethrough~~", result$content, fixed = TRUE))
})

test_that("emphasis_subscript: sub tag content is preserved", {
  result <- jsonlite::fromJSON(convert(html = "<p>H<sub>2</sub>O</p>", options = NULL), simplifyVector = FALSE)
...
test_that("emphasis_superscript: sup tag content is preserved", {
  result <- jsonlite::fromJSON(convert(html = "<p>x<sup>2</sup></p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("x", result$content, fixed = TRUE))
  expect_true(grepl("2", result$content, fixed = TRUE))
})

test_that("emphasis_underline_u: u tag content is preserved in output", {
  result <- jsonlite::fromJSON(convert(html = "<p><u>underlined</u></p>", options = NULL), simplifyVector = FALSE)
...
test_that("form_input_elements: Form input elements produce readable output without form mechanics", {
  result <- jsonlite::fromJSON(convert(html = "<form><label for=\"name\">Name:</label><input type=\"text\" id=\"name\" placeholder=\"Enter name\"></form>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("form_select_options: Select element with options produces readable output", {
  result <- jsonlite::fromJSON(convert(html = "<form><label>Color:</label><select><option value=\"red\">Red</option><option value=\"blue\" selected>Blue</option><option value=\"green\">Green</option></select></form>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
  expect_true(grepl("Color", result$content, fixed = TRUE))
})

test_that("form_textarea: Textarea element produces readable output", {
  result <- jsonlite::fromJSON(convert(html = "<form><label>Message:</label><textarea>Default text content</textarea></form>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
  expect_true(grepl("Message", result$content, fixed = TRUE))
})

test_that("heading_h1: H1 heading", {
  result <- jsonlite::fromJSON(convert(html = "<h1>Heading 1</h1>", options = NULL), simplifyVector = FALSE)
  expect_equal(trimws(result$content), "# Heading 1")
})

test_that("heading_h2: H2 heading", {
  result <- jsonlite::fromJSON(convert(html = "<h2>Heading 2</h2>", options = NULL), simplifyVector = FALSE)
  expect_equal(trimws(result$content), "## Heading 2")
})

test_that("heading_h3: H3 heading", {
  result <- jsonlite::fromJSON(convert(html = "<h3>Heading 3</h3>", options = NULL), simplifyVector = FALSE)
  expect_equal(trimws(result$content), "### Heading 3")
})

test_that("heading_h4: H4 heading", {
  result <- jsonlite::fromJSON(convert(html = "<h4>Heading 4</h4>", options = NULL), simplifyVector = FALSE)
  expect_equal(trimws(result$content), "#### Heading 4")
})

test_that("heading_h5: H5 heading", {
  result <- jsonlite::fromJSON(convert(html = "<h5>Heading 5</h5>", options = NULL), simplifyVector = FALSE)
  expect_equal(trimws(result$content), "##### Heading 5")
})

test_that("heading_h6: H6 heading", {
  result <- jsonlite::fromJSON(convert(html = "<h6>Heading 6</h6>", options = NULL), simplifyVector = FALSE)
...
test_that("image_figure_figcaption: Figure with figcaption preserves both image and caption", {
  result <- jsonlite::fromJSON(convert(html = "<figure><img src=\"sunset.jpg\" alt=\"A sunset\"><figcaption>Beautiful sunset over the ocean</figcaption></figure>", options = NULL), simplifyVector = FALSE)
...
test_that("image_linked: Image inside an anchor produces a linked image", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"https://example.com\"><img src=\"icon.png\" alt=\"Icon\"></a>", options = NULL), simplifyVector = FALSE)
...
test_that("image_no_alt: Image without alt text produces image markdown", {
  result <- jsonlite::fromJSON(convert(html = "<img src=\"banner.jpg\">", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
  expect_true(grepl("banner.jpg", result$content, fixed = TRUE))
})

test_that("image_simple: Image with alt text", {
  result <- jsonlite::fromJSON(convert(html = "<img src=\"photo.jpg\" alt=\"A photo\">", options = NULL), simplifyVector = FALSE)
...
test_that("image_with_title: Image with title attribute includes title in output", {
  result <- jsonlite::fromJSON(convert(html = "<img src=\"chart.png\" alt=\"Sales chart\" title=\"Q3 Sales\">", options = NULL), simplifyVector = FALSE)
...
test_that("inline_code: Inline code", {
  result <- jsonlite::fromJSON(convert(html = "<p>Use <code>console.log()</code> to debug</p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("`console.log()`", result$content, fixed = TRUE))
})

test_that("italic_em: Em tag converts to italic", {
  result <- jsonlite::fromJSON(convert(html = "<p><em>italic</em></p>", options = NULL), simplifyVector = FALSE)
...
test_that("line_break_br_tag: Single br tag produces a line break in output", {
  result <- jsonlite::fromJSON(convert(html = "<p>First line.<br>Second line.</p>", options = NULL), simplifyVector = FALSE)
...
test_that("line_break_hr_tag: hr tag produces a horizontal separator between content", {
  result <- jsonlite::fromJSON(convert(html = "<p>Before rule.</p><hr><p>After rule.</p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("line_break_multiple_br: Multiple consecutive br tags in sequence", {
  result <- jsonlite::fromJSON(convert(html = "<p>Start.<br><br>End.</p>", options = NULL), simplifyVector = FALSE)
...
test_that("link_anchor_fragment: Fragment-only anchor link is preserved", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"#section\">Jump to section</a>", options = NULL), simplifyVector = FALSE)
...
test_that("link_empty_href: Link with empty href produces output with the link text", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"\">No destination</a>", options = NULL), simplifyVector = FALSE)
...
test_that("link_image_inside: Image inside a link produces a linked image", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"https://example.com\"><img src=\"logo.png\" alt=\"Logo\"></a>", options = NULL), simplifyVector = FALSE)
...
test_that("link_mailto: Mailto link is preserved with mailto: scheme", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"mailto:user@example.com\">Email us</a>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("mailto:user@example.com", result$content, fixed = TRUE))
})

test_that("link_simple: Simple link", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"https://example.com\">Example</a>", options = NULL), simplifyVector = FALSE)
...
test_that("link_with_bold_text: Link containing bold text preserves formatting", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"https://example.com\"><strong>Bold link</strong></a>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("**Bold link**", result$content, fixed = TRUE))
  expect_true(grepl("https://example.com", result$content, fixed = TRUE))
})

test_that("link_with_title: Link with title attribute", {
  result <- jsonlite::fromJSON(convert(html = "<a href=\"https://example.com\" title=\"Example Site\">Example</a>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("[Example](https://example.com", result$content, fixed = TRUE))
...
test_that("list_definition_dl: Definition list with dt and dd elements", {
  result <- jsonlite::fromJSON(convert(html = "<dl><dt>Term One</dt><dd>Definition of term one.</dd><dt>Term Two</dt><dd>Definition of term two.</dd></dl>", options = NULL), simplifyVector = FALSE)
...
test_that("list_item_multiple_paragraphs: List item containing multiple paragraphs", {
  result <- jsonlite::fromJSON(convert(html = "<ul><li><p>First paragraph in item.</p><p>Second paragraph in item.</p></li><li>Simple item</li></ul>", options = NULL), simplifyVector = FALSE)
...
test_that("list_mixed_nested: Mixed list: ordered list nested inside unordered list", {
  result <- jsonlite::fromJSON(convert(html = "<ul><li>Item A<ol><li>Sub 1</li><li>Sub 2</li></ol></li><li>Item B</li></ul>", options = NULL), simplifyVector = FALSE)
...
test_that("list_nested_ordered: Nested ordered list with two levels of depth", {
  result <- jsonlite::fromJSON(convert(html = "<ol><li>Step 1<ol><li>Step 1a</li><li>Step 1b</li></ol></li><li>Step 2</li></ol>", options = NULL), simplifyVector = FALSE)
...
test_that("list_nested_unordered: Nested unordered list with two levels of depth", {
  result <- jsonlite::fromJSON(convert(html = "<ul><li>Parent A<ul><li>Child A1</li><li>Child A2</li></ul></li><li>Parent B</li></ul>", options = NULL), simplifyVector = FALSE)
...
test_that("list_task_checkboxes: Task list with checked and unchecked checkboxes", {
  result <- jsonlite::fromJSON(convert(html = "<ul><li><input type=\"checkbox\" checked> Done task</li><li><input type=\"checkbox\"> Pending task</li></ul>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("ordered_list: Ordered list", {
  result <- jsonlite::fromJSON(convert(html = "<ol><li>First</li><li>Second</li><li>Third</li></ol>", options = NULL), simplifyVector = FALSE)
...
test_that("paragraph_multiple: Multiple paragraphs are separated by a blank line", {
  result <- jsonlite::fromJSON(convert(html = "<p>First paragraph.</p><p>Second paragraph.</p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("First paragraph.", result$content, fixed = TRUE))
  expect_true(grepl("Second paragraph.", result$content, fixed = TRUE))
})

test_that("paragraph_nested_divs: Text nested inside divs is extracted correctly", {
  result <- jsonlite::fromJSON(convert(html = "<div><div><p>Nested text</p></div></div>", options = NULL), simplifyVector = FALSE)
...
test_that("paragraph_with_inline_formatting: Paragraph with bold, italic, and a link", {
  result <- jsonlite::fromJSON(convert(html = "<p>This has <strong>bold</strong>, <em>italic</em>, and a <a href=\"https://example.com\">link</a>.</p>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("**bold**", result$content, fixed = TRUE))
  expect_true(grepl("*italic*", result$content, fixed = TRUE))
...
test_that("paragraph_with_line_breaks: Paragraph with br tags produces line breaks in output", {
  result <- jsonlite::fromJSON(convert(html = "<p>Line one.<br>Line two.<br>Line three.</p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("semantic_abbr: Abbreviation element text is preserved", {
  result <- jsonlite::fromJSON(convert(html = "<p>The <abbr title=\"World Wide Web\">WWW</abbr> is global.</p>", options = NULL), simplifyVector = FALSE)
...
test_that("semantic_article: Article element wrapping content preserves inner content", {
  result <- jsonlite::fromJSON(convert(html = "<article><h2>Article Title</h2><p>Article body.</p></article>", options = NULL), simplifyVector = FALSE)
...
test_that("semantic_definition_list: Definition list with term and description", {
  result <- jsonlite::fromJSON(convert(html = "<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", options = NULL), simplifyVector = FALSE)
...
test_that("semantic_details_summary: Details and summary elements produce readable output", {
  result <- jsonlite::fromJSON(convert(html = "<details><summary>Click to expand</summary><p>Hidden content here.</p></details>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("semantic_hr: Horizontal rule produces a separator in output", {
  result <- jsonlite::fromJSON(convert(html = "<p>Above</p><hr><p>Below</p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("semantic_mark_highlight: Mark tag produces highlighted output", {
  result <- jsonlite::fromJSON(convert(html = "<p>This is <mark>highlighted text</mark> in a sentence.</p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("semantic_section_with_heading: Section element with heading preserves structure", {
  result <- jsonlite::fromJSON(convert(html = "<section><h3>Section Heading</h3><p>Section content.</p></section>", options = NULL), simplifyVector = FALSE)
...
test_that("semantic_sub_superscript: Subscript and superscript elements are preserved in output", {
  result <- jsonlite::fromJSON(convert(html = "<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
  expect_true(grepl("H", result$content, fixed = TRUE))
  expect_true(grepl("2", result$content, fixed = TRUE))
  expect_true(grepl("O", result$content, fixed = TRUE))
...
test_that("simple_table: Simple table with header", {
  result <- jsonlite::fromJSON(convert(html = "<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", options = NULL), simplifyVector = FALSE)
  expect_true(grepl("Name", result$content, fixed = TRUE))
...
test_that("table_empty: Empty table produces no output or minimal output", {
  result <- jsonlite::fromJSON(convert(html = "<table></table>", options = NULL), simplifyVector = FALSE)
  expect_equal(trimws(result$content), "")
})

test_that("table_no_thead: Table without thead uses first row as implied header", {
  result <- jsonlite::fromJSON(convert(html = "<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</td><td>1.00</td></tr></table>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("table_pipe_chars_in_content: Table cells containing pipe characters are escaped in output", {
  result <- jsonlite::fromJSON(convert(html = "<table><thead><tr><th>Expression</th><th>Result</th></tr></thead><tbody><tr><td>a | b</td><td>true</td></tr></tbody></table>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("table_with_alignment: Table with column alignment attributes", {
  result <- jsonlite::fromJSON(convert(html = "<table><thead><tr><th align=\"left\">Left</th><th align=\"center\">Center</th><th align=\"right\">Right</th></tr></thead><tbody><tr><td>L</td><td>C</td><td>R</td></tr></tbody></table>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("table_with_colspan: Table with colspan attribute in a header cell", {
  result <- jsonlite::fromJSON(convert(html = "<table><thead><tr><th colspan=\"2\">Full Name</th></tr></thead><tbody><tr><td>John</td><td>Doe</td></tr></tbody></table>", options = NULL), simplifyVector = FALSE)
  expect_true(if (is.character(result$content)) nchar(result$content) > 0 else length(result$content) > 0)
...
test_that("unordered_list: Unordered list", {
  result <- jsonlite::fromJSON(convert(html = "<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>", options = NULL), simplifyVector = FALSE)
