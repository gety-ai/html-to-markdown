...
# alef:hash:a3498ad859a1d306d51efccea08188a0b55efc3da58c5c656c9a3b1cd9c3d1bb
...
test_that("structure_code_block: Fenced code block produces Code node", {
  ...
  expect_true(if (is.character(result$document$nodes)) length(result$document$nodes) > 0 && any(nchar(result$document$nodes) > 0) else length(result$document$nodes) > 0)
