...
# alef:hash:3cff9bea4fe5eac5a598035df6d995eb0f9932dd60017f55267693196dde982e
...
test_that("visitor_audio_custom: Visitor replaces audio element with custom output", {
  ...
  result <- convert(html = "<p>Listen to this: <audio src=\"podcast.mp3\" controls></audio></p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_audio_skip: Visitor removes audio elements from output", {
  ...
  result <- convert(html = "<p>Background music:</p><audio src=\"music.ogg\" autoplay></audio><p>Enjoy!</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_button_custom: Visitor replaces button with bracketed text", {
  ...
  result <- convert(html = "<p>Confirm action: <button type=\"submit\">Click me</button> or <button type=\"reset\">Cancel</button></p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_button_skip: Visitor removes all buttons from output", {
  ...
  result <- convert(html = "<p>Actions available: <button>Save</button> <button>Delete</button> <button>Export</button></p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_continue_default: Visitor continue action preserves default conversion", {
  ...
  result <- convert(html = "<p>Hello <strong>World</strong></p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_blockquote: Visitor replaces blockquote with custom format", {
  ...
  result <- convert(html = "<blockquote><p>A wise quote.</p></blockquote>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_emphasis: Visitor replaces emphasis with custom output", {
  ...
  result <- convert(html = "<p>This is <em>important</em> text.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_heading: Visitor replaces heading with custom format", {
  ...
  result <- convert(html = "<h2>Section Title</h2><p>Content below heading.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_image: Visitor replaces image with custom output using template", {
  ...
  result <- convert(html = "<img src=\"banner.png\" alt=\"Banner\">", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_link_format: Visitor reformats links using template interpolation", {
  ...
  result <- convert(html = "<p>Visit <a href=\"https://example.com\">Example</a> for more info.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_link_static: Visitor replaces link with static custom output", {
  ...
  result <- convert(html = "<a href=\"https://example.com\">Click here</a>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_custom_output: Visitor custom action replaces element output", {
  ...
  result <- convert(html = "<h1>Original Heading</h1>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_definition_list_custom: Visitor customizes definition list items", {
  ...
  result <- convert(html = "<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_definition_list_custom_format: Visitor formats definition lists with custom templates", {
  ...
  result <- convert(html = "<dl><dt>Python</dt><dd>A high-level programming language</dd><dt>JavaScript</dt><dd>A scripting language for web browsers</dd></dl>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_definition_list_skip: Visitor skips definition list items from output", {
  ...
  result <- convert(html = "<p>Glossary:</p><dl><dt>Term A</dt><dd>Definition of term A</dd><dt>Term B</dt><dd>Definition of term B</dd></dl><p>End of glossary</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_details_summary_custom: Visitor customizes details/summary disclosure elements", {
  ...
  result <- convert(html = "<details><summary>Click to expand</summary><p>This content is initially hidden.</p><p>But can be revealed by the user.</p></details>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_details_summary_skip: Visitor removes details/summary elements entirely", {
  ...
  result <- convert(html = "<p>Main content here.</p><details><summary>Hidden section</summary><p>Secret details</p></details><p>More main content.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_figure_custom: Visitor customizes figure and figcaption elements", {
  ...
  result <- convert(html = "<article><h1>Article Title</h1><p>Introduction paragraph.</p><figure><img src=\"diagram.png\" alt=\"System architecture diagram\"><figcaption>Figure 1: System Architecture</figcaption></figure><p>Explanation of the figure.</p></article>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_figure_custom_wrap: Visitor wraps figure content with custom formatting", {
  ...
  result <- convert(html = "<section><h2>Gallery</h2><figure><img src=\"photo1.jpg\" alt=\"Photo\"><figcaption>Beautiful sunset</figcaption></figure></section>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_figure_skip: Visitor removes figure elements with their captions", {
  ...
  result <- convert(html = "<p>See the chart below:</p><figure><img src=\"chart.svg\"><figcaption>Revenue Trends 2020-2024</figcaption></figure><p>As shown in the chart above.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_form_custom: Visitor replaces form with custom output", {
  ...
  result <- convert(html = "<div><form action=\"/submit\" method=\"POST\"><label>Name: <input type=\"text\" name=\"name\"></label><button type=\"submit\">Submit</button></form></div>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_form_skip: Visitor skips form elements entirely", {
  ...
  result <- convert(html = "<p>Before form</p><form><input type=\"email\" name=\"email\"></form><p>After form</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_heading_bare_string_preserves_case: Visitor returns rendered heading template as bare string; mixed-case is preserved (regression guard for issue #350)", {
  ...
  result <- convert(html = "<h2>Important Section Title</h2><p>Body.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_horizontal_rule_custom: Visitor replaces horizontal rule with custom output", {
  ...
  result <- convert(html = "<h1>Section A</h1><p>Content A</p><hr><h1>Section B</h1><p>Content B</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_horizontal_rule_skip: Visitor removes all horizontal rules", {
  ...
  result <- convert(html = "<p>Part 1</p><hr><p>Part 2</p><hr><p>Part 3</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_iframe_custom: Visitor replaces embedded iframe with custom text", {
  ...
  result <- convert(html = "<p>Embedded map:</p><iframe src=\"https://maps.example.com/embed\" width=\"400\" height=\"300\"></iframe><p>End of map</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_iframe_skip: Visitor removes embedded iframes", {
  ...
  result <- convert(html = "<h3>Reviews</h3><iframe src=\"https://widget.example.com/reviews\"></iframe><p>See reviews from our partners.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_image_bare_string_preserves_case: Visitor returns bare-string image replacement; mixed-case alt/src preserved (regression guard for issue #350)", {
  ...
  result <- convert(html = "<img src=\"PhotoOne.JPG\" alt=\"Sunset Over Bay\">", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_input_custom: Visitor replaces input with labeled output", {
  ...
  result <- convert(html = "<form><label>Username: <input type=\"text\" name=\"username\" value=\"\"></label><label>Password: <input type=\"password\" name=\"password\"></label></form>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_input_skip: Visitor skips all input elements", {
  ...
  result <- convert(html = "<p>Sign up:</p><input type=\"text\" name=\"email\" placeholder=\"your@email.com\"><input type=\"checkbox\" name=\"agree\"><p>Continue</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_line_break_custom: Visitor replaces line break with custom output", {
  ...
  result <- convert(html = "<p>First line<br>Second line<br>Third line</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_line_break_skip: Visitor removes all line breaks", {
  ...
  result <- convert(html = "<p>Address Line 1<br>Address Line 2<br>Address Line 3</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_link_bare_string_preserves_case: Visitor returns rendered template as a bare string (not a dict) and original mixed-case content is preserved end-to-end (regression guard for issue #350)", {
  ...
  result <- convert(html = "<a href=\"https://old-cdn.com/file.pdf\">Download</a>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_mark_custom: Visitor replaces highlight/mark with custom template", {
  ...
  result <- convert(html = "<p>This is a <mark>highlighted passage</mark> in the text.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_mark_skip: Visitor skips mark elements entirely", {
  ...
  result <- convert(html = "<p>Key insight: <mark>always validate input</mark> for security.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_preserve_html: Visitor preserve_html action includes raw HTML in output", {
  ...
  result <- convert(html = "<div><custom-tag>Custom content</custom-tag></div>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_skip_code_blocks: Visitor skips code blocks from output", {
  ...
  result <- convert(html = "<p>Intro text</p><pre><code>let x = 42;</code></pre><p>Outro text</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_skip_heading: Visitor skip action omits all headings from output", {
  ...
  result <- convert(html = "<h1>Title</h1><p>Body text remains.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_skip_images: Visitor skips all images from output", {
  ...
  result <- convert(html = "<p>Before image</p><img src=\"photo.jpg\" alt=\"A photo\"><p>After image</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_skip_links: Visitor skips all links entirely", {
  ...
  result <- convert(html = "<p>Before <a href=\"https://example.com\">link text</a> after</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_skip_strong: Visitor skips bold/strong elements", {
  ...
  result <- convert(html = "<p>Normal <strong>bold text</strong> normal</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_subscript_custom: Visitor replaces subscript with custom template", {
  ...
  result <- convert(html = "<p>H<sub>2</sub>O is water.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_subscript_skip: Visitor skips subscript elements entirely", {
  ...
  result <- convert(html = "<p>The formula C<sub>12</sub>H<sub>22</sub>O<sub>11</sub> is sugar.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_superscript_custom: Visitor replaces superscript with custom template", {
  ...
  result <- convert(html = "<p>Einstein's E=mc<sup>2</sup> revolutionized physics.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_superscript_skip: Visitor skips superscript from output", {
  ...
  result <- convert(html = "<p>The equation x<sup>3</sup> + y<sup>3</sup> = z<sup>3</sup> has no solutions.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_underline_custom: Visitor replaces underline with custom markup", {
  ...
  result <- convert(html = "<p>This is <u>very important</u> text.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_underline_skip: Visitor skips underline elements from output", {
  ...
  result <- convert(html = "<p>Normal text with <u>underlined part</u> and more text.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_video_custom: Visitor replaces video with custom link", {
  ...
  result <- convert(html = "<p>Watch our tutorial:</p><video src=\"tutorial.mp4\" width=\"320\" height=\"240\" controls></video><p>Great content!</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
...
test_that("visitor_video_skip: Visitor removes video elements entirely", {
  ...
  result <- convert(html = "<h2>Demo</h2><video src=\"demo.webm\"></video><p>See the demo above.</p>", options = ConversionOptions$default(), options = list(visitor = visitor))
