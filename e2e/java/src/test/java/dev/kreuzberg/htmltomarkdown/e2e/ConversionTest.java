...
// alef:hash:d4ca8983a9e54e3f5ca45c062fc514d5f581bfc7d77e9b95216042085ce0b1c2
...
class ConversionTest {
    ...
    void testBlockquoteMultipleParagraphs() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<blockquote><p>First paragraph.</p><p>Second paragraph.</p></blockquote>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testBlockquoteNested() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<blockquote><p>Outer quote.</p><blockquote><p>Inner quote.</p></blockquote></blockquote>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testBlockquoteSimple() throws Exception {
        // Simple blockquote
        var result = HtmlToMarkdownRs.convert("<blockquote><p>Quote text</p></blockquote>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testBlockquoteWithList() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<blockquote><p>Quote intro:</p><ul><li>Point one</li><li>Point two</li></ul></blockquote>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testBoldAndItalic() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><strong><em>both</em></strong></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testBoldStrong() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><strong>bold</strong></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testCodeBlock() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<pre><code class=\"language-python\">print('hello')</code></pre>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testCodeBlockNoLanguage() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<pre><code>plain code here</code></pre>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testCodeInlineInParagraph() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Call the <code>initialize()</code> method first.</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testCodeWithBackticksInContent() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Use <code>`backtick` here</code> carefully.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testEmphasisMarkHighlight() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><mark>highlighted</mark></p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testEmphasisStrikethroughDel() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><del>deleted text</del></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testEmphasisStrikethroughS() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><s>strikethrough</s></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testEmphasisSubscript() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>H<sub>2</sub>O</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testEmphasisSuperscript() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>x<sup>2</sup></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testEmphasisUnderlineU() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><u>underlined</u></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testFormInputElements() throws Exception {
        ...
        var options = MAPPER.readValue("{\"preprocessing\":{\"remove_forms\":false}}", ConversionOptions.class);
    ...
    void testHeadingH1() throws Exception {
        // H1 heading
        var result = HtmlToMarkdownRs.convert("<h1>Heading 1</h1>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testHeadingH2() throws Exception {
        // H2 heading
        var result = HtmlToMarkdownRs.convert("<h2>Heading 2</h2>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testHeadingH3() throws Exception {
        // H3 heading
        var result = HtmlToMarkdownRs.convert("<h3>Heading 3</h3>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testHeadingH4() throws Exception {
        // H4 heading
        var result = HtmlToMarkdownRs.convert("<h4>Heading 4</h4>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testHeadingH5() throws Exception {
        // H5 heading
        var result = HtmlToMarkdownRs.convert("<h5>Heading 5</h5>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testHeadingH6() throws Exception {
        // H6 heading
        var result = HtmlToMarkdownRs.convert("<h6>Heading 6</h6>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testImageFigureFigcaption() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<figure><img src=\"sunset.jpg\" alt=\"A sunset\"><figcaption>Beautiful sunset over the ocean</figcaption></figure>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testImageLinked() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"https://example.com\"><img src=\"icon.png\" alt=\"Icon\"></a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testImageNoAlt() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<img src=\"banner.jpg\">", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testImageSimple() throws Exception {
        // Image with alt text
        var result = HtmlToMarkdownRs.convert("<img src=\"photo.jpg\" alt=\"A photo\">", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testImageWithTitle() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<img src=\"chart.png\" alt=\"Sales chart\" title=\"Q3 Sales\">", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testInlineCode() throws Exception {
        // Inline code
        var result = HtmlToMarkdownRs.convert("<p>Use <code>console.log()</code> to debug</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testItalicEm() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><em>italic</em></p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLineBreakBrTag() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>First line.<br>Second line.</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLineBreakHrTag() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Before rule.</p><hr><p>After rule.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testLineBreakMultipleBr() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Start.<br><br>End.</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkAnchorFragment() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"#section\">Jump to section</a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkEmptyHref() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"\">No destination</a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkImageInside() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"https://example.com\"><img src=\"logo.png\" alt=\"Logo\"></a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkMailto() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"mailto:user@example.com\">Email us</a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkSimple() throws Exception {
        // Simple link
        var result = HtmlToMarkdownRs.convert("<a href=\"https://example.com\">Example</a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkWithBoldText() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"https://example.com\"><strong>Bold link</strong></a>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testLinkWithTitle() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<a href=\"https://example.com\" title=\"Example Site\">Example</a>", MAPPER.readValue("{}", ConversionOptions.class));
        assertTrue(result.content().orElse("").contains("[Example](https://example.com"), "expected to contain: " + "[Example](https://example.com");
    ...
    void testListDefinitionDl() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<dl><dt>Term One</dt><dd>Definition of term one.</dd><dt>Term Two</dt><dd>Definition of term two.</dd></dl>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testListItemMultipleParagraphs() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<ul><li><p>First paragraph in item.</p><p>Second paragraph in item.</p></li><li>Simple item</li></ul>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testListMixedNested() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<ul><li>Item A<ol><li>Sub 1</li><li>Sub 2</li></ol></li><li>Item B</li></ul>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testListNestedOrdered() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<ol><li>Step 1<ol><li>Step 1a</li><li>Step 1b</li></ol></li><li>Step 2</li></ol>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testListNestedUnordered() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<ul><li>Parent A<ul><li>Child A1</li><li>Child A2</li></ul></li><li>Parent B</li></ul>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testListTaskCheckboxes() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<ul><li><input type=\"checkbox\" checked> Done task</li><li><input type=\"checkbox\"> Pending task</li></ul>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testOrderedList() throws Exception {
        // Ordered list
        var result = HtmlToMarkdownRs.convert("<ol><li>First</li><li>Second</li><li>Third</li></ol>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testParagraphMultiple() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>First paragraph.</p><p>Second paragraph.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertTrue(result.content().orElse("").contains("First paragraph."), "expected to contain: " + "First paragraph.");
        assertTrue(result.content().orElse("").contains("Second paragraph."), "expected to contain: " + "Second paragraph.");
    }
    ...
    void testParagraphNestedDivs() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<div><div><p>Nested text</p></div></div>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testParagraphWithInlineFormatting() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>This has <strong>bold</strong>, <em>italic</em>, and a <a href=\"https://example.com\">link</a>.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertTrue(result.content().orElse("").contains("**bold**"), "expected to contain: " + "**bold**");
        assertTrue(result.content().orElse("").contains("*italic*"), "expected to contain: " + "*italic*");
    ...
    void testParagraphWithLineBreaks() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Line one.<br>Line two.<br>Line three.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testSemanticAbbr() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>The <abbr title=\"World Wide Web\">WWW</abbr> is global.</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testSemanticArticle() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<article><h2>Article Title</h2><p>Article body.</p></article>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testSemanticDefinitionList() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testSemanticDetailsSummary() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<details><summary>Click to expand</summary><p>Hidden content here.</p></details>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testSemanticHr() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Above</p><hr><p>Below</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testSemanticMarkHighlight() throws Exception {
        // Mark tag produces highlighted output
        var result = HtmlToMarkdownRs.convert("<p>This is <mark>highlighted text</mark> in a sentence.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testSemanticSectionWithHeading() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<section><h3>Section Heading</h3><p>Section content.</p></section>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testSemanticSubSuperscript() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertTrue(result.content().orElse("").contains("H"), "expected to contain: " + "H");
        assertTrue(result.content().orElse("").contains("2"), "expected to contain: " + "2");
        assertTrue(result.content().orElse("").contains("O"), "expected to contain: " + "O");
    ...
    void testSimpleTable() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", MAPPER.readValue("{}", ConversionOptions.class));
        assertTrue(result.content().orElse("").contains("Name"), "expected to contain: " + "Name");
    ...
    void testTableEmpty() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table></table>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testTableNoThead() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</td><td>1.00</td></tr></table>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testTablePipeCharsInContent() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table><thead><tr><th>Expression</th><th>Result</th></tr></thead><tbody><tr><td>a | b</td><td>true</td></tr></tbody></table>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testTableWithAlignment() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table><thead><tr><th align=\"left\">Left</th><th align=\"center\">Center</th><th align=\"right\">Right</th></tr></thead><tbody><tr><td>L</td><td>C</td><td>R</td></tr></tbody></table>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testTableWithColspan() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table><thead><tr><th colspan=\"2\">Full Name</th></tr></thead><tbody><tr><td>John</td><td>Doe</td></tr></tbody></table>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testUnorderedList() throws Exception {
        // Unordered list
        var result = HtmlToMarkdownRs.convert("<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>", MAPPER.readValue("{}", ConversionOptions.class));
