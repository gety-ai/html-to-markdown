...
// alef:hash:b58b8482a04f43f9f825a4502084ce3e52032cd4b632da9d34deffe79295c4dd
...
class ResultTest {
    ...
    void testResultTablesWithoutStructureFlag() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<table><tr><th>X</th></tr><tr><td>Y</td></tr></table>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertEquals(0, result.tables().size(), "expected exactly 0 elements");
    }
    ...
    void testResultWarningsEmptyForCleanInput() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<h1>Title</h1><p>Clean content with <a href='https://example.com'>a link</a>.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testResultWarningsEmptyForComplexInput() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<article><h1>Article</h1><p>Paragraph with <strong>bold</strong> and <em>italic</em>.</p><table><tr><th>Col</th></tr><tr><td>Val</td></tr></table><ul><li>Item 1</li><li>Item 2</li></ul></article>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertEquals(0, result.warnings().size(), "expected exactly 0 elements");
    }
    ...
    void testResultWarningsEmptyForMalformedHtml() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Unclosed paragraph<div>Mixed nesting</p></div>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertEquals(0, result.warnings().size(), "expected exactly 0 elements");
    }
