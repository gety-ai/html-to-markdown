...
// alef:hash:258467984feefebc92b1cf21ce8990ad20e810d20dff90cda4eb5ec0cdad3eab
...
class VisitorTest {
    ...
    void testVisitorAudioCustom() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<p>Listen to this: <audio src=\"podcast.mp3\" controls></audio></p>", visitor);
    ...
    void testVisitorAudioSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Background music:</p><audio src=\"music.ogg\" autoplay></audio><p>Enjoy!</p>", visitor);
    ...
    void testVisitorButtonCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Confirm action: <button type=\"submit\">Click me</button> or <button type=\"reset\">Cancel</button></p>", visitor);
    ...
    void testVisitorButtonSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Actions available: <button>Save</button> <button>Delete</button> <button>Export</button></p>", visitor);
    ...
    void testVisitorDefinitionListCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", visitor);
    ...
    void testVisitorDefinitionListCustomFormat() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<dl><dt>Python</dt><dd>A high-level programming language</dd><dt>JavaScript</dt><dd>A scripting language for web browsers</dd></dl>", visitor);
    ...
    void testVisitorDefinitionListSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Glossary:</p><dl><dt>Term A</dt><dd>Definition of term A</dd><dt>Term B</dt><dd>Definition of term B</dd></dl><p>End of glossary</p>", visitor);
    ...
    void testVisitorDetailsSummaryCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<details><summary>Click to expand</summary><p>This content is initially hidden.</p><p>But can be revealed by the user.</p></details>", visitor);
    ...
    void testVisitorDetailsSummarySkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Main content here.</p><details><summary>Hidden section</summary><p>Secret details</p></details><p>More main content.</p>", visitor);
    ...
    void testVisitorFigureCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<article><h1>Article Title</h1><p>Introduction paragraph.</p><figure><img src=\"diagram.png\" alt=\"System architecture diagram\"><figcaption>Figure 1: System Architecture</figcaption></figure><p>Explanation of the figure.</p></article>", visitor);
    ...
    void testVisitorFigureCustomWrap() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<section><h2>Gallery</h2><figure><img src=\"photo1.jpg\" alt=\"Photo\"><figcaption>Beautiful sunset</figcaption></figure></section>", visitor);
    ...
    void testVisitorFigureSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>See the chart below:</p><figure><img src=\"chart.svg\"><figcaption>Revenue Trends 2020-2024</figcaption></figure><p>As shown in the chart above.</p>", visitor);
    ...
    void testVisitorFormCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<div><form action=\"/submit\" method=\"POST\"><label>Name: <input type=\"text\" name=\"name\"></label><button type=\"submit\">Submit</button></form></div>", visitor);
    ...
    void testVisitorFormSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Before form</p><form><input type=\"email\" name=\"email\"></form><p>After form</p>", visitor);
    ...
    void testVisitorHorizontalRuleCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<h1>Section A</h1><p>Content A</p><hr><h1>Section B</h1><p>Content B</p>", visitor);
    ...
    void testVisitorHorizontalRuleSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Part 1</p><hr><p>Part 2</p><hr><p>Part 3</p>", visitor);
    ...
    void testVisitorIframeCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Embedded map:</p><iframe src=\"https://maps.example.com/embed\" width=\"400\" height=\"300\"></iframe><p>End of map</p>", visitor);
    ...
    void testVisitorIframeSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<h3>Reviews</h3><iframe src=\"https://widget.example.com/reviews\"></iframe><p>See reviews from our partners.</p>", visitor);
    ...
    void testVisitorInputCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<form><label>Username: <input type=\"text\" name=\"username\" value=\"\"></label><label>Password: <input type=\"password\" name=\"password\"></label></form>", visitor);
    ...
    void testVisitorInputSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Sign up:</p><input type=\"text\" name=\"email\" placeholder=\"your@email.com\"><input type=\"checkbox\" name=\"agree\"><p>Continue</p>", visitor);
    ...
    void testVisitorLineBreakCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>First line<br>Second line<br>Third line</p>", visitor);
    ...
    void testVisitorLineBreakSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Address Line 1<br>Address Line 2<br>Address Line 3</p>", visitor);
    ...
    void testVisitorMarkCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>This is a <mark>highlighted passage</mark> in the text.</p>", visitor);
    ...
    void testVisitorMarkSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Key insight: <mark>always validate input</mark> for security.</p>", visitor);
    ...
    void testVisitorSubscriptCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>H<sub>2</sub>O is water.</p>", visitor);
    ...
    void testVisitorSubscriptSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>The formula C<sub>12</sub>H<sub>22</sub>O<sub>11</sub> is sugar.</p>", visitor);
    ...
    void testVisitorSuperscriptCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Einstein's E=mc<sup>2</sup> revolutionized physics.</p>", visitor);
    ...
    void testVisitorSuperscriptSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>The equation x<sup>3</sup> + y<sup>3</sup> = z<sup>3</sup> has no solutions.</p>", visitor);
    ...
    void testVisitorUnderlineCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>This is <u>very important</u> text.</p>", visitor);
    ...
    void testVisitorUnderlineSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Normal text with <u>underlined part</u> and more text.</p>", visitor);
    ...
    void testVisitorVideoCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<p>Watch our tutorial:</p><video src=\"tutorial.mp4\" width=\"320\" height=\"240\" controls></video><p>Great content!</p>", visitor);
    ...
    void testVisitorVideoSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<h2>Demo</h2><video src=\"demo.webm\"></video><p>See the demo above.</p>", visitor);
