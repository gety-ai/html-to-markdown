...
// alef:hash:ab7340456b64d18c8a4912a6a1b09322b239b05fa0e6ce41a33cccedfe706a63
...
class VisitorTest {
    ...
    void testVisitorAudioCustom() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Listen to this: <audio src=\"podcast.mp3\" controls></audio></p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorAudioSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Background music:</p><audio src=\"music.ogg\" autoplay></audio><p>Enjoy!</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorButtonCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Confirm action: <button type=\"submit\">Click me</button> or <button type=\"reset\">Cancel</button></p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorButtonSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Actions available: <button>Save</button> <button>Delete</button> <button>Export</button></p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorContinueDefault() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Hello <strong>World</strong></p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomBlockquote() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<blockquote><p>A wise quote.</p></blockquote>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomEmphasis() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>This is <em>important</em> text.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomHeading() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<h2>Section Title</h2><p>Content below heading.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomImage() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<img src=\"banner.png\" alt=\"Banner\">", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomLinkFormat() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Visit <a href=\"https://example.com\">Example</a> for more info.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomLinkStatic() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<a href=\"https://example.com\">Click here</a>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorCustomOutput() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<h1>Original Heading</h1>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorDefinitionListCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorDefinitionListCustomFormat() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<dl><dt>Python</dt><dd>A high-level programming language</dd><dt>JavaScript</dt><dd>A scripting language for web browsers</dd></dl>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorDefinitionListSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Glossary:</p><dl><dt>Term A</dt><dd>Definition of term A</dd><dt>Term B</dt><dd>Definition of term B</dd></dl><p>End of glossary</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorDetailsSummaryCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<details><summary>Click to expand</summary><p>This content is initially hidden.</p><p>But can be revealed by the user.</p></details>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorDetailsSummarySkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Main content here.</p><details><summary>Hidden section</summary><p>Secret details</p></details><p>More main content.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorFigureCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<article><h1>Article Title</h1><p>Introduction paragraph.</p><figure><img src=\"diagram.png\" alt=\"System architecture diagram\"><figcaption>Figure 1: System Architecture</figcaption></figure><p>Explanation of the figure.</p></article>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorFigureCustomWrap() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<section><h2>Gallery</h2><figure><img src=\"photo1.jpg\" alt=\"Photo\"><figcaption>Beautiful sunset</figcaption></figure></section>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorFigureSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>See the chart below:</p><figure><img src=\"chart.svg\"><figcaption>Revenue Trends 2020-2024</figcaption></figure><p>As shown in the chart above.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorFormCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<div><form action=\"/submit\" method=\"POST\"><label>Name: <input type=\"text\" name=\"name\"></label><button type=\"submit\">Submit</button></form></div>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorFormSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Before form</p><form><input type=\"email\" name=\"email\"></form><p>After form</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorHorizontalRuleCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<h1>Section A</h1><p>Content A</p><hr><h1>Section B</h1><p>Content B</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorHorizontalRuleSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Part 1</p><hr><p>Part 2</p><hr><p>Part 3</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorIframeCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Embedded map:</p><iframe src=\"https://maps.example.com/embed\" width=\"400\" height=\"300\"></iframe><p>End of map</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorIframeSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<h3>Reviews</h3><iframe src=\"https://widget.example.com/reviews\"></iframe><p>See reviews from our partners.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorInputCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<form><label>Username: <input type=\"text\" name=\"username\" value=\"\"></label><label>Password: <input type=\"password\" name=\"password\"></label></form>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorInputSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Sign up:</p><input type=\"text\" name=\"email\" placeholder=\"your@email.com\"><input type=\"checkbox\" name=\"agree\"><p>Continue</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorLineBreakCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>First line<br>Second line<br>Third line</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorLineBreakSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Address Line 1<br>Address Line 2<br>Address Line 3</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorMarkCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>This is a <mark>highlighted passage</mark> in the text.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorMarkSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Key insight: <mark>always validate input</mark> for security.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorPreserveHtml() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<div><custom-tag>Custom content</custom-tag></div>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSkipAllHeadings() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<h1>Title</h1><p>Body text remains.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSkipCodeBlocks() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Intro text</p><pre><code>let x = 42;</code></pre><p>Outro text</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSkipImages() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Before image</p><img src=\"photo.jpg\" alt=\"A photo\"><p>After image</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSkipLinks() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Before <a href=\"https://example.com\">link text</a> after</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSkipStrong() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Normal <strong>bold text</strong> normal</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSubscriptCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>H<sub>2</sub>O is water.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSubscriptSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>The formula C<sub>12</sub>H<sub>22</sub>O<sub>11</sub> is sugar.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSuperscriptCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Einstein's E=mc<sup>2</sup> revolutionized physics.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorSuperscriptSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>The equation x<sup>3</sup> + y<sup>3</sup> = z<sup>3</sup> has no solutions.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorUnderlineCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>This is <u>very important</u> text.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorUnderlineSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Normal text with <u>underlined part</u> and more text.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorVideoCustom() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<p>Watch our tutorial:</p><video src=\"tutorial.mp4\" width=\"320\" height=\"240\" controls></video><p>Great content!</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorVideoSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<h2>Demo</h2><video src=\"demo.webm\"></video><p>See the demo above.</p>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
