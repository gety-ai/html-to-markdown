...
// alef:hash:472c717469a74cace34353f4a6dc678fd071a3e328859e626d6ae1e8fff9c54b
...
class EdgeCasesTest {
    ...
    void testEmptyHtml() throws Exception {
        // Empty HTML document
        var result = HtmlToMarkdownRs.convert("<html><head></head><body></body></html>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testEncodingCjkCharacters() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>中文内容</p><p>日本語テキスト</p><p>한국어 텍스트</p>", MAPPER.readValue("{}", ConversionOptions.class));
    ...
    void testEncodingHtmlEntities() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>&amp; &lt; &gt; &nbsp; &quot; &apos;</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testEncodingNamedEntities() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Em dash&mdash;used for parenthetical remarks&mdash;is common. Ellipsis&hellip; indicates omission. Non-breaking&nbsp;space.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertTrue(result.content().orElse("").contains("—"), "expected to contain: " + "—");
        assertTrue(result.content().orElse("").contains("…"), "expected to contain: " + "…");
    }
    ...
    void testEncodingNumericEntities() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Copyright: &#169; Trade: &#174; Euro: &#8364; Hex: &#x00A9;</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertTrue(result.content().orElse("").contains("©"), "expected to contain: " + "©");
        assertTrue(result.content().orElse("").contains("®"), "expected to contain: " + "®");
        assertTrue(result.content().orElse("").contains("€"), "expected to contain: " + "€");
    ...
    void testEncodingUnicodeEmoji() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Hello 🌍 World 🚀</p><p>Stars: ⭐ ✨</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
        assertTrue(result.content().orElse("").contains("🌍"), "expected to contain: " + "🌍");
        assertTrue(result.content().orElse("").contains("🚀"), "expected to contain: " + "🚀");
        assertTrue(result.content().orElse("").contains("⭐"), "expected to contain: " + "⭐");
    ...
    void testHtmlCommentsOnly() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<!-- This is a comment --><!-- Another comment -->", MAPPER.readValue("{}", ConversionOptions.class));
        assertEquals("", result.content().orElse("").trim());
    }
    ...
    void testMalformedDeeplyNestedElements() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><p>Deeply nested content</p></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testMalformedMissingBlockClosingTags() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<div><h1>Title<p>First paragraph<p>Second paragraph</div>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testMalformedOverlappingTags() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><b><i>bold and italic</b></i></p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testMalformedUnclosedParagraph() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>This paragraph is never closed", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testScriptTagsOnly() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<html><head><script>alert('xss')</script></head><body><script>document.write('hello')</script></body></html>", MAPPER.readValue("{}", ConversionOptions.class));
        assertEquals("", result.content().orElse("").trim());
    }
    ...
    void testStyleTagsOnly() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<html><head><style>body { color: red; }</style></head><body><style>.foo { margin: 0; }</style></body></html>", MAPPER.readValue("{}", ConversionOptions.class));
        assertEquals("", result.content().orElse("").trim());
    }
    ...
    void testVisitorCustomElementWithNesting() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convertWithVisitor("<div><custom-widget data-value=\"123\"><p>Widget content here</p><span>With nested elements</span></custom-widget></div>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorDeeplyNestedSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<div><p>Outer <em>emphasis <strong>with bold <mark>and highlight</mark></strong></em> text</p></div>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testVisitorElementEndModification() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<blockquote><p>Original quote</p></blockquote>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    }
    ...
    void testVisitorElementStartSkipEntireSubtree() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<div><h1>Title</h1><p>Content</p></div>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    }
    ...
    void testVisitorUnknownTagPreservation() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdownRs.convertWithVisitor("<article><p>Article text</p><x-custom>Custom element with content</x-custom><p>More article text</p></article>", MAPPER.readValue("{}", ConversionOptions.class), visitor);
    ...
    void testXssOnclickHandlerRemoved() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p><a href=\"https://example.com\" onclick=\"alert('xss')\">Click me</a></p><button onmouseover=\"steal_data()\">Hover me</button>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testXssScriptTagStripped() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Safe content.</p><script>alert('xss')</script><p>More safe content.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
    ...
    void testXssSvgNestedScriptStripped() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<p>Before SVG.</p><svg xmlns=\"http://www.w3.org/2000/svg\"><script>alert('svg-xss')</script><text>SVG text</text></svg><p>After SVG.</p>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
