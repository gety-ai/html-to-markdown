...
// alef:hash:90197897a699bbe1d90e42663caf035af3a88ca6dff3444181c7a72bfe290c6e
...
class MetadataTest {
    ...
    void testMetadataMicrodataSchemaBreadcrumb() throws Exception {
        ...
        var options = MAPPER.readValue("{\"extract_metadata\":true,\"preprocessing\":{\"remove_navigation\":false}}", ConversionOptions.class);
    ...
    void testOgBasicTags() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<html><head><title>Fallback Title</title><meta property=\"og:title\" content=\"OG Title\"><meta property=\"og:description\" content=\"OG description text.\"><meta property=\"og:image\" content=\"https://example.com/image.jpg\"></head><body><p>Content</p></body></html>", MAPPER.readValue("{}", ConversionOptions.class));
        assertFalse(result.content().isEmpty(), "expected non-empty value");
