...
// alef:hash:43b8c51bed0a4a8fe6f6850343d5ecdfba592b8104254804d2d1b65fc5654519
...
class OptionsTest {
    ...
    void testOptionsMaxDepthDefaultUnlimited() throws Exception {
        ...
        var result = HtmlToMarkdownRs.convert("<div><div><div><div><p>Deep content</p></div></div></div></div>", MAPPER.readValue("{}", ConversionOptions.class));
