...
// alef:hash:587b5745d7207d77603df35176d66336945a5576a16f48b20c1f36c8371237cc
...
test "metadata_author_meta" {
    ...
    try testing.expectEqualStrings("Jane Doe", result.object.get("metadata").?.object.get("document").?.object.get("author").?.string);
}
...
test "metadata_canonical_url" {
    ...
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expectEqualStrings("https://example.com/canonical-page", result.object.get("metadata").?.object.get("document").?.object.get("canonical_url").?.string);
}
...
test "metadata_description_meta" {
    ...
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expectEqualStrings("This is the page description.", result.object.get("metadata").?.object.get("document").?.object.get("description").?.string);
}
...
test "metadata_extract_all_images" {
    ...
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expect(result.object.get("metadata").?.object.get("images").?.array.items.len >= 2);
}
...
test "metadata_headers_hierarchy" {
    ...
    const _result_json = try html_to_markdown.convert("<html><head><title>Docs</title></head><body><h1>Introduction</h1><h2>Getting Started</h2><h3>Installation</h3><h3>Configuration</h3><h2>Advanced Usage</h2><h3>Custom Options</h3></body></html>", "{\"extract_metadata\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expect(result.object.get("metadata").?.object.get("headers").?.array.items.len >= 5);
}
...
test "metadata_keywords_meta" {
    ...
    const _result_json = try html_to_markdown.convert("<html><head><title>Page</title><meta name=\"keywords\" content=\"rust, markdown, html, converter\"></head><body><p>Content</p></body></html>", "{\"extract_metadata\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expect(result.object.get("metadata").?.object.get("document").?.object.get("keywords").?.array.items.len >= 1);
}
...
test "metadata_microdata_schema_person" {
    ...
    const _result_json = try html_to_markdown.convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>", "{\"extract_metadata\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "metadata_title_tag" {
    ...
    const _result_json = try html_to_markdown.convert("<html><head><title>My Page</title></head><body><p>Content</p></body></html>", "{\"extract_metadata\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expectEqualStrings("My Page", result.object.get("metadata").?.object.get("document").?.object.get("title").?.string);
}
...
test "og_basic_tags" {
    ...
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expectEqualStrings("OG Title", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[title]").?.string);
    try testing.expectEqualStrings("OG description text.", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[description]").?.string);
    try testing.expectEqualStrings("https://example.com/image.jpg", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[image]").?.string);
}
...
test "og_multiple_tags" {
    ...
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expectEqualStrings("Article Title", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[title]").?.string);
    try testing.expectEqualStrings("article", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[type]").?.string);
    try testing.expectEqualStrings("https://example.com/article", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[url]").?.string);
    try testing.expectEqualStrings("Example Site", result.object.get("metadata").?.object.get("document").?.object.get("open_graph[site_name]").?.string);
}
...
test "twitter_card_tags" {
    ...
    const result = &_parsed.value;
    try testing.expect(result.object.get("content").? != .null);
    try testing.expectEqualStrings("summary_large_image", result.object.get("metadata").?.object.get("document").?.object.get("twitter_card[card]").?.string);
    try testing.expectEqualStrings("Twitter Card Title", result.object.get("metadata").?.object.get("document").?.object.get("twitter_card[title]").?.string);
    try testing.expectEqualStrings("Twitter card description.", result.object.get("metadata").?.object.get("document").?.object.get("twitter_card[description]").?.string);
}
