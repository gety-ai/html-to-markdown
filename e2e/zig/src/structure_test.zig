...
// alef:hash:6d750eb9732e0debf3de5c5d95c83cbeb42d1a54a3ace65c20878eed683c3ab6
...
test "structure_deep_nesting_h1_h2_h3" {
    ...
    const _result_json = try html_to_markdown.convert("<h1>Top Level</h1><p>Top intro.</p><h2>Mid Level</h2><p>Mid content.</p><h3>Deep Level</h3><p>Deep content.</p>", "{\"include_document_structure\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
