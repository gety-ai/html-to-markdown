...
pub fn build(b: *std.Build) void {
    ...
    edge_cases_run.step.dependOn(&conversion_run.step);
    ...
    metadata_run.step.dependOn(&edge_cases_run.step);
    ...
    options_run.step.dependOn(&metadata_run.step);
    ...
    real_world_run.step.dependOn(&options_run.step);
    ...
    result_run.step.dependOn(&real_world_run.step);
    ...
    structure_run.step.dependOn(&smoke_run.step);
    ...
    visitor_run.step.dependOn(&structure_run.step);
