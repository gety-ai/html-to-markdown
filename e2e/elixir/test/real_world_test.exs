...
defmodule E2e.RealWorldTest do
  ...
  describe "real_world_blog_post" do
    test "real_world_blog_post" do
      ...
      assert String.contains?(to_string(result.content), "\# Getting Started with Rust")
      assert String.contains?(to_string(result.content), "\#\# Installation")
      assert String.contains?(to_string(result.content), "\#\# Hello World")
      assert String.contains?(to_string(result.content), "\#\# Key Concepts")
      assert String.contains?(to_string(result.content), "cargo run")
      assert String.contains?(to_string(result.content), "[Mozilla](https://www.mozilla.org)")
      assert String.contains?(to_string(result.content), "- Ownership and borrowing")
    end
  end
  ...
  describe "real_world_documentation_page" do
    test "real_world_documentation_page" do
      ...
      assert result.content != ""
      assert String.contains?(to_string(result.content), "\# API Reference")
      assert String.contains?(to_string(result.content), "\#\# convert_html")
      assert String.contains?(to_string(result.content), "\#\#\# Parameters")
      assert String.contains?(to_string(result.content), "\#\#\# Returns")
      assert String.contains?(to_string(result.content), "\#\#\# Example")
      assert String.contains?(to_string(result.content), "\#\# ConversionOptions")
      assert String.contains?(to_string(result.content), "> ")
      assert String.contains?(to_string(result.content), "thread-safe")
      assert String.contains?(to_string(result.content), "convert_html")
      assert String.contains?(to_string(result.content), "ConversionOptions")
    end
  end
  ...
  describe "real_world_product_page" do
    test "real_world_product_page" do
      ...
      assert result.content != ""
      assert String.contains?(to_string(result.content), "\# Wireless Keyboard Pro")
      assert String.contains?(to_string(result.content), "![Wireless Keyboard Pro](https://example.com/keyboard.jpg)")
      assert String.contains?(to_string(result.content), "\#\# Specifications")
      assert String.contains?(to_string(result.content), "Battery Life")
      assert String.contains?(to_string(result.content), "12 months")
      assert String.contains?(to_string(result.content), "Bluetooth 5.0")
      assert String.contains?(to_string(result.content), "\#\# What's in the Box")
      assert String.contains?(to_string(result.content), "USB-C charging cable")
      assert String.contains?(to_string(result.content), "|")
      assert String.contains?(to_string(result.content), "---")
    end
  end
