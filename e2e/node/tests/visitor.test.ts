...
describe("visitor", () => {
  ...
  it("visitor_audio_skip: Visitor removes audio elements from output", () => {
    ...
    const result = convert('<p>Background music:</p><audio src="music.ogg" autoplay></audio><p>Enjoy!</p>', {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_custom_link_format: Visitor reformats links using template interpolation", () => {
    ...
    const result = convert('<p>Visit <a href="https://example.com">Example</a> for more info.</p>', {
      visitor: _testVisitor as any,
    });
...
`,
  ...
  it("visitor_form_skip: Visitor skips form elements entirely", () => {
    ...
    const result = convert('<p>Before form</p><form><input type="email" name="email"></form><p>After form</p>', {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_horizontal_rule_custom: Visitor replaces horizontal rule with custom output", () => {
    ...
    const result = convert("<h1>Section A</h1><p>Content A</p><hr><h1>Section B</h1><p>Content B</p>", {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_skip_code_blocks: Visitor skips code blocks from output", () => {
    ...
    const result = convert("<p>Intro text</p><pre><code>let x = 42;</code></pre><p>Outro text</p>", {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_skip_images: Visitor skips all images from output", () => {
    ...
    const result = convert('<p>Before image</p><img src="photo.jpg" alt="A photo"><p>After image</p>', {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_subscript_skip: Visitor skips subscript elements entirely", () => {
    ...
    const result = convert("<p>The formula C<sub>12</sub>H<sub>22</sub>O<sub>11</sub> is sugar.</p>", {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_superscript_skip: Visitor skips superscript from output", () => {
    ...
    const result = convert("<p>The equation x<sup>3</sup> + y<sup>3</sup> = z<sup>3</sup> has no solutions.</p>", {
      visitor: _testVisitor as any,
    });
  ...
  it("visitor_video_skip: Visitor removes video elements entirely", () => {
    ...
    const result = convert('<h2>Demo</h2><video src="demo.webm"></video><p>See the demo above.</p>', {
      visitor: _testVisitor as any,
    });
