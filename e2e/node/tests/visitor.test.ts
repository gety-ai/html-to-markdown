...
// alef:hash:dab250d6a964b2c098d1822f14aaab561ae7a873af0b7d363e0dd011f7324aa3
...
describe("visitor", () => {
  ...
  it("visitor_continue_default: Visitor continue action preserves default conversion", () => {
    ...
    const result = convert("<p>Hello <strong>World</strong></p>", {} as ConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_emphasis: Visitor replaces emphasis with custom output", () => {
    ...
    const result = convert("<p>This is <em>important</em> text.</p>", {} as ConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_image: Visitor replaces image with custom output using template", () => {
    ...
    const result = convert('<img src="banner.png" alt="Banner">', {} as ConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_output: Visitor custom action replaces element output", () => {
    ...
    const result = convert("<h1>Original Heading</h1>", {} as ConversionOptions, {
      visitor: _testVisitor,
    });
...
`,
  ...
  it("visitor_skip_all_headings: Visitor skips all headings from document", () => {
    ...
    const result = convert("<h1>Title</h1><p>Body text remains.</p>", {} as ConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_subscript_custom: Visitor replaces subscript with custom template", () => {
    ...
    const result = convert("<p>H<sub>2</sub>O is water.</p>", {} as ConversionOptions, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_underline_custom: Visitor replaces underline with custom markup", () => {
    ...
    const result = convert("<p>This is <u>very important</u> text.</p>", {} as ConversionOptions, {
      visitor: _testVisitor,
    });
