...
describe("metadata", () => {
	...
	it("metadata_author_meta: Extract author from <meta name='author'> tag", () => {
		const result = convert("<html><head><title>Page</title><meta name=\"author\" content=\"Jane Doe\"></head><body><p>Content</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
	...
	it("metadata_canonical_url: Extract canonical URL from <link rel='canonical'> tag", () => {
		const result = convert("<html><head><title>Page</title><link rel=\"canonical\" href=\"https://example.com/canonical-page\"></head><body><p>Content</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_description_meta: Extract description from <meta name='description'> tag", () => {
		const result = convert("<html><head><title>Page</title><meta name=\"description\" content=\"This is the page description.\"></head><body><p>Content</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_extract_all_images: Extract all images from a document into metadata", () => {
		const result = convert("<html><head><title>Gallery</title></head><body><img src=\"https://example.com/photo1.jpg\" alt=\"Photo 1\"><img src=\"https://example.com/photo2.png\" alt=\"Photo 2\"><img src=\"/local/image.webp\" alt=\"Local image\"></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_extract_all_links: Extract all links from a document into metadata", () => {
		const result = convert("<html><head><title>Links Page</title></head><body><p>Visit <a href=\"https://example.com\">Example</a> or <a href=\"https://docs.example.com\">Docs</a>.</p><p>Also see <a href=\"/relative/path\">relative link</a> and <a href=\"mailto:hello@example.com\">email us</a>.</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_headers_hierarchy: Extract heading hierarchy from document into metadata", () => {
		const result = convert("<html><head><title>Docs</title></head><body><h1>Introduction</h1><h2>Getting Started</h2><h3>Installation</h3><h3>Configuration</h3><h2>Advanced Usage</h2><h3>Custom Options</h3></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_image_type_data_uri_classified: A data-URI image is extracted into metadata.images when extract_metadata is true", () => {
		const result = convert("<p><img src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==\" alt=\"pixel\"></p>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_image_type_external_classified: An https image URL is extracted into metadata.images when extract_metadata is true", () => {
		const result = convert("<p><img src=\"https://example.com/photo.jpg\" alt=\"A photo\"></p>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_keywords_meta: Extract keywords from <meta name='keywords'> tag", () => {
		const result = convert("<html><head><title>Page</title><meta name=\"keywords\" content=\"rust, markdown, html, converter\"></head><body><p>Content</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_lang_attribute: Extract language from html lang attribute", () => {
		const result = convert("<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_link_type_anchor_classified: A fragment anchor link is extracted into metadata.links when extract_metadata is true", () => {
		const result = convert("<p>Jump to <a href=\"#section\">section</a> below.</p>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_link_type_email_classified: A mailto link is extracted into metadata.links when extract_metadata is true", () => {
		const result = convert("<p>Contact <a href=\"mailto:hello@example.com\">us</a> directly.</p>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_link_type_external_classified: An https link is extracted into metadata.links when extract_metadata is true", () => {
		const result = convert("<p>See <a href=\"https://example.com\">Example</a> for details.</p>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_microdata_schema_organization: Extract schema.org microdata for Organization", () => {
		const result = convert("<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_microdata_schema_person: Extract schema.org microdata for Person", () => {
		const result = convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_text_direction_ltr: Extract text direction from lang attribute on html element", () => {
		const result = convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_text_direction_rtl: Extract right-to-left text direction", () => {
		const result = convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
	...
	it("metadata_title_tag: Extract title from <title> tag", () => {
		const result = convert("<html><head><title>My Page</title></head><body><p>Content</p></body></html>", { extractMetadata: true } as ConversionOptions);
    {
        const _v = result.content;
        if (typeof _v === "string" || Array.isArray(_v)) {
            expect(_v.length).toBeGreaterThan(0);
