...
namespace HtmlToMarkdown
{
    ...
    Assert.Equal("", result.Content!.Trim());
        ...
        public void Test_VisitorCustomElementWithNesting()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<div><custom-widget data-value=\"123\"><p>Widget content here</p><span>With nested elements</span></custom-widget></div>", new ConversionOptions(), options);
    ...
    Assert.DoesNotContain("Widget content here", result.Content.ToString());
        ...
        public void Test_VisitorDeeplyNestedSkip()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<div><p>Outer <em>emphasis <strong>with bold <mark>and highlight</mark></strong></em> text</p></div>", new ConversionOptions(), options);
    ...
    Assert.DoesNotContain("highlight", result.Content.ToString());
        ...
        public void Test_VisitorElementEndModification()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<blockquote><p>Original quote</p></blockquote>", new ConversionOptions(), options);
    Assert.False(string.IsNullOrEmpty(result.Content?.ToString()));
        ...
        public void Test_VisitorElementStartSkipEntireSubtree()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<div><h1>Title</h1><p>Content</p></div>", new ConversionOptions(), options);
    ...
    Assert.DoesNotContain("Content", result.Content.ToString());
        ...
        public void Test_VisitorUnknownTagPreservation()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<article><p>Article text</p><x-custom>Custom element with content</x-custom><p>More article text</p></article>", new ConversionOptions(), options);
