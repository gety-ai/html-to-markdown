...
namespace HtmlToMarkdown
{
    ...
    Assert.Contains("text.", result.Content.ToString().ToLower());
        ...
        public void Test_OptionsPreprocessingAggressive()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<nav>Menu</nav><article><h1>Title</h1><p>Content</p></article><aside>Sidebar</aside><footer>Footer</footer>", new ConversionOptions { Preprocessing = JsonSerializer.Deserialize<PreprocessingOptions>("{\"preset\":\"Aggressive\"}", ConfigOptions)! });
    Assert.Contains("title", result.Content.ToString().ToLower());
    Assert.Contains("content", result.Content.ToString().ToLower());
    Assert.DoesNotContain("Menu", result.Content.ToString());
        ...
        public void Test_OptionsPreprocessingEnabledFalseSkipsCleanup()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<nav>NavSection</nav><p>Paragraph</p>", new ConversionOptions { Preprocessing = JsonSerializer.Deserialize<PreprocessingOptions>("{\"enabled\":false}", ConfigOptions)! });
    ...
    Assert.Contains("paragraph", result.Content.ToString().ToLower());
        ...
        public void Test_OptionsPreprocessingMinimal()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<nav>Navigation</nav><p>Content</p><footer>Footer</footer>", new ConversionOptions { Preprocessing = JsonSerializer.Deserialize<PreprocessingOptions>("{\"preset\":\"Minimal\"}", ConfigOptions)! });
    ...
    Assert.Contains("footer", result.Content.ToString().ToLower());
        ...
        public void Test_OptionsPreprocessingRemoveForms()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<p>Before</p><form><input type='text'/><button>Submit</button></form><p>After</p>", new ConversionOptions { Preprocessing = JsonSerializer.Deserialize<PreprocessingOptions>("{\"remove_forms\":true}", ConfigOptions)! });
    Assert.Contains("before", result.Content.ToString().ToLower());
    Assert.Contains("after", result.Content.ToString().ToLower());
    Assert.DoesNotContain("Submit", result.Content.ToString());
        ...
        public void Test_OptionsPreprocessingRemoveNavigationFalseKeepsNav()
        {
            ...
            var result = HtmlToMarkdownConverter.Convert("<nav>SiteMenu</nav><main><p>MainContent</p></main><aside>SidebarText</aside>", new ConversionOptions { Preprocessing = JsonSerializer.Deserialize<PreprocessingOptions>("{\"remove_navigation\":false}", ConfigOptions)! });
