...
// alef:hash:0c3f357d52dc4795293b98e524a2c80f0a27caacbe1c15a758bd565b763ec755
...
func Test_MetadataDublinCore(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `scholarly article`) {
...
func Test_MetadataLangAttribute(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `Hola Mundo`) {
...
func Test_MetadataMicrodataSchemaArticle(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `Breaking News Today`) {
		t.Errorf("expected to contain %s, got %v", `Breaking News Today`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `Jane Reporter`) {
		t.Errorf("expected to contain %s, got %v", `Jane Reporter`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `important information`) {
...
func Test_MetadataMicrodataSchemaBreadcrumb(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `Home`) {
		t.Errorf("expected to contain %s, got %v", `Home`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `Products`) {
		t.Errorf("expected to contain %s, got %v", `Products`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `Current Page`) {
...
func Test_MetadataMicrodataSchemaOrganization(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `Acme Corp`) {
		t.Errorf("expected to contain %s, got %v", `Acme Corp`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `2020`) {
...
func Test_MetadataMicrodataSchemaPerson(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `John Smith`) {
		t.Errorf("expected to contain %s, got %v", `John Smith`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `john@example.com`) {
...
func Test_MetadataMicrodataSchemaProduct(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `Awesome Widget`) {
		t.Errorf("expected to contain %s, got %v", `Awesome Widget`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `best widget`) {
		t.Errorf("expected to contain %s, got %v", `best widget`, content)
	}
	if !strings.Contains(fmt.Sprint(content), `29.99`) {
...
func Test_MetadataTextDirectionLtr(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `left-to-right text`) {
...
func Test_MetadataTextDirectionRtl(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(content), `right-to-left text`) {
...
func Test_StructuredDataJsonLd(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `My Article`) {
...
func Test_StructuredDataMultipleJsonLd(t *testing.T) {
	...
	if result.Content != nil {
		if !strings.Contains(fmt.Sprint(*result.Content), `Widget`) {
