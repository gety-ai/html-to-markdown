...
// alef:hash:e492a005107fe38db13d191af1323e482acb0eaf6a8593a1b3e04985eae3fc7c
...
func Test_VisitorIframeCustom(t *testing.T) {
	...
	if !strings.Contains(func() string {
		...
		return string(b)
	}(), `[EMBEDDED: https://maps.example.com/embed]`) {
...
func Test_VisitorSuperscriptSkip(t *testing.T) {
	...
	if !strings.Contains(func() string {
		...
		return string(b)
	}(), `The equation x + y = z has no solutions.`) {
