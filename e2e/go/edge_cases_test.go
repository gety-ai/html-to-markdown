...
func (v *testVisitorVisitorElementEndModification) VisitElementEnd(ctx htmd.NodeContext, output string) htmd.VisitResult {
	panic("go visitor fixture 'visit_element_end' requires explicit e2e result-action metadata for result type 'VisitResult'")
}
...
func (v *testVisitorVisitorElementStartSkipEntireSubtree) VisitElementStart(ctx htmd.NodeContext) htmd.VisitResult {
	panic("go visitor fixture 'visit_element_start' requires explicit e2e result-action metadata for result type 'VisitResult'")
}
