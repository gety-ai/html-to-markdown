...
// alef:hash:f6d2f32657b81df65f2ecdbd61b62479adafa837186e89f5bec15eb9d67979f0
...
void test_real_world_blog_post(void) {
    ...
    assert(content != NULL && strstr(content, "# Getting Started with Rust") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## Installation") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## Hello World") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## Key Concepts") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "cargo run") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "[Mozilla](https://www.mozilla.org)") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "- Ownership and borrowing") != NULL &&
           "expected to contain substring");
...
void test_real_world_documentation_page(void) {
    ...
    char *content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "# API Reference") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## convert_html") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "### Parameters") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "### Returns") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "### Example") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## ConversionOptions") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "> ") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "thread-safe") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "convert_html") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "ConversionOptions") != NULL &&
...
void test_real_world_product_page(void) {
    ...
    char *content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "# Wireless Keyboard Pro") != NULL &&
           "expected to contain substring");
    assert(content != NULL &&
           strstr(content, "![Wireless Keyboard Pro](https://example.com/keyboard.jpg)") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## Specifications") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "Battery Life") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "12 months") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "Bluetooth 5.0") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "## What's in the Box") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "USB-C charging cable") != NULL &&
           "expected to contain substring");
    assert(content != NULL && strstr(content, "|") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "---") != NULL && "expected to contain substring");
    htm_free_string(content);
