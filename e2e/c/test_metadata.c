...
// alef:hash:b4243a990f03de955499a82080270a4586792ea83fae1597a07c3ca75e624d25
...
void test_metadata_lang_attribute(void) {
    ...
    HTMConversionResult* result = htm_convert("<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_microdata_schema_organization(void) {
    ...
    HTMConversionResult* result = htm_convert("<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_microdata_schema_person(void) {
    ...
    HTMConversionResult* result = htm_convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_text_direction_ltr(void) {
    ...
    HTMConversionResult* result = htm_convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_text_direction_rtl(void) {
    ...
    HTMConversionResult* result = htm_convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
