...
void test_options_autolinks_false(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "example.com") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_capture_svg_false(void) {
    ...
    assert(content != NULL && strstr(content, "Below SVG") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_code_block_backticks(void) {
    ...
    assert(content != NULL && strstr(content, "console.log('hi');") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_code_block_indented(void) {
    ...
    HTMConversionResult* result = htm_convert("<pre><code>print('hello')</code></pre>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "print('hello')") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "```") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_code_block_tildes(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "~~~") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "let x = 1;") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_code_block_tildes_style(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "~~~") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "some code") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_code_language_python(void) {
    ...
    HTMConversionResult* result = htm_convert("<pre><code>def hello(): pass</code></pre>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "```python") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "def hello") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_compact_tables_false(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"compact_tables\":false}");
...
void test_options_compact_tables_true(void) {
    ...
    assert((content == NULL || strstr(content, "| ----- |") == NULL) && "expected NOT to contain substring");
    assert(content != NULL && strstr(content, "| 42 |") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "| 42    |") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_debug_true(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Debug test") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_escape_ascii_enabled(void) {
    ...
    HTMConversionResult* result = htm_convert("<p>Text with # hash and [brackets] and * star</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    ...
    assert(content != NULL && strstr(content, "brackets") != NULL && "expected to contain substring");
...
void test_options_escape_misc(void) {
    ...
    assert(content != NULL && strstr(content, "in text.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_escape_underscores(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "variable") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "name") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "defined.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_attribute(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Primary text") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Sidebar") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_class(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Main content") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "cookies") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_empty_noop(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Hello world") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_id(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Article text") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Buy stuff") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_multiple(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Content") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Menu") == NULL) && "expected NOT to contain substring");
    assert((content == NULL || strstr(content, "Footer") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_nested_content_dropped(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Main text") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Related") == NULL) && "expected NOT to contain substring");
    assert((content == NULL || strstr(content, "Sidebar text") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_plain_text_mode(void) {
    ...
    HTMConversionResult* result = htm_convert("<body><div class=\"nav\">Navigation</div><p>Article body</p></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Article body") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Navigation") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_exclude_selectors_vs_strip_tags(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Outer text") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Inner paragraph") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_extract_images_false(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"extract_images\":false}");
    HTMConversionResult* result = htm_convert("<p>Text with <img src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==\" alt=\"pixel\"> image.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    htm_free_string(content);
...
void test_options_extract_metadata_true(void) {
    ...
    HTMConversionResult* result = htm_convert("<html><head><title>Test Page</title><meta name='description' content='A test page'></head><body><p>Content</p></body></html>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
...
void test_options_heading_style_atx(void) {
    ...
    assert(content != NULL && strstr(content, "## Subtitle") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_heading_style_atx_closed(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "# Closed Heading #") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_heading_style_underlined(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "Main Title") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_highlight_none(void) {
    ...
    HTMConversionResult* result = htm_convert("<p>Text with <mark>plain</mark> content.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
...
void test_options_include_document_structure_false(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":false}");
    HTMConversionResult* result = htm_convert("<article><h1>Heading</h1><p>Paragraph body.</p></article>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "Heading") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_infer_dimensions_false(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "No dims") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_infer_dimensions_true(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"extract_images\":true,\"infer_dimensions\":true}");
    HTMConversionResult* result = htm_convert("<p>With dims: <img src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==\" alt=\"pixel\"></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "With dims") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_keep_inline_images_in_paragraph(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Text") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "more text") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_link_style_reference(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Example") != NULL && "expected to contain substring");
...
void test_options_list_custom_bullets(void) {
    ...
    assert(content != NULL && strstr(content, "* Item B") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_max_depth_default_unlimited(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Deep content") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_options_max_depth_truncates(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Shallow") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Too deep") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_max_image_size_generous_limit(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"extract_images\":true,\"max_image_size\":10485760}");
    HTMConversionResult* result = htm_convert("<p>Image: <img src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==\" alt=\"pixel\"></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_options_max_image_size_tiny_limit_safe(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "Tiny limit") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_output_format_djot(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "Simple paragraph.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_output_format_markdown(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "# Title") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "Some text.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_preprocessing_enabled_false_skips_cleanup(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"preprocessing\":{\"enabled\":false}}");
    HTMConversionResult* result = htm_convert("<nav>NavSection</nav><p>Paragraph</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "NavSection") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "Paragraph") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_preprocessing_minimal(void) {
    ...
    HTMConversionResult* result = htm_convert("<nav>Navigation</nav><p>Content</p><footer>Footer</footer>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Navigation") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "Content") != NULL && "expected to contain substring");
...
void test_options_preprocessing_remove_forms(void) {
    ...
    assert(content != NULL && strstr(content, "Before") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "After") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "Submit") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_preprocessing_remove_navigation_false_keeps_nav(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "SiteMenu") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "MainContent") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "SidebarText") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_preserve_tags_iframe(void) {
    ...
    assert(content != NULL && strstr(content, "Before") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "After") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "<iframe") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_skip_images_true(void) {
    ...
    assert(content != NULL && strstr(content, "Before") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "After") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "photo") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_strip_tags_div_span(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "Inside div") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "span text") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_strong_em_underscore(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "__bold__") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "_italic_") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_url_escape_style_angle_default(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "</file (1).pdf>") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_url_escape_style_percent_angle_brackets_in_url(void) {
    ...
    HTMConversionResult* result = htm_convert("<a href=\"/file (1) <draft>.pdf\">file</a>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "/file%20%281%29%20%3Cdraft%3E.pdf") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_url_escape_style_percent_image(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "/img%20%281%29%20%3Cdraft%3E.png") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_url_escape_style_percent_link(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "/file%20%281%29.pdf") != NULL && "expected to contain substring");
    assert((content == NULL || strstr(content, "</") == NULL) && "expected NOT to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
...
void test_options_whitespace_normalized(void) {
    ...
    assert(content != NULL && strstr(content, "spaces.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_whitespace_strict(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "Preserved") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "spacing.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_wrap_disabled(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "This is a long paragraph that should not be wrapped at all because wrapping is disabled.") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
...
void test_options_wrap_enabled(void) {
    ...
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    assert(content != NULL && strstr(content, "This is a long paragraph") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
