...
static int32_t c_visitor_visitor_custom_heading_visit_heading(const HTMHtmContext* _ctx, void* _user_data, uint32_t _level, const char* _text, const char* _id, char** out_custom, size_t* out_len) {
    (void)_ctx;
    (void)_user_data;
    (void)_level;
    (void)_id;
...
static int32_t c_visitor_visitor_iframe_skip_visit_iframe(const HTMHtmContext* _ctx, void* _user_data, const char* _src, char** out_custom, size_t* out_len) {
    (void)_ctx;
    (void)_user_data;
    (void)out_custom;
    (void)out_len;
