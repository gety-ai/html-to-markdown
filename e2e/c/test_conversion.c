...
void test_semantic_sub_superscript(void) {
    ...
    assert(content != NULL && strstr(content, "2") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "O") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "E=mc") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
...
void test_simple_table(void) {
    ...
    assert(content != NULL && strstr(content, "30") != NULL && "expected to contain substring");
...
void test_table_with_alignment(void) {
    ...
    assert(content != NULL && strstr(content, "Right") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "L") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "C") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "R") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "|") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_result_free(result);
}
