...
from html_to_markdown import convert, ConversionOptions, CodeBlockStyle, HeadingStyle, HighlightStyle, LinkStyle, ListIndentType, NewlineStyle, OutputFormat, UrlEscapeStyle, WhitespaceMode
...
def test_options_capture_svg_false() -> None:
    ...
    assert result.content is not None  # noqa: S101
    assert "Below SVG" in result.content  # noqa: S101
...
def test_options_infer_dimensions_false() -> None:
    ...
    assert result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "No dims" in result.content  # noqa: S101
...
def test_options_infer_dimensions_true() -> None:
    ...
    assert result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "With dims" in result.content  # noqa: S101
...
def test_options_max_image_size_generous_limit() -> None:
    ...
    assert result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "Image" in result.content  # noqa: S101
...
def test_options_max_image_size_tiny_limit_safe() -> None:
    ...
    assert result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "Tiny limit" in result.content  # noqa: S101
...
def test_options_preprocessing_enabled_false_skips_cleanup() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None  # noqa: S101
    assert "NavSection" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "Paragraph" in result.content  # noqa: S101
...
def test_options_preprocessing_remove_navigation_false_keeps_nav() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None  # noqa: S101
    assert "SiteMenu" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "MainContent" in result.content  # noqa: S101
    assert result.content is not None  # noqa: S101
    assert "SidebarText" in result.content  # noqa: S101
...
def test_options_url_escape_style_angle_default() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None  # noqa: S101
    assert "</file (1).pdf>" in result.content  # noqa: S101
...
def test_options_url_escape_style_percent_angle_brackets_in_url() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None  # noqa: S101
    assert "/file%20%281%29%20%3Cdraft%3E.pdf" in result.content  # noqa: S101
...
def test_options_url_escape_style_percent_image() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None  # noqa: S101
    assert "/img%20%281%29%20%3Cdraft%3E.png" in result.content  # noqa: S101
...
def test_options_wrap_disabled() -> None:
    ...
    result = convert(html, options)
    assert result.content is not None  # noqa: S101
    assert "This is a long paragraph that should not be wrapped at all because wrapping is disabled." in result.content  # noqa: S101
