...
def test_metadata_canonical_url() -> None:
    ...
    result = convert(html, options)
    assert result.content  # noqa: S101
    assert result.metadata.document.canonical_url.strip() == "https://example.com/canonical-page"  # noqa: S101
...
def test_metadata_description_meta() -> None:
    ...
    result = convert(html, options)
    assert result.content  # noqa: S101
    assert result.metadata.document.description.strip() == "This is the page description."  # noqa: S101
...
def test_og_basic_tags() -> None:
    ...
    assert result.metadata.document.open_graph.get("description").strip() == "OG description text."  # noqa: S101
    assert result.metadata.document.open_graph.get("image").strip() == "https://example.com/image.jpg"  # noqa: S101
...
def test_og_multiple_tags() -> None:
    ...
    assert result.metadata.document.open_graph.get("url").strip() == "https://example.com/article"  # noqa: S101
    assert result.metadata.document.open_graph.get("site_name").strip() == "Example Site"  # noqa: S101
...
def test_twitter_card_tags() -> None:
    ...
    result = convert(html, None)
    assert result.content  # noqa: S101
    assert result.metadata.document.twitter_card.get("card").strip() == "summary_large_image"  # noqa: S101
    assert result.metadata.document.twitter_card.get("title").strip() == "Twitter Card Title"  # noqa: S101
    assert result.metadata.document.twitter_card.get("description").strip() == "Twitter card description."  # noqa: S101
