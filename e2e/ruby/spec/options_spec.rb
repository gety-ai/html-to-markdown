...
# alef:hash:fb8c26e1d675fe4203b5e2d3e3e7376bd4cbb84d9990de58728624ccf65b454d
...
RSpec.describe 'options' do
  ...
  it 'options_extract_metadata_true: Extract metadata returns document metadata when enabled' do
    ...
    expect(result.content.to_s).not_to be_empty
    expect(result.metadata.document.title).to eq('Test Page')
    expect(result.metadata.document.description).to eq('A test page')
  ...
  it 'options_heading_style_atx_closed: ATX closed heading style adds closing hashes' do
    result = HtmlToMarkdown.convert('<h1>Closed Heading</h1>', HtmlToMarkdownRs::ConversionOptions.new(heading_style: 'atx_closed'))
  ...
  it 'options_highlight_double_equal: Mark tag with double equal highlight style' do
    result = HtmlToMarkdown.convert('<p>Text with <mark>highlighted</mark> here.</p>', HtmlToMarkdownRs::ConversionOptions.new(highlight_style: 'double_equal'))
    expect(result.content.to_s).to include('==highlighted==')
