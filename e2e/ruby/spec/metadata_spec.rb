...
# alef:hash:5d6ce759f724fcccf7f8169e52a3cdc138b3660888d2bcafc97a351fc1fd0739
...
RSpec.describe 'metadata' do
  it 'metadata_author_meta: Extract author from <meta name=\'author\'> tag' do
    result = HtmlToMarkdown.convert('<html><head><title>Page</title><meta name="author" content="Jane Doe"></head><body><p>Content</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'metadata.author' not applicable for simple result type

  end

  it 'metadata_canonical_url: Extract canonical URL from <link rel=\'canonical\'> tag' do
    result = HtmlToMarkdown.convert('<html><head><title>Page</title><link rel="canonical" href="https://example.com/canonical-page"></head><body><p>Content</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'metadata.canonical_url' not applicable for simple result type

  end

  it 'metadata_description_meta: Extract description from <meta name=\'description\'> tag' do
    result = HtmlToMarkdown.convert('<html><head><title>Page</title><meta name="description" content="This is the page description."></head><body><p>Content</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
  ...
  it 'metadata_extract_all_images: Extract all images from a document into metadata' do
    result = HtmlToMarkdown.convert('<html><head><title>Gallery</title></head><body><img src="https://example.com/photo1.jpg" alt="Photo 1"><img src="https://example.com/photo2.png" alt="Photo 2"><img src="/local/image.webp" alt="Local image"></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
  ...
  it 'metadata_extract_all_links: Extract all links from a document into metadata' do
    result = HtmlToMarkdown.convert('<html><head><title>Links Page</title></head><body><p>Visit <a href="https://example.com">Example</a> or <a href="https://docs.example.com">Docs</a>.</p><p>Also see <a href="/relative/path">relative link</a> and <a href="mailto:hello@example.com">email us</a>.</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    expect(result.length).to be >= 2
  ...
  it 'metadata_headers_hierarchy: Extract heading hierarchy from document into metadata' do
    result = HtmlToMarkdown.convert('<html><head><title>Docs</title></head><body><h1>Introduction</h1><h2>Getting Started</h2><h3>Installation</h3><h3>Configuration</h3><h2>Advanced Usage</h2><h3>Custom Options</h3></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
  ...
  it 'metadata_keywords_meta: Extract keywords from <meta name=\'keywords\'> tag' do
    result = HtmlToMarkdown.convert('<html><head><title>Page</title><meta name="keywords" content="rust, markdown, html, converter"></head><body><p>Content</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
  ...
  it 'metadata_lang_attribute: Extract language from html lang attribute' do
    result = HtmlToMarkdown.convert('<html lang="es"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'content' not applicable for simple result type
  ...
  it 'metadata_microdata_schema_organization: Extract schema.org microdata for Organization' do
    result = HtmlToMarkdown.convert('<html><head><title>Company</title></head><body><div itemscope itemtype="https://schema.org/Organization"><span itemprop="name">Acme Corp</span><span itemprop="foundingDate">2020</span><span itemprop="url">https://acmecorp.example.com</span><span itemprop="logo">https://acmecorp.example.com/logo.png</span></div></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'content' not applicable for simple result type
    # skipped: field 'content' not applicable for simple result type
  ...
  it 'metadata_microdata_schema_person: Extract schema.org microdata for Person' do
    result = HtmlToMarkdown.convert('<html><head><title>Contact</title></head><body><div itemscope itemtype="https://schema.org/Person"><span itemprop="name">John Smith</span><span itemprop="email">john@example.com</span><span itemprop="telephone">+1-555-0100</span></div></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'content' not applicable for simple result type
    # skipped: field 'content' not applicable for simple result type
  ...
  it 'metadata_text_direction_ltr: Extract text direction from lang attribute on html element' do
    result = HtmlToMarkdown.convert('<html lang="en" dir="ltr"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'content' not applicable for simple result type
  ...
  it 'metadata_text_direction_rtl: Extract right-to-left text direction' do
    result = HtmlToMarkdown.convert('<html lang="ar" dir="rtl"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
    # skipped: field 'content' not applicable for simple result type
  ...
  it 'metadata_title_tag: Extract title from <title> tag' do
    result = HtmlToMarkdown.convert('<html><head><title>My Page</title></head><body><p>Content</p></body></html>', {extract_metadata: true})
    expect(result.to_s).not_to be_empty
  ...
  it 'og_basic_tags: Extract og:title, og:description, and og:image from Open Graph meta tags' do
    ...
    expect(result.to_s).not_to be_empty
    # skipped: field 'metadata.open_graph.title' not applicable for simple result type
    # skipped: field 'metadata.open_graph.description' not applicable for simple result type
    # skipped: field 'metadata.open_graph.image' not applicable for simple result type
  ...
  it 'og_multiple_tags: Extract multiple Open Graph tags including type, url, and site_name' do
    ...
    expect(result.to_s).not_to be_empty
    # skipped: field 'metadata.open_graph.title' not applicable for simple result type
    # skipped: field 'metadata.open_graph.type' not applicable for simple result type
    # skipped: field 'metadata.open_graph.url' not applicable for simple result type
    # skipped: field 'metadata.open_graph.site_name' not applicable for simple result type
  ...
  it 'twitter_card_tags: Extract Twitter card meta tags' do
    ...
    expect(result.to_s).not_to be_empty
    # skipped: field 'metadata.twitter.card' not applicable for simple result type
    # skipped: field 'metadata.twitter.title' not applicable for simple result type
    # skipped: field 'metadata.twitter.description' not applicable for simple result type
