...
In other languages, the same hook is reached by passing a visitor object to the options builder. For binding-specific examples see [Guides → Visitor pattern](/visitor/).
