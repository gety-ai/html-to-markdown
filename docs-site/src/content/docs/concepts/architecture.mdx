...
See [Conversion pipeline](/concepts/pipeline/) for the per-stage breakdown.
...
| PHP                  | [ext-php-rs](https://docs.rs/ext-php-rs) PHP extension                   | `html-to-markdown-php`  |
...
| WebAssembly          | [wasm-bindgen](https://rustwasm.github.io/docs/wasm-bindgen/)            | `html-to-markdown-wasm` |
