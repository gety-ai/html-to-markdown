defmodule HtmlToMarkdown.MixProject do
  ...
  defp package do
    [
      ...
      files:
        ~w(.formatter.exs mix.exs README* checksum-*.exs lib native/html_to_markdown_nif/Cargo.toml native/html_to_markdown_nif/Cargo.lock ../../packages/elixir/native/html_to_markdown_nif/src)
    ]
  end
