...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "HtmlToMarkdown.ImageDimensions"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "HtmlToMarkdown.MetadataEntry"]
    ...
    std::thread::spawn(move || {
        let _ = visitor_owned_env.send_and_clear(&pid, |env| {
            ...
            options_core.visitor =
                Some(std::sync::Arc::new(std::sync::Mutex::new(bridge)) as html_to_markdown_rs::VisitorHandle);

            // Run conversion and return result term to send back to BEAM
            let conversion_result: Result<ConversionResult, String> =
                match html_to_markdown_rs::convert(&html, Some(options_core)) {
                    Ok(val) => {
...
fn nodecontext_to_elixir_map<'a>(env: rustler::Env<'a>, ctx: &html_to_markdown_rs::NodeContext) -> rustler::Term<'a> {
...
fn visitor_send_and_wait<F>(bridge: &ElixirHtmlVisitorBridge, callback_name: &str, build_args: F) -> Option<String>
where
    F: for<'a> FnOnce(rustler::Env<'a>) -> rustler::Term<'a>,
{
...
impl html_to_markdown_rs::visitor::HtmlVisitor for ElixirHtmlVisitorBridge {
    fn visit_text(&mut self, _ctx: &html_to_markdown_rs::NodeContext, _text: &str) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_text", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("text".encode(env), _text_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_element_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let result = visitor_send_and_wait(self, "handle_element_start", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_element_end(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _output_arg = _output.to_string();
        let result = visitor_send_and_wait(self, "handle_element_end", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("output".encode(env), _output_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_link(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _href_arg = _href.to_string();
        let _text_arg = _text.to_string();
        let _title_arg = _title.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_link", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("href".encode(env), _href_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("text".encode(env), _text_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("title".encode(env), _title_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_image(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _src_arg = _src.to_string();
        let _alt_arg = _alt.to_string();
        let _title_arg = _title.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_image", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("src".encode(env), _src_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("alt".encode(env), _alt_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("title".encode(env), _title_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_heading(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _level_arg = _level;
        let _text_arg = _text.to_string();
        let _id_arg = _id.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_heading", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("level".encode(env), _level_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("text".encode(env), _text_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("id".encode(env), _id_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_code_block(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _lang_arg = _lang.map(|s| s.to_string());
        let _code_arg = _code.to_string();
        let result = visitor_send_and_wait(self, "handle_code_block", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("lang".encode(env), _lang_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("code".encode(env), _code_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_code_inline(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _code_arg = _code.to_string();
        let result = visitor_send_and_wait(self, "handle_code_inline", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_list_item(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _ordered_arg = _ordered;
        let _marker_arg = _marker.to_string();
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_list_item", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("ordered".encode(env), _ordered_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("marker".encode(env), _marker_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("text".encode(env), _text_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_list_start(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _ordered_arg = _ordered;
        let result = visitor_send_and_wait(self, "handle_list_start", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_list_end(
        ...
        let _ordered_arg = _ordered;
        let _output_arg = _output.to_string();
        let result = visitor_send_and_wait(self, "handle_list_end", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_table_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let result = visitor_send_and_wait(self, "handle_table_start", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_table_row(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _cells_arg = _cells.to_vec();
        let _is_header_arg = _is_header;
        let result = visitor_send_and_wait(self, "handle_table_row", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("cells".encode(env), _cells_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("is_header".encode(env), _is_header_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_table_end(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _output_arg = _output.to_string();
        let result = visitor_send_and_wait(self, "handle_table_end", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_blockquote(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _content_arg = _content.to_string();
        let _depth_arg = _depth;
        let result = visitor_send_and_wait(self, "handle_blockquote", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("content".encode(env), _content_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("depth".encode(env), _depth_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_strong(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_strong", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_emphasis(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_emphasis", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_strikethrough(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_strikethrough", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_underline(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_underline", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_subscript(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_subscript", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_superscript(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_superscript", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_mark(&mut self, _ctx: &html_to_markdown_rs::NodeContext, _text: &str) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_mark", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_line_break(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let result = visitor_send_and_wait(self, "handle_line_break", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_horizontal_rule(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let result = visitor_send_and_wait(self, "handle_horizontal_rule", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_custom_element(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _tag_name_arg = _tag_name.to_string();
        let _html_arg = _html.to_string();
        let result = visitor_send_and_wait(self, "handle_custom_element", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("tag_name".encode(env), _tag_name_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("html".encode(env), _html_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_definition_list_start(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let result = visitor_send_and_wait(self, "handle_definition_list_start", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_definition_term(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_definition_term", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_definition_description(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_definition_description", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_definition_list_end(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _output_arg = _output.to_string();
        let result = visitor_send_and_wait(self, "handle_definition_list_end", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_form(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _action_arg = _action.map(|s| s.to_string());
        let _method_arg = _method.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_form", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("action".encode(env), _action_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("method".encode(env), _method_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_input(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _input_type_arg = _input_type.to_string();
        let _name_arg = _name.map(|s| s.to_string());
        let _value_arg = _value.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_input", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("input_type".encode(env), _input_type_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("name".encode(env), _name_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("value".encode(env), _value_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_button(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_button", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_audio(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _src_arg = _src.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_audio", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_video(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _src_arg = _src.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_video", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_iframe(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _src_arg = _src.map(|s| s.to_string());
        let result = visitor_send_and_wait(self, "handle_iframe", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_details(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _open_arg = _open;
        let result = visitor_send_and_wait(self, "handle_details", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
            args_map = args_map
                .map_put("open".encode(env), _open_arg.encode(env))
                .expect("map_put");
            args_map
        });
        match result {
    ...
    fn visit_summary(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_summary", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_figure_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let result = visitor_send_and_wait(self, "handle_figure_start", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_figcaption(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _text_arg = _text.to_string();
        let result = visitor_send_and_wait(self, "handle_figcaption", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
    ...
    fn visit_figure_end(
        ...
        let _ctx_arg = NodeContext::from((*_ctx).clone());
        let _output_arg = _output.to_string();
        let result = visitor_send_and_wait(self, "handle_figure_end", |env| {
            let mut args_map = rustler::Term::map_new(env);
            args_map = args_map
                .map_put("ctx".encode(env), _ctx_arg.encode(env))
                .expect("map_put");
...
#[rustler::nif]
pub fn nodecontext_attributes(obj: NodeContext) -> HashMap<String, String> {
    html_to_markdown_rs::NodeContext::from(obj)
        .attributes()
        .iter()
...
#[rustler::nif]
pub fn nodecontext_with_owned_attributes(
    node_type: NodeType,
    tag_name: String,
...
#[rustler::nif]
pub fn nodecontext_into_owned(obj: NodeContext) -> NodeContext {
    html_to_markdown_rs::NodeContext::from(obj).into_owned().into()
}
