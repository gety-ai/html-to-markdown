...
// alef:hash:e9777affd335e90736c49d793acd874f19f850b0d79a1ac6f63f20ab64723740
...
pub fn convert_with_visitor(
    ...
    std::thread::spawn(move || {
        visitor_owned_env.run(|env| {
            ...
            let _ = result_env.send_and_clear(&pid, |env| match conversion_result {
                Ok(result) => {
