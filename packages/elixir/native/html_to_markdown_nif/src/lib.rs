...
// alef:hash:85035187f6ad3509d23de08d9147aaec8a96091bcd91cca34a7a3f7032ffb7f9
...
pub fn conversionoptions_apply_update(obj: ConversionOptions, update: Option<String>) -> () {
    ...
    html_to_markdown_rs::ConversionOptions::from(obj).apply_update(update_core.unwrap_or_default())
}
...
pub fn conversionoptions_from_update(update: Option<String>) -> ConversionOptions {
    let update_core: Option<html_to_markdown_rs::ConversionOptionsUpdate> =
        update.and_then(|s| serde_json::from_str::<html_to_markdown_rs::ConversionOptionsUpdate>(&s).ok());
    html_to_markdown_rs::ConversionOptions::from_update(update_core.unwrap_or_default()).into()
}
...
pub fn conversionoptions_from(update: Option<String>) -> ConversionOptions {
    let update_core: Option<html_to_markdown_rs::ConversionOptionsUpdate> =
        update.and_then(|s| serde_json::from_str::<html_to_markdown_rs::ConversionOptionsUpdate>(&s).ok());
    html_to_markdown_rs::ConversionOptions::from(update_core.unwrap_or_default()).into()
}
...
pub fn preprocessingoptions_apply_update(obj: PreprocessingOptions, update: Option<String>) -> () {
    ...
    html_to_markdown_rs::PreprocessingOptions::from(obj).apply_update(update_core.unwrap_or_default())
}
...
pub fn preprocessingoptions_from_update(update: Option<String>) -> PreprocessingOptions {
    let update_core: Option<html_to_markdown_rs::PreprocessingOptionsUpdate> =
        update.and_then(|s| serde_json::from_str::<html_to_markdown_rs::PreprocessingOptionsUpdate>(&s).ok());
    html_to_markdown_rs::PreprocessingOptions::from_update(update_core.unwrap_or_default()).into()
}
...
pub fn preprocessingoptions_from(update: Option<String>) -> PreprocessingOptions {
    let update_core: Option<html_to_markdown_rs::PreprocessingOptionsUpdate> =
        update.and_then(|s| serde_json::from_str::<html_to_markdown_rs::PreprocessingOptionsUpdate>(&s).ok());
    html_to_markdown_rs::PreprocessingOptions::from(update_core.unwrap_or_default()).into()
}
