...
// alef:hash:f20c2f93a6b6f020fe32f2c1cafd471142cf4409ec7976c7b3276ba3929752a2
...
impl ConversionOptionsUpdate {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            compact_tables: opts.get("compact_tables").and_then(|t| t.decode().ok()),
...
pub fn conversionoptions_from(update: Option<String>) -> ConversionOptions {
    let update_core: Option<html_to_markdown_rs::options::ConversionOptionsUpdate> =
        update.and_then(|s| serde_json::from_str::<html_to_markdown_rs::options::ConversionOptionsUpdate>(&s).ok());
...
pub fn preprocessingoptions_from(update: Option<String>) -> PreprocessingOptions {
    let update_core: Option<html_to_markdown_rs::options::PreprocessingOptionsUpdate> =
        update.and_then(|s| serde_json::from_str::<html_to_markdown_rs::options::PreprocessingOptionsUpdate>(&s).ok());
