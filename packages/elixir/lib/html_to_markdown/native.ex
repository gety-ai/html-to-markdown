...
# alef:hash:bd3d36d21aa92678f017b06b82034268dc230fa049feeb46a07b8fb78d11e260
...
defmodule HtmlToMarkdown.Native do
  ...
  def conversion_options_update_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  def preprocessing_options_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  def preprocessing_options_update_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
