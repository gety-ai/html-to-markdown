...
// alef:hash:6af54bcbcd14b1f04abba1a279f0f8bcf547e9052f527bc64689d44674044c90
...
impl ConversionOptionsUpdate {
    pub fn from_json(json: String) -> extendr_api::Result<ConversionOptionsUpdate> {
        let core: html_to_markdown_rs::options::ConversionOptionsUpdate =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
impl PreprocessingOptions {
    ...
    pub fn from_json(json: String) -> extendr_api::Result<PreprocessingOptions> {
        let core: html_to_markdown_rs::options::PreprocessingOptions =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
impl PreprocessingOptionsUpdate {
    pub fn from_json(json: String) -> extendr_api::Result<PreprocessingOptionsUpdate> {
        let core: html_to_markdown_rs::options::PreprocessingOptionsUpdate =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
#[extendr]
pub fn convert(html: Robj, options: Robj) -> Result<Robj> {
