...
// alef:hash:7696ead76bb073af8d5aee41ac2b6607b388401defffecab137bb60053044c70
...
pub fn convert(html: String, options: Robj) -> Result<Robj> {
    ...
    let opts = crate::options::decode_options(options).map_err(|e| extendr_api::Error::Other(e))?;
