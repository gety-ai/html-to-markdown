...
// alef:hash:6eba8124470deeb9df0f3c9be8f565f560183ba0a3cd3b7eb1ca6520bf9c81b6
...
impl PreprocessingOptions {
    fn new(enabled: bool, preset: PreprocessingPreset, remove_navigation: bool, remove_forms: bool) -> Self {
        Self {
            enabled,
            preset,
            remove_navigation,
    ...
    let options_core = match visitor {
        Some(v) if !v.is_nil() => {
            if magnus::RHash::from_value(v).is_some() {
                ...
                serde_json::from_str::<html_to_markdown_rs::ConversionOptions>(&json).unwrap_or_default()
            } else {
