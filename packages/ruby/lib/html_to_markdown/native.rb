...
# alef:hash:d738b3ae3464fda65a6e4b7920f5ff01b1896f1874d450910477426a8a58b946
...
module HtmlToMarkdown
  ...
  define_singleton_method(:convert) do |*args, **kwargs, &blk|
    HtmlToMarkdownRs.convert(*args, **kwargs, &blk)
  end
end
