...
pub const ConversionOptionsUpdate = struct {
    ...
    output_format: ?OutputFormat,
    /// Optional override for the `include_document_structure` option.
    include_document_structure: ?bool,
