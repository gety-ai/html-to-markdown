...
// alef:hash:890db36c5e55b2c632125d2d04f0fe8cdf800035fe0d8e270fbac1666330072a
...
public record DocumentMetadata(@Nullable String title, @Nullable String description,
        ...
        @Nullable @JsonProperty("canonicalUrl") String canonicalUrl,
        @Nullable @JsonProperty("baseHref") String baseHref, @Nullable String language,
        @Nullable @JsonProperty("textDirection") TextDirection textDirection,
        @JsonProperty("openGraph") Map<String, String> openGraph,
        @JsonProperty("twitterCard") Map<String, String> twitterCard,
        @JsonProperty("metaTags") Map<String, String> metaTags) {
