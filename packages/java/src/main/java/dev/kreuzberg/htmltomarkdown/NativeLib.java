...
final class NativeLib {
    ...
    private static void loadNativeLibrary() {
        ...
        try {
            ...
            Path libPath = findLoadedLibraryPath("html_to_markdown_ffi", libName, libExt);
            if (libPath != null) {
