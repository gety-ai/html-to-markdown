...
// alef:hash:73feea20b0ece636a590734bb8d68dbb4f0fc3dfbd7d00f61113e2f868b8f6f3
...
public record LinkMetadata(String href, String text, @Nullable String title,
        @JsonProperty("linkType") LinkType linkType, @JsonInclude(JsonInclude.Include.NON_NULL) List<String> rel,
