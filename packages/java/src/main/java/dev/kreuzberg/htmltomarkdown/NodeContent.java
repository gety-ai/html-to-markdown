...
// alef:hash:d4f6c6b800d969bcc9ee390a0e56a22508c89496ad7e0c5104d0db9f89d49356
...
@JsonSubTypes({@JsonSubTypes.Type(value = NodeContent.Heading.class, name = "heading"),
...
public sealed interface NodeContent {
    ...
    /** An image element. */
    record Image(@JsonProperty("description") Optional<String> description, @JsonProperty("src") Optional<String> src,
            @JsonProperty("image_index") Optional<Integer> imageIndex) implements NodeContent {
    }
