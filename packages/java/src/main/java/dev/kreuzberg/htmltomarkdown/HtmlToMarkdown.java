...
public final class HtmlToMarkdown {
     ...
     * Defaults to ConversionOptions::default. When the {@code visitor} feature is enabled, a custom {@code HtmlVisitor}
     * can be attached via the {@code visitor} field on {@code ConversionOptions}. {@literal @}throws
     * KreuzbergRsException Returns an error if HTML parsing fails or if the input contains invalid UTF-8.
     */
