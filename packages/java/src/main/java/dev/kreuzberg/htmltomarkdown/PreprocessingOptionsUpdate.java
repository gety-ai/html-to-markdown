...
// alef:hash:e2aed53de60802e1a7aaf664041b02182879cded5142ef99bbeb8447e311b80d
...
public record PreprocessingOptionsUpdate(@Nullable Boolean enabled, @Nullable PreprocessingPreset preset,
        @Nullable @JsonProperty("removeNavigation") Boolean removeNavigation,
        @Nullable @JsonProperty("removeForms") Boolean removeForms) {
