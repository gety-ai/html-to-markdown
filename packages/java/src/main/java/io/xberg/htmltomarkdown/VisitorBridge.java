...
final class VisitorBridge implements AutoCloseable {
    ...
    private static final int VISIT_RESULT_CUSTOM = 1;
    private static final int VISIT_RESULT_SKIP = 2;
    private static final int VISIT_RESULT_PRESERVEHTML = 3;
    private static final int VISIT_RESULT_ERROR = 4;

    // Callback table: user_data + 40 callbacks
    ...
    VisitorBridge(HtmlVisitor visitor) {
        ...
        try {
            ...
            offset = registerStubs4(offset);
            offset = registerStubs5(offset);
            offset = registerStubs6(offset);
            offset = registerStubs7(offset);
            offset = registerStubs8(offset);
    ...
    int handleVisitText(
        ...
        try {
            var context = decodeContext(ctx);
            var text = rawText0.equals(MemorySegment.NULL) ? null : rawText0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitElementEnd(
        ...
        try {
            var context = decodeContext(ctx);
            var output = rawOutput0.equals(MemorySegment.NULL) ? null : rawOutput0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitLink(
        ...
        try {
            var context = decodeContext(ctx);
            var href = rawHref0.equals(MemorySegment.NULL) ? null : rawHref0.reinterpret(Long.MAX_VALUE).getString(0);
            var text = rawText0.equals(MemorySegment.NULL) ? null : rawText0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitImage(
        ...
        try {
            ...
            var alt = rawAlt0.equals(MemorySegment.NULL) ? null : rawAlt0.reinterpret(Long.MAX_VALUE).getString(0);
            var title = rawTitle0.equals(MemorySegment.NULL) ? null : rawTitle0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitCodeBlock(
        ...
        try {
            ...
            var code = rawCode0.equals(MemorySegment.NULL) ? null : rawCode0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitListItem(
        ...
        try {
            ...
            var marker = rawMarker0.equals(MemorySegment.NULL) ? null : rawMarker0.reinterpret(Long.MAX_VALUE).getString(0);
            var text = rawText0.equals(MemorySegment.NULL) ? null : rawText0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitTableRow(
        ...
        final long rawIsHeader0,
        final MemorySegment outCustom,
        final MemorySegment outLen) {
        try {
            var context = decodeContext(ctx);
            var cells = decodeStringList(rawCells0, rawCells1);
            var isHeader = rawIsHeader0 != 0;

            var result = visitor.visitTableRow(context, cells, isHeader);
            return encodeVisitResult(result, outCustom, outLen);
        } catch (Throwable t) {
            // Record the first visitor exception; subsequent errors are suppressed.
            if (visitorError == null) {
    ...
    int handleVisitBlockquote(
        ...
        try {
            var context = decodeContext(ctx);
            var content = rawContent0.equals(MemorySegment.NULL) ? null : rawContent0.reinterpret(Long.MAX_VALUE).getString(0);
            var depth = rawDepth0;
    ...
    int handleVisitCustomElement(
        ...
        try {
            var context = decodeContext(ctx);
            var tagName = rawTagName0.equals(MemorySegment.NULL) ? null : rawTagName0.reinterpret(Long.MAX_VALUE).getString(0);
            var html = rawHtml0.equals(MemorySegment.NULL) ? null : rawHtml0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    int handleVisitInput(
        ...
        try {
            var context = decodeContext(ctx);
            var inputType = rawInputType0.equals(MemorySegment.NULL) ? null : rawInputType0.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    private int encodeVisitResult(VisitResult result, MemorySegment outCustom, MemorySegment outLen) {
        return switch (result) {
            ...
            case VisitResult.Custom c -> {
                var buf = Arena.global().allocateFrom(c.value());
                outCustom.reinterpret(ValueLayout.ADDRESS.byteSize()).set(ValueLayout.ADDRESS, 0L, buf);
                long customLen = (long) c.value().getBytes(java.nio.charset.StandardCharsets.UTF_8).length;
            ...
            case VisitResult.PreserveHtml ignored -> VISIT_RESULT_PRESERVEHTML;
            case VisitResult.Error c -> {
                var buf = Arena.global().allocateFrom(c.value());
                outCustom.reinterpret(ValueLayout.ADDRESS.byteSize()).set(ValueLayout.ADDRESS, 0L, buf);
                long customLen = (long) c.value().getBytes(java.nio.charset.StandardCharsets.UTF_8).length;
                outLen.reinterpret(ValueLayout.JAVA_LONG.byteSize()).set(ValueLayout.JAVA_LONG, 0L, customLen);
