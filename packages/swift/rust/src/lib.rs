...
mod ffi {
    ...
    #[cfg(feature = "metadata")]
    extern "Rust" {
        #[swift_bridge(swift_name = "headerMetadataIsValidFromJson")]
        fn header_metadata_is_valid_from_json(json: String) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        type VisitorHandle;
        fn visitor_handle_noop(client: &VisitorHandle);
    }
    ...
    #[cfg(feature = "visitor")]
    extern "Rust" {
        #[swift_bridge(swift_name = "nodeContextAttributesFromJson")]
        fn node_context_attributes_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "nodeContextIntoOwnedFromJson")]
        fn node_context_into_owned_from_json(json: String) -> Result<String, String>;
    }
...
#[cfg(feature = "visitor")]
pub fn visitor_handle_noop(client: &VisitorHandle) {}
