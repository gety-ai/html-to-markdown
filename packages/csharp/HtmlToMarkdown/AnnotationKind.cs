...
public sealed class AnnotationKindJsonConverter : JsonConverter<AnnotationKind>
{
    public override AnnotationKind Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {            "bold" => new AnnotationKind.Bold(),            "italic" => new AnnotationKind.Italic(),            "underline" => new AnnotationKind.Underline(),            "strikethrough" => new AnnotationKind.Strikethrough(),            "code" => new AnnotationKind.Code(),            "subscript" => new AnnotationKind.Subscript(),            "superscript" => new AnnotationKind.Superscript(),            "highlight" => new AnnotationKind.Highlight(),            "link" => JsonSerializer.Deserialize<AnnotationKind.Link>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),            // Unknown discriminator: binding-excluded variant or forward compatibility
            _ => throw new JsonException($"Unknown AnnotationKind discriminator: {tagValue} (this may be a binding-excluded variant)")
        };
    }
