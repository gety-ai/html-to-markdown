...
// alef:hash:68c9ac02b9f81f627d1b99b1739778fded1d1196e42f93ae593b2ff4ed975690
#nullable enable
...
public static class HtmlToMarkdownRs
{
    ...
    private static Exception GetLastError()
    {
        ...
        var message = Marshal.PtrToStringUTF8(ctxPtr) ?? "Unknown error";        if (code == 1) return new InvalidInputException(message);        if (code == 2) return new ConversionErrorException(message);        return new HtmlToMarkdownRsException(code, message);
    }
}
