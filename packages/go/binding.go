...
//   - options: — conversion options. Rust accepts either bare [`ConversionOptions`], `Some(options)`, or `None`; bindings expose the same option fields through language-native constructors or optional parameters.
//
