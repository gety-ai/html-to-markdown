...
#cgo darwin,arm64 LDFLAGS: -L${SRCDIR}/.lib/macos-arm64 -lhtml_to_markdown_ffi
#cgo darwin,amd64 LDFLAGS: -L${SRCDIR}/.lib/macos-amd64 -lhtml_to_markdown_ffi
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/.lib/linux-amd64 -lhtml_to_markdown_ffi
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/.lib/linux-arm64 -lhtml_to_markdown_ffi
