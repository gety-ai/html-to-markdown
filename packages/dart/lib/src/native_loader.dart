...
// Shared native-library resolution for html-to-markdown-rs: cache-path computation,
...
/// a fresh download.
const String nativeModuleVersion = '3.8.3';

/// GitHub repository base URL (e.g. `https://github.com/owner/repo`).
const String nativeRepoUrl = 'https://github.com/xberg-io/html-to-markdown';

/// Release-asset name prefix and cache namespace (the package name).
const String nativeAssetPrefix = 'html-to-markdown-rs';

/// Native library file stem (without the platform prefix/suffix).
const String nativeLibStem = 'html_to_markdown_rs';
