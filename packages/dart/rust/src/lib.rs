...
impl From<html_to_markdown_rs::options::TierStrategy> for TierStrategy {
    fn from(v: html_to_markdown_rs::options::TierStrategy) -> Self {
        match v {
            ...
            _ => unreachable!("cfg-gated variant of TierStrategy not active in this build"),
        }
    }
}
...
impl From<html_to_markdown_rs::NodeContent> for NodeContent {
    fn from(v: html_to_markdown_rs::NodeContent) -> Self {
        match v {
            ...
            html_to_markdown_rs::NodeContent::Paragraph { text } => NodeContent::Paragraph { text: text },
            html_to_markdown_rs::NodeContent::List { ordered } => NodeContent::List { ordered: ordered as _ },
            html_to_markdown_rs::NodeContent::ListItem { text } => NodeContent::ListItem { text: text },
...
impl html_to_markdown_rs::visitor::HtmlVisitor for HtmlVisitorDartImpl {
    fn visit_text(
        ...
        let __fut = (self.visit_text)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                eprintln!("[HtmlVisitorDartImpl] host 'visit_text' panicked; returning default: {msg}");
    ...
    fn visit_element_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext<'_>) -> html_to_markdown_rs::VisitResult {
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_element_start)(_ctx);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_element_start' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_element_end(
        ...
        let __fut = (self.visit_element_end)(_ctx, _output);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_element_end' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_link(
        ...
        let __fut = (self.visit_link)(_ctx, _href, _text, _title);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_link' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_image(
        ...
        let _title = _title.map(|x| x.to_string());
        let __fut = (self.visit_image)(_ctx, _src, _alt, _title);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_image' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_heading(
        ...
        let __fut = (self.visit_heading)(_ctx, _level, _text, _id);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_heading' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_code_block(
        ...
        let __fut = (self.visit_code_block)(_ctx, _lang, _code);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_code_block' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_code_inline(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _code = _code.to_string();
        let __fut = (self.visit_code_inline)(_ctx, _code);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_code_inline' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_list_item(
        ...
        let _text = _text.to_string();
        let __fut = (self.visit_list_item)(_ctx, _ordered, _marker, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_list_item' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_list_start(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_list_start)(_ctx, _ordered);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_list_start' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_list_end(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _output = _output.to_string();
        let __fut = (self.visit_list_end)(_ctx, _ordered, _output);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_list_end' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_table_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext<'_>) -> html_to_markdown_rs::VisitResult {
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_table_start)(_ctx);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_table_start' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_table_row(
        ...
        let __fut = (self.visit_table_row)(_ctx, _cells, _is_header);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_table_row' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_table_end(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _output = _output.to_string();
        let __fut = (self.visit_table_end)(_ctx, _output);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_table_end' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_blockquote(
        ...
        let __fut = (self.visit_blockquote)(_ctx, _content, _depth);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_blockquote' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_strong(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_strong)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_strong' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_emphasis(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_emphasis)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_emphasis' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_strikethrough(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_strikethrough)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_strikethrough' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_underline(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_underline)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_underline' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_subscript(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_subscript)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_subscript' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_superscript(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_superscript)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_superscript' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_mark(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_mark)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_mark' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_line_break(&mut self, _ctx: &html_to_markdown_rs::NodeContext<'_>) -> html_to_markdown_rs::VisitResult {
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_line_break)(_ctx);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_line_break' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_horizontal_rule(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_horizontal_rule)(_ctx);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_horizontal_rule' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_custom_element(
        ...
        let __fut = (self.visit_custom_element)(_ctx, _tag_name, _html);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_custom_element' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_definition_list_start(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_definition_list_start)(_ctx);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[HtmlVisitorDartImpl] host 'visit_definition_list_start' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn visit_definition_term(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_definition_term)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_definition_term' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_definition_description(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_definition_description)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[HtmlVisitorDartImpl] host 'visit_definition_description' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn visit_definition_list_end(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _output = _output.to_string();
        let __fut = (self.visit_definition_list_end)(_ctx, _output);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_definition_list_end' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_form(
        ...
        let __fut = (self.visit_form)(_ctx, _action, _method);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_form' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_input(
        ...
        let __fut = (self.visit_input)(_ctx, _input_type, _name, _value);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_input' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_button(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_button)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_button' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_audio(
        ...
        let __fut = (self.visit_audio)(_ctx, _src);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_audio' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_video(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _src = _src.map(|x| x.to_string());
        let __fut = (self.visit_video)(_ctx, _src);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_video' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_iframe(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _src = _src.map(|x| x.to_string());
        let __fut = (self.visit_iframe)(_ctx, _src);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_iframe' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_details(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_details)(_ctx, _open);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_details' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_summary(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_summary)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_summary' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_figure_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext<'_>) -> html_to_markdown_rs::VisitResult {
        let _ctx = NodeContext::from(_ctx.clone());
        let __fut = (self.visit_figure_start)(_ctx);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_figure_start' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_figcaption(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _text = _text.to_string();
        let __fut = (self.visit_figcaption)(_ctx, _text);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_figcaption' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn visit_figure_end(
        ...
        let _ctx = NodeContext::from(_ctx.clone());
        let _output = _output.to_string();
        let __fut = (self.visit_figure_end)(_ctx, _output);
        let __result = match std::thread::spawn(move || {
            ::tokio::runtime::Builder::new_current_thread()
                .build()
                .expect("build alef visitor tokio runtime")
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[HtmlVisitorDartImpl] host 'visit_figure_end' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
