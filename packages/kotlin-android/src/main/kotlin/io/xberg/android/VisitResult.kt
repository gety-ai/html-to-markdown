...
private class VisitResultDeserializer : com.fasterxml.jackson.databind.deser.std.StdDeserializer<VisitResult>(VisitResult::class.java) {
...
private class VisitResultSerializer : com.fasterxml.jackson.databind.ser.std.StdSerializer<VisitResult>(VisitResult::class.java) {
    @Suppress("LongMethod")
