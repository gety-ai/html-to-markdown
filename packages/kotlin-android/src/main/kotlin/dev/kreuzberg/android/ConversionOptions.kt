...
data class ConversionOptions(
     ...
     *
     * Defaults to the standard preprocessing options, which enables the standard cleaning passes.
     * Set individual fields on `PreprocessingOptions` (or construct via
     ...
     *
     * - `UrlEscapeStyle.Angle` (default) — wraps the destination in angle brackets when it contains
     *   spaces or newlines. Some parsers misinterpret `>` inside such a destination.
     *
