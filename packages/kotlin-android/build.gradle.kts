...
tasks.register("copyHostJni", Copy::class) {
    if (project.properties["alef.skipHostJni"] != "true") {
        ...
        val jniCratePath = file("../../crates/html-to-markdown-rs-jni")
    ...
    doFirst {
        if (
            gradle.taskGraph.hasTask("assembleRelease") ||
                gradle.taskGraph.hasTask("publishAndReleaseToMavenCentral")
        ) {
...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            ...
            developerConnection.set("scm:git:ssh://git@github.com:xberg-io/html-to-markdown.git")
        }
    }
}
