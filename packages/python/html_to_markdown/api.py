...
from ._html_to_markdown import ConversionResult, HtmlVisitor
...
@overload
def _to_rust_conversion_options(value: None, _visitor_override: HtmlVisitor) -> _rust.ConversionOptions: ...


@overload
def _to_rust_conversion_options(
    value: ConversionOptions | dict[str, Any] | str,
    _visitor_override: HtmlVisitor | None = None,
...
def _to_rust_conversion_options(
    ...
    return _rust.ConversionOptions(
        ...
        **(
        ...
        visitor=_visitor_override if _visitor_override is not None else value.visitor,  # type: ignore[arg-type]
    )
