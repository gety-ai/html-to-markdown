...
def _from_native_document_metadata(native: Any) -> DocumentMetadata:
    """Build the public `DocumentMetadata` dataclass from the native binding object."""
...
def _from_native_html_metadata(native: Any) -> HtmlMetadata:
    ...
    return HtmlMetadata(
        document=_from_native_document_metadata(native.document),
